...
def accelerator_parse_with_keycode(accelerator: str, display: Gdk.Display, accelerator_key: int, accelerator_codes: list[int], accelerator_mods: Gdk.ModifierType) -> bool: ...
...
def enumerate_printers(func: PrinterFunc, data: object, destroy: GLib.DestroyNotify, wait: bool) -> None: ...
...
def native_get_for_surface(surface: Gdk.Surface) -> Native: ...
...
def show_uri(parent: Window, uri: str, timestamp: int) -> None: ...
def show_uri_full(parent: Window, uri: str, timestamp: int, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
def tree_get_row_drag_data(value: GObject.Value, tree_model: TreeModel, path: TreePath) -> bool: ...
...
def value_dup_expression(value: GObject.Value) -> Expression: ...
def value_get_expression(value: GObject.Value) -> Expression: ...
def value_set_expression(value: GObject.Value, expression: Expression) -> None: ...
def value_take_expression(value: GObject.Value, expression: Expression) -> None: ...

class ATContext(GObject.Object): 
    @classmethod
    def create(cls, accessible_role: AccessibleRole, accessible: Accessible, display: Gdk.Display) -> ATContext: ...
...
class AboutDialog(Window, Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager): 
    ...
    def get_logo(self) -> Gdk.Paintable: ...
    ...
    def set_logo(self, logo: Gdk.Paintable) -> None: ...
    def set_logo_icon_name(self, icon_name: str) -> None: ...
    def set_program_name(self, name: str) -> None: ...
    def set_system_information(self, system_information: str) -> None: ...
...
class BookmarkList(GObject.Object, Gio.ListModel): 
    @classmethod
    def new(cls, filename: filename, attributes: str) -> BookmarkList: ...
...
class BoolFilter(Filter): 
    @classmethod
    def new(cls, expression: Expression) -> BoolFilter: ...
...
class Box(Widget, Accessible, Buildable, ConstraintTarget, Orientable): 
    ...
    def insert_child_after(self, child: Widget, sibling: Widget) -> None: ...
...
class Builder(GObject.Object): 
    ...
    def create_closure(self, function_name: str, flags: BuilderClosureFlags, object: GObject.Object) -> GObject.Closure: ...
    ...
    def get_current_object(self) -> GObject.Object: ...
    ...
    def set_current_object(self, current_object: GObject.Object) -> None: ...
    def set_scope(self, scope: BuilderScope) -> None: ...
...
class BuilderListItemFactory(ListItemFactory): 
    @classmethod
    def new_from_bytes(cls, scope: BuilderScope, bytes: GLib.Bytes) -> ListItemFactory: ...
...
class CClosureExpression(Expression): 
    @classmethod
    def new(cls, value_type: GObject.Type, marshal: GObject.ClosureMarshal, n_params: int, params: list[Expression], callback_func: GObject.Callback, user_data: object, user_destroy: GObject.ClosureNotify) -> CClosureExpression: ...
...
class CallbackAction(ShortcutAction): 
    @classmethod
    def new(cls, callback: ShortcutFunc, data: object, destroy: GLib.DestroyNotify) -> CallbackAction: ...
...
class CenterBox(Widget, Accessible, Buildable, ConstraintTarget, Orientable): 
    ...
    def get_baseline_position(self) -> BaselinePosition: ...
    def get_center_widget(self) -> Widget: ...
    def get_end_widget(self) -> Widget: ...
    def get_start_widget(self) -> Widget: ...
    def set_baseline_position(self, position: BaselinePosition) -> None: ...
    def set_center_widget(self, child: Widget) -> None: ...
    def set_end_widget(self, child: Widget) -> None: ...
    def set_start_widget(self, child: Widget) -> None: ...
...
class CenterLayout(LayoutManager): 
    ...
    def set_end_widget(self, widget: Widget) -> None: ...
    def set_orientation(self, orientation: Orientation) -> None: ...
    def set_start_widget(self, widget: Widget) -> None: ...
...
class CheckButton(Widget, Accessible, Actionable, Buildable, ConstraintTarget): 
    ...
    def set_active(self, setting: bool) -> None: ...
    def set_child(self, child: Widget) -> None: ...
    def set_group(self, group: CheckButton) -> None: ...
...
class ClosureExpression(Expression): 
    @classmethod
    def new(cls, value_type: GObject.Type, closure: GObject.Closure, n_params: int, params: list[Expression]) -> ClosureExpression: ...
...
class ColumnView(Widget, Accessible, Buildable, ConstraintTarget, Scrollable): 
    ...
    def set_model(self, model: SelectionModel) -> None: ...
    ...
    def sort_by_column(self, column: ColumnViewColumn, direction: SortType) -> None: ...

class ColumnViewColumn(GObject.Object): 
    @classmethod
    def new(cls, title: str, factory: ListItemFactory) -> ColumnViewColumn: ...
    def get_column_view(self) -> ColumnView: ...
    def get_expand(self) -> bool: ...
    def get_factory(self) -> ListItemFactory: ...
    def get_fixed_width(self) -> int: ...
    def get_header_menu(self) -> Gio.MenuModel: ...
    def get_resizable(self) -> bool: ...
    def get_sorter(self) -> Sorter: ...
    def get_title(self) -> str: ...
    def get_visible(self) -> bool: ...
    def set_expand(self, expand: bool) -> None: ...
    def set_factory(self, factory: ListItemFactory) -> None: ...
    def set_fixed_width(self, fixed_width: int) -> None: ...
    def set_header_menu(self, menu: Gio.MenuModel) -> None: ...
...
class Constraint(GObject.Object): 
    @classmethod
    def new(cls, target: ConstraintTarget, target_attribute: ConstraintAttribute, relation: ConstraintRelation, source: ConstraintTarget, source_attribute: ConstraintAttribute, multiplier: float, constant: float, strength: int) -> Constraint: ...
    def get_constant(self) -> float: ...
    def get_multiplier(self) -> float: ...
    def get_relation(self) -> ConstraintRelation: ...
    def get_source(self) -> ConstraintTarget: ...
    def get_source_attribute(self) -> ConstraintAttribute: ...
    def get_strength(self) -> int: ...
    def get_target(self) -> ConstraintTarget: ...
...
class CssProvider(GObject.Object, StyleProvider): 
    ...
    def load_named(self, name: str, variant: str) -> None: ...
    def to_string(self) -> str: ...

class CustomFilter(Filter): 
    @classmethod
    def new(cls, match_func: CustomFilterFunc, user_data: object, user_destroy: GLib.DestroyNotify) -> CustomFilter: ...
    def set_filter_func(self, match_func: CustomFilterFunc, user_data: object, user_destroy: GLib.DestroyNotify) -> None: ...

class CustomLayout(LayoutManager): 
    @classmethod
    def new(cls, request_mode: CustomRequestModeFunc, measure: CustomMeasureFunc, allocate: CustomAllocateFunc) -> LayoutManager: ...

class CustomSorter(Sorter): 
    @classmethod
    def new(cls, sort_func: GLib.CompareDataFunc, user_data: object, user_destroy: GLib.DestroyNotify) -> CustomSorter: ...
    def set_sort_func(self, sort_func: GLib.CompareDataFunc, user_data: object, user_destroy: GLib.DestroyNotify) -> None: ...
...
class DirectoryList(GObject.Object, Gio.ListModel): 
    @classmethod
    def new(cls, attributes: str, file: Gio.File) -> DirectoryList: ...
    def get_attributes(self) -> str: ...
...
class DragIcon(Widget, Accessible, Buildable, ConstraintTarget, Native, Root): 
    @classmethod
    def create_widget_for_value(cls, value: GObject.Value) -> Widget: ...
    @classmethod
...
class DragSource(GestureSingle): 
    ...
    def get_content(self) -> Gdk.ContentProvider: ...
    def get_drag(self) -> Gdk.Drag: ...
    def set_actions(self, actions: Gdk.DragAction) -> None: ...
    def set_content(self, content: Gdk.ContentProvider) -> None: ...
    def set_icon(self, paintable: Gdk.Paintable, hot_x: int, hot_y: int) -> None: ...
...
class DrawingArea(Widget, Accessible, Buildable, ConstraintTarget): 
    ...
    def set_draw_func(self, draw_func: DrawingAreaDrawFunc, user_data: object, destroy: GLib.DestroyNotify) -> None: ...

class DropControllerMotion(EventController): 
    @classmethod
    def new(cls) -> EventController: ...
    def contains_pointer(self) -> bool: ...
    def get_drop(self) -> Gdk.Drop: ...
    def is_pointer(self) -> bool: ...

class DropDown(Widget, Accessible, Buildable, ConstraintTarget): 
    @classmethod
    def new(cls, model: Gio.ListModel, expression: Expression) -> Widget: ...
    def get_enable_search(self) -> bool: ...
    def get_expression(self) -> Expression: ...
    def get_factory(self) -> ListItemFactory: ...
    def get_list_factory(self) -> ListItemFactory: ...
    def get_model(self) -> Gio.ListModel: ...
    def get_selected(self) -> int: ...
    def get_selected_item(self) -> GObject.Object: ...
    def get_show_arrow(self) -> bool: ...
    def set_enable_search(self, enable_search: bool) -> None: ...
    def set_expression(self, expression: Expression) -> None: ...
    def set_factory(self, factory: ListItemFactory) -> None: ...
    def set_list_factory(self, factory: ListItemFactory) -> None: ...
    def set_model(self, model: Gio.ListModel) -> None: ...
...
class DropTarget(EventController): 
    ...
    def get_actions(self) -> Gdk.DragAction: ...
    def get_current_drop(self) -> Gdk.Drop: ...
    def get_drop(self) -> Gdk.Drop: ...
    def get_formats(self) -> Gdk.ContentFormats: ...
    def get_gtypes(self, n_types: gsize) -> list[GObject.Type]: ...
    def get_preload(self) -> bool: ...
    def get_value(self) -> GObject.Value: ...
    def reject(self) -> None: ...
    def set_actions(self, actions: Gdk.DragAction) -> None: ...
    def set_gtypes(self, types: list[GObject.Type], n_types: gsize) -> None: ...
    def set_preload(self, preload: bool) -> None: ...

class DropTargetAsync(EventController): 
    @classmethod
    def new(cls, formats: Gdk.ContentFormats, actions: Gdk.DragAction) -> DropTargetAsync: ...
    def get_actions(self) -> Gdk.DragAction: ...
    def get_formats(self) -> Gdk.ContentFormats: ...
    def reject_drop(self, drop: Gdk.Drop) -> None: ...
    def set_actions(self, actions: Gdk.DragAction) -> None: ...
    def set_formats(self, formats: Gdk.ContentFormats) -> None: ...
...
class Entry(Widget, Accessible, Buildable, CellEditable, ConstraintTarget, Editable): 
    ...
    def get_icon_paintable(self, icon_pos: EntryIconPosition) -> Gdk.Paintable: ...
    ...
    def set_extra_menu(self, model: Gio.MenuModel) -> None: ...
    ...
    def set_icon_from_paintable(self, icon_pos: EntryIconPosition, paintable: Gdk.Paintable) -> None: ...
...
class EventController(GObject.Object): 
    def get_current_event(self) -> Gdk.Event: ...
    def get_current_event_device(self) -> Gdk.Device: ...
...
class Expression: 
    def bind(self, target: GObject.Object, property: str, this_: GObject.Object) -> ExpressionWatch: ...
    def evaluate(self, this_: GObject.Object, value: GObject.Value) -> bool: ...
    def get_value_type(self) -> GObject.Type: ...
    def is_static(self) -> bool: ...
    def ref(self) -> Expression: ...
    def unref(self) -> None: ...
    def watch(self, this_: GObject.Object, notify: ExpressionNotify, user_data: object, user_destroy: GLib.DestroyNotify) -> ExpressionWatch: ...
...
class FilterListModel(GObject.Object, Gio.ListModel): 
    @classmethod
    def new(cls, model: Gio.ListModel, filter: Filter) -> FilterListModel: ...
...
class Fixed(Widget, Accessible, Buildable, ConstraintTarget): 
    ...
    def get_child_transform(self, widget: Widget) -> Gsk.Transform: ...
    def move(self, widget: Widget, x: float, y: float) -> None: ...
    def put(self, widget: Widget, x: float, y: float) -> None: ...
    def remove(self, widget: Widget) -> None: ...
    def set_child_transform(self, widget: Widget, transform: Gsk.Transform) -> None: ...
...
class FixedLayoutChild(LayoutChild): 
    def get_transform(self) -> Gsk.Transform: ...
    def set_transform(self, transform: Gsk.Transform) -> None: ...

class FlattenListModel(GObject.Object, Gio.ListModel): 
    @classmethod
    def new(cls, model: Gio.ListModel) -> FlattenListModel: ...
    def get_model(self) -> Gio.ListModel: ...
    def get_model_for_item(self, position: int) -> Gio.ListModel: ...
    def set_model(self, model: Gio.ListModel) -> None: ...
...
class Grid(Widget, Accessible, Buildable, ConstraintTarget, Orientable): 
    ...
    def get_child_at(self, column: int, row: int) -> Widget: ...
...
class GridView(ListBase, Accessible, Buildable, ConstraintTarget, Orientable, Scrollable): 
    @classmethod
    def new(cls, model: SelectionModel, factory: ListItemFactory) -> Widget: ...
    def get_enable_rubberband(self) -> bool: ...
    def get_factory(self) -> ListItemFactory: ...
...
class IMContext(GObject.Object): 
    ...
    def reset(self) -> None: ...
    def set_client_widget(self, widget: Widget) -> None: ...
...
class IconTheme(GObject.Object): 
    ...
    def get_resource_path(self) -> list[str]: ...
    def get_search_path(self) -> list[filename]: ...
    ...
    def lookup_icon(self, icon_name: str, fallbacks: list[str], size: int, scale: int, direction: TextDirection, flags: IconLookupFlags) -> IconPaintable: ...
    def set_resource_path(self, path: list[str]) -> None: ...
    def set_search_path(self, path: list[filename]) -> None: ...
...
class IconView(Widget, Accessible, Buildable, CellLayout, ConstraintTarget, Scrollable): 
    @classmethod
    def new(cls) -> Widget: ...
    def create_drag_icon(self, path: TreePath) -> Gdk.Paintable: ...
...
class Image(Widget, Accessible, Buildable, ConstraintTarget): 
    ...
    def set_from_paintable(self, paintable: Gdk.Paintable) -> None: ...
...
class ListItem(GObject.Object): 
    def get_activatable(self) -> bool: ...
    def get_child(self) -> Widget: ...
    def get_item(self) -> GObject.Object: ...
...
class MapListModel(GObject.Object, Gio.ListModel): 
    @classmethod
    def new(cls, model: Gio.ListModel, map_func: MapListModelMapFunc, user_data: object, user_destroy: GLib.DestroyNotify) -> MapListModel: ...
    def get_model(self) -> Gio.ListModel: ...
    def has_map(self) -> bool: ...
    def set_map_func(self, map_func: MapListModelMapFunc, user_data: object, user_destroy: GLib.DestroyNotify) -> None: ...
    def set_model(self, model: Gio.ListModel) -> None: ...

class MediaControls(Widget, Accessible, Buildable, ConstraintTarget): 
    @classmethod
    def new(cls, stream: MediaStream) -> Widget: ...
    def get_media_stream(self) -> MediaStream: ...
    def set_media_stream(self, stream: MediaStream) -> None: ...
...
class MediaFile(MediaStream, Gdk.Paintable): 
    ...
    def set_file(self, file: Gio.File) -> None: ...
    def set_filename(self, filename: filename) -> None: ...
    def set_input_stream(self, stream: Gio.InputStream) -> None: ...
    def set_resource(self, resource_path: str) -> None: ...
...
class MenuButton(Widget, Accessible, Buildable, ConstraintTarget): 
    ...
    def set_child(self, child: Widget) -> None: ...
    def set_create_popup_func(self, func: MenuButtonCreatePopupFunc, user_data: object, destroy_notify: GLib.DestroyNotify) -> None: ...
...
class MultiSelection(GObject.Object, Gio.ListModel, SelectionModel): 
    @classmethod
    def new(cls, model: Gio.ListModel) -> MultiSelection: ...
    def get_model(self) -> Gio.ListModel: ...
    def set_model(self, model: Gio.ListModel) -> None: ...
...
class NoSelection(GObject.Object, Gio.ListModel, SelectionModel): 
    @classmethod
    def new(cls, model: Gio.ListModel) -> NoSelection: ...
    def get_model(self) -> Gio.ListModel: ...
    def set_model(self, model: Gio.ListModel) -> None: ...
...
class NumericSorter(Sorter): 
    @classmethod
    def new(cls, expression: Expression) -> NumericSorter: ...
    def get_expression(self) -> Expression: ...
...
class PadController(EventController): 
    @classmethod
    def new(cls, group: Gio.ActionGroup, pad: Gdk.Device) -> PadController: ...
...
class Paned(Widget, Accessible, Buildable, ConstraintTarget, Orientable): 
    ...
    def get_start_child(self) -> Widget: ...
    def get_wide_handle(self) -> bool: ...
    def set_end_child(self, child: Widget) -> None: ...
    ...
    def set_start_child(self, child: Widget) -> None: ...
...
class Popover(Widget, Accessible, Buildable, ConstraintTarget, Native, ShortcutManager): 
    ...
    def get_offset(self, x_offset: int, y_offset: int) -> None: ...
...
class PopoverMenu(Popover, Accessible, Buildable, ConstraintTarget, Native, ShortcutManager): 
    ...
    def set_menu_model(self, model: Gio.MenuModel) -> None: ...
...
class PrintJob(GObject.Object): 
    ...
    def send(self, callback: PrintJobCompleteFunc, user_data: object, dnotify: GLib.DestroyNotify) -> None: ...
...
class PrintUnixDialog(Dialog, Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager): 
    ...
    def get_selected_printer(self) -> Printer: ...
    def get_settings(self) -> PrintSettings: ...
    def get_support_selection(self) -> bool: ...
    def set_current_page(self, current_page: int) -> None: ...
    def set_embed_page_setup(self, embed: bool) -> None: ...
    ...
    def set_page_setup(self, page_setup: PageSetup) -> None: ...
    def set_settings(self, settings: PrintSettings) -> None: ...
    def set_support_selection(self, support_selection: bool) -> None: ...
...
class PropertyExpression(Expression): 
    @classmethod
    def new(cls, this_type: GObject.Type, expression: Expression, property_name: str) -> PropertyExpression: ...
    def get_expression(self) -> Expression: ...
...
class Scale(Range, Accessible, Buildable, ConstraintTarget, Orientable): 
    ...
    def set_format_value_func(self, func: ScaleFormatValueFunc, user_data: object, destroy_notify: GLib.DestroyNotify) -> None: ...
...
class ScaleButton(Widget, Accessible, Buildable, ConstraintTarget, Orientable): 
    @classmethod
    def new(cls, min: float, max: float, step: float, icons: list[str]) -> Widget: ...
    def get_adjustment(self) -> Adjustment: ...
...
class SearchBar(Widget, Accessible, Buildable, ConstraintTarget): 
    ...
    def get_child(self) -> Widget: ...
    def get_key_capture_widget(self) -> Widget: ...
    def get_search_mode(self) -> bool: ...
    def get_show_close_button(self) -> bool: ...
    def set_child(self, child: Widget) -> None: ...
    def set_key_capture_widget(self, widget: Widget) -> None: ...
...
class SelectionFilterModel(GObject.Object, Gio.ListModel): 
    @classmethod
    def new(cls, model: SelectionModel) -> SelectionFilterModel: ...
    def get_model(self) -> SelectionModel: ...
    def set_model(self, model: SelectionModel) -> None: ...
...
class Shortcut(GObject.Object): 
    @classmethod
    def new(cls, trigger: ShortcutTrigger, action: ShortcutAction) -> Shortcut: ...
    def get_action(self) -> ShortcutAction: ...
    def get_arguments(self) -> GLib.Variant: ...
    def get_trigger(self) -> ShortcutTrigger: ...
    def set_action(self, action: ShortcutAction) -> None: ...
    def set_arguments(self, args: GLib.Variant) -> None: ...
    def set_trigger(self, trigger: ShortcutTrigger) -> None: ...

class ShortcutAction(GObject.Object): 
    @classmethod
    def parse_string(cls, string: str) -> ShortcutAction: ...
    def activate(self, flags: ShortcutActionFlags, widget: Widget, args: GLib.Variant) -> bool: ...
...
class ShortcutTrigger(GObject.Object): 
    @classmethod
    def parse_string(cls, string: str) -> ShortcutTrigger: ...
...
class SingleSelection(GObject.Object, Gio.ListModel, SelectionModel): 
    @classmethod
    def new(cls, model: Gio.ListModel) -> SingleSelection: ...
...
class SliceListModel(GObject.Object, Gio.ListModel): 
    @classmethod
    def new(cls, model: Gio.ListModel, offset: int, size: int) -> SliceListModel: ...
    def get_model(self) -> Gio.ListModel: ...
...
class Snapshot(Gdk.Snapshot): 
    ...
    def free_to_node(self) -> Gsk.RenderNode: ...
    def free_to_paintable(self, size: Graphene.Size) -> Gdk.Paintable: ...
    ...
    def push_repeat(self, bounds: Graphene.Rect, child_bounds: Graphene.Rect) -> None: ...
    ...
    def to_node(self) -> Gsk.RenderNode: ...
    def to_paintable(self, size: Graphene.Size) -> Gdk.Paintable: ...
    def transform(self, transform: Gsk.Transform) -> None: ...
...
class SortListModel(GObject.Object, Gio.ListModel): 
    @classmethod
    def new(cls, model: Gio.ListModel, sorter: Sorter) -> SortListModel: ...
    def get_incremental(self) -> bool: ...
    def get_model(self) -> Gio.ListModel: ...
    def get_pending(self) -> int: ...
    def get_sorter(self) -> Sorter: ...
...
class Stack(Widget, Accessible, Buildable, ConstraintTarget): 
    ...
    def add_named(self, child: Widget, name: str) -> StackPage: ...
    def add_titled(self, child: Widget, name: str, title: str) -> StackPage: ...
...
class StringFilter(Filter): 
    @classmethod
    def new(cls, expression: Expression) -> StringFilter: ...
    def get_expression(self) -> Expression: ...
...
class StringList(GObject.Object, Gio.ListModel, Buildable): 
    @classmethod
    def new(cls, strings: list[str]) -> StringList: ...
    def append(self, string: str) -> None: ...
    def get_string(self, position: int) -> str: ...
    def remove(self, position: int) -> None: ...
    def splice(self, position: int, n_removals: int, additions: list[str]) -> None: ...
...
class StringSorter(Sorter): 
    @classmethod
    def new(cls, expression: Expression) -> StringSorter: ...
    def get_expression(self) -> Expression: ...
    def get_ignore_case(self) -> bool: ...
    def set_expression(self, expression: Expression) -> None: ...
    def set_ignore_case(self, ignore_case: bool) -> None: ...
...
class TextBuffer(GObject.Object): 
    ...
    def paste_clipboard(self, clipboard: Gdk.Clipboard, override_location: TextIter, default_editable: bool) -> None: ...
...
class TextView(Widget, Accessible, Buildable, ConstraintTarget, Scrollable): 
    ...
    def get_extra_menu(self) -> Gio.MenuModel: ...
    def get_gutter(self, win: TextWindowType) -> Widget: ...
    ...
    def set_extra_menu(self, model: Gio.MenuModel) -> None: ...
    def set_gutter(self, win: TextWindowType, widget: Widget) -> None: ...
...
class ToggleButton(Button, Accessible, Actionable, Buildable, ConstraintTarget): 
    ...
    def get_active(self) -> bool: ...
    def set_active(self, is_active: bool) -> None: ...
    def set_group(self, group: ToggleButton) -> None: ...
    def toggled(self) -> None: ...

class Tooltip(GObject.Object): 
    def set_custom(self, custom_widget: Widget) -> None: ...
    def set_icon(self, paintable: Gdk.Paintable) -> None: ...
    def set_icon_from_gicon(self, gicon: Gio.Icon) -> None: ...
    def set_icon_from_icon_name(self, icon_name: str) -> None: ...
    def set_markup(self, markup: str) -> None: ...
    def set_text(self, text: str) -> None: ...
...
class TreeExpander(Widget, Accessible, Buildable, ConstraintTarget): 
    ...
    def get_item(self) -> GObject.Object: ...
    def get_list_row(self) -> TreeListRow: ...
    def set_child(self, child: Widget) -> None: ...
    def set_indent_for_icon(self, indent_for_icon: bool) -> None: ...
    def set_list_row(self, list_row: TreeListRow) -> None: ...

class TreeListModel(GObject.Object, Gio.ListModel): 
    @classmethod
    def new(cls, root: Gio.ListModel, passthrough: bool, autoexpand: bool, create_func: TreeListModelCreateModelFunc, user_data: object, user_destroy: GLib.DestroyNotify) -> TreeListModel: ...
    def get_autoexpand(self) -> bool: ...
    def get_child_row(self, position: int) -> TreeListRow: ...
    def get_model(self) -> Gio.ListModel: ...
    def get_passthrough(self) -> bool: ...
    def get_row(self, position: int) -> TreeListRow: ...
    def set_autoexpand(self, autoexpand: bool) -> None: ...

class TreeListRow(GObject.Object): 
    def get_child_row(self, position: int) -> TreeListRow: ...
    def get_children(self) -> Gio.ListModel: ...
    def get_depth(self) -> int: ...
    def get_expanded(self) -> bool: ...
    def get_item(self) -> GObject.Object: ...
    def get_parent(self) -> TreeListRow: ...
    def get_position(self) -> int: ...
...
class TreeListRowSorter(Sorter): 
    @classmethod
    def new(cls, sorter: Sorter) -> TreeListRowSorter: ...
    def get_sorter(self) -> Sorter: ...
    def set_sorter(self, sorter: Sorter) -> None: ...
...
class TreeView(Widget, Accessible, Buildable, ConstraintTarget, Scrollable): 
    ...
    def create_row_drag_icon(self, path: TreePath) -> Gdk.Paintable: ...
    def enable_model_drag_dest(self, formats: Gdk.ContentFormats, actions: Gdk.DragAction) -> None: ...
    def enable_model_drag_source(self, start_button_mask: Gdk.ModifierType, formats: Gdk.ContentFormats, actions: Gdk.DragAction) -> None: ...
    ...
    def get_search_entry(self) -> Editable: ...
    ...
    def set_search_entry(self, entry: Editable) -> None: ...
...
class Widget(GObject.InitiallyUnowned, Accessible, Buildable, ConstraintTarget): 
    ...
    def activate_action_variant(self, name: str, args: GLib.Variant) -> bool: ...
    ...
    def allocate(self, width: int, height: int, baseline: int, transform: Gsk.Transform) -> None: ...
    ...
    def get_cursor(self) -> Gdk.Cursor: ...
    def get_direction(self) -> TextDirection: ...
    def get_display(self) -> Gdk.Display: ...
    def get_first_child(self) -> Widget: ...
    ...
    def get_last_child(self) -> Widget: ...
    def get_layout_manager(self) -> LayoutManager: ...
    ...
    def insert_after(self, parent: Widget, previous_sibling: Widget) -> None: ...
    def insert_before(self, parent: Widget, next_sibling: Widget) -> None: ...
    ...
    def pick(self, x: float, y: float, flags: PickFlags) -> Widget: ...
    ...
    def set_cursor(self, cursor: Gdk.Cursor) -> None: ...
    def set_cursor_from_name(self, name: str) -> None: ...
...
class WidgetPaintable(GObject.Object, Gdk.Paintable): 
    @classmethod
    def new(cls, widget: Widget) -> WidgetPaintable: ...
    def get_widget(self) -> Widget: ...
    def set_widget(self, widget: Widget) -> None: ...
...
class Window(Widget, Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager): 
    ...
    def set_default_widget(self, default_widget: Widget) -> None: ...
...
class Buildable: 
    ...
    def custom_tag_start(self, builder: Builder, child: GObject.Object, tagname: str, parser: BuildableParser, data: object) -> bool: ...
    def get_id(self) -> str: ...
...
class Editable(Widget): 
    ...
    def get_delegate(self) -> Editable: ...
...
class FileChooser: 
    ...
    def get_current_folder(self) -> Gio.File: ...
    ...
    def set_current_folder(self, file: Gio.File) -> bool: ...
...
class TreeDragSource: 
    ...
    def drag_data_get(self, path: TreePath) -> Gdk.ContentProvider: ...
