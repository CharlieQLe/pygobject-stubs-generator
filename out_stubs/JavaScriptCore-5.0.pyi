...
def options_foreach(function: OptionsFunc, user_data: object) -> None: ...
...
class Class(GObject.Object): 
    def add_constructor(self, name: str, callback: GObject.Callback, user_data: object, destroy_notify: GLib.DestroyNotify, return_type: GObject.Type, n_params: int) -> Value: ...
    def add_constructor_variadic(self, name: str, callback: GObject.Callback, user_data: object, destroy_notify: GLib.DestroyNotify, return_type: GObject.Type) -> Value: ...
    def add_constructorv(self, name: str, callback: GObject.Callback, user_data: object, destroy_notify: GLib.DestroyNotify, return_type: GObject.Type, n_parameters: int, parameter_types: list[GObject.Type]) -> Value: ...
    def add_method(self, name: str, callback: GObject.Callback, user_data: object, destroy_notify: GLib.DestroyNotify, return_type: GObject.Type, n_params: int) -> None: ...
    def add_method_variadic(self, name: str, callback: GObject.Callback, user_data: object, destroy_notify: GLib.DestroyNotify, return_type: GObject.Type) -> None: ...
    def add_methodv(self, name: str, callback: GObject.Callback, user_data: object, destroy_notify: GLib.DestroyNotify, return_type: GObject.Type, n_parameters: int, parameter_types: list[GObject.Type]) -> None: ...
    def add_property(self, name: str, property_type: GObject.Type, getter: GObject.Callback, setter: GObject.Callback, user_data: object, destroy_notify: GLib.DestroyNotify) -> None: ...
...
class Context(GObject.Object): 
    ...
    def evaluate_in_object(self, code: str, length: gssize, object_instance: object, object_class: Class, uri: str, line_number: int, object: Value) -> Value: ...
    ...
    def push_exception_handler(self, handler: ExceptionHandler, user_data: object, destroy_notify: GLib.DestroyNotify) -> None: ...
    def register_class(self, name: str, parent_class: Class, vtable: ClassVTable, destroy_notify: GLib.DestroyNotify) -> Class: ...
...
class Exception(GObject.Object): 
    ...
    def get_backtrace_string(self) -> str: ...
...
class Value(GObject.Object): 
    ...
    def array_buffer_get_data(self, size: gsize) -> object: ...
    def array_buffer_get_size(self) -> gsize: ...
    def constructor_call(self, first_parameter_type: GObject.Type) -> Value: ...
    def constructor_callv(self, n_parameters: int, parameters: list[Value]) -> Value: ...
    def function_call(self, first_parameter_type: GObject.Type) -> Value: ...
    def function_callv(self, n_parameters: int, parameters: list[Value]) -> Value: ...
    ...
    def object_define_property_accessor(self, property_name: str, flags: ValuePropertyFlags, property_type: GObject.Type, getter: GObject.Callback, setter: GObject.Callback, user_data: object, destroy_notify: GLib.DestroyNotify) -> None: ...
    def object_define_property_data(self, property_name: str, flags: ValuePropertyFlags, property_value: Value) -> None: ...
    def object_delete_property(self, name: str) -> bool: ...
    def object_enumerate_properties(self) -> list[str]: ...
    ...
    def object_invoke_methodv(self, name: str, n_parameters: int, parameters: list[Value]) -> Value: ...
    ...
    def typed_array_get_data(self, length: gsize) -> object: ...
