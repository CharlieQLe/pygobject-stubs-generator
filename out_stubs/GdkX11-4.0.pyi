...
def x11_device_manager_lookup(device_manager: X11DeviceManagerXI2, device_id: int) -> X11DeviceXI2: ...
...
def x11_set_sm_client_id(sm_client_id: str) -> None: ...
...
class X11Display(Gdk.Display): 
    @classmethod
    def open(cls, display_name: str) -> Gdk.Display: ...
    @classmethod
    ...
    def grab(self) -> None: ...
    def set_cursor_theme(self, theme: str, size: int) -> None: ...
...
class X11Surface(Gdk.Surface): 
    ...
    def get_group(self) -> Gdk.Surface: ...
    ...
    def set_utf8_property(self, name: str, value: str) -> None: ...
