...
def cookie_parse(header: str, origin: GLib.Uri | None) -> Cookie | None: ...
...
def form_decode_multipart(multipart: Multipart, file_control_name: str | None, filename: str, content_type: str, file: GLib.Bytes) -> GLib.HashTable | None: ...
...
def header_parse_param_list_strict(header: str) -> GLib.HashTable | None: ...
...
def header_parse_semi_param_list_strict(header: str) -> GLib.HashTable | None: ...
...
def uri_decode_data_uri(uri: str, content_type: str | None) -> GLib.Bytes: ...
def uri_equal(uri1: GLib.Uri, uri2: GLib.Uri) -> bool: ...
def websocket_client_prepare_handshake(msg: Message, origin: str | None, protocols: list[str] | None, supported_extensions: list[GObject.TypeClass] | None) -> None: ...
def websocket_client_verify_handshake(msg: Message, supported_extensions: list[GObject.TypeClass] | None, accepted_extensions: GLib.List) -> bool: ...
def websocket_error_quark() -> GLib.Quark: ...
def websocket_server_check_handshake(msg: ServerMessage, origin: str | None, protocols: list[str] | None, supported_extensions: list[GObject.TypeClass] | None) -> bool: ...
def websocket_server_process_handshake(msg: ServerMessage, expected_origin: str | None, protocols: list[str] | None, supported_extensions: list[GObject.TypeClass] | None, accepted_extensions: GLib.List) -> bool: ...

class Auth(GObject.Object): 
    @classmethod
    def new(cls, type: GObject.Type, msg: Message, auth_header: str) -> Auth | None: ...
...
class AuthDomain(GObject.Object): 
    ...
    def set_filter(self, filter: AuthDomainFilter, filter_data: object | None, dnotify: GLib.DestroyNotify) -> None: ...
    def set_generic_auth_callback(self, auth_callback: AuthDomainGenericAuthCallback, auth_data: object | None, dnotify: GLib.DestroyNotify) -> None: ...

class AuthDomainBasic(AuthDomain): 
    @classmethod
    def new(cls, optname1: str) -> AuthDomain: ...
    def set_auth_callback(self, callback: AuthDomainBasicAuthCallback, user_data: object | None, dnotify: GLib.DestroyNotify) -> None: ...
...
class AuthDomainDigest(AuthDomain): 
    ...
    def set_auth_callback(self, callback: AuthDomainDigestAuthCallback, user_data: object | None, dnotify: GLib.DestroyNotify) -> None: ...
...
class ContentSniffer(GObject.Object, SessionFeature): 
    ...
    def sniff(self, msg: Message, buffer: GLib.Bytes, params: GLib.HashTable | None) -> str: ...

class CookieJar(GObject.Object, SessionFeature): 
    @classmethod
    def new(cls) -> CookieJar: ...
    def add_cookie(self, cookie: Cookie) -> None: ...
    def add_cookie_full(self, cookie: Cookie, uri: GLib.Uri | None, first_party: GLib.Uri | None) -> None: ...
    ...
    def get_cookie_list_with_same_site_info(self, uri: GLib.Uri, top_level: GLib.Uri | None, site_for_cookies: GLib.Uri | None, for_http: bool, is_safe_method: bool, is_top_level_navigation: bool) -> GLib.SList: ...
...
class Logger(GObject.Object, SessionFeature): 
    ...
    def set_printer(self, printer: LoggerPrinter, printer_data: object | None, destroy: GLib.DestroyNotify) -> None: ...
    def set_request_filter(self, request_filter: LoggerFilter, filter_data: object | None, destroy: GLib.DestroyNotify) -> None: ...
    def set_response_filter(self, response_filter: LoggerFilter, filter_data: object | None, destroy: GLib.DestroyNotify) -> None: ...

class Message(GObject.Object): 
    @classmethod
    def new(cls, method: str, uri_string: str) -> Message | None: ...
    def add_flags(self, flags: MessageFlags) -> None: ...
    def add_header_handler(self, signal: str, header: str, callback: GObject.Callback, user_data: object | None) -> int: ...
    def add_status_code_handler(self, signal: str, status_code: int, callback: GObject.Callback, user_data: object | None) -> int: ...
    ...
    def set_request_body(self, content_type: str | None, stream: Gio.InputStream | None, content_length: gssize) -> None: ...
    def set_request_body_from_bytes(self, content_type: str | None, bytes: GLib.Bytes | None) -> None: ...
    def set_site_for_cookies(self, site_for_cookies: GLib.Uri | None) -> None: ...
    def set_tls_client_certificate(self, certificate: Gio.TlsCertificate | None) -> None: ...
...
class MultipartInputStream(Gio.FilterInputStream, Gio.PollableInputStream): 
    ...
    def next_part(self, cancellable: Gio.Cancellable | None) -> Gio.InputStream | None: ...
    def next_part_async(self, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, data: object | None) -> None: ...
    def next_part_finish(self, result: Gio.AsyncResult) -> Gio.InputStream | None: ...

class Server(GObject.Object): 
    @classmethod
    def new(cls, optname1: str) -> Server | None: ...
    def accept_iostream(self, stream: Gio.IOStream, local_addr: Gio.SocketAddress | None, remote_addr: Gio.SocketAddress | None) -> bool: ...
    def add_auth_domain(self, auth_domain: AuthDomain) -> None: ...
    def add_early_handler(self, path: str | None, callback: ServerCallback, user_data: object | None, destroy: GLib.DestroyNotify) -> None: ...
    def add_handler(self, path: str | None, callback: ServerCallback, user_data: object | None, destroy: GLib.DestroyNotify) -> None: ...
    def add_websocket_extension(self, extension_type: GObject.Type) -> None: ...
    def add_websocket_handler(self, path: str | None, origin: str | None, protocols: list[str] | None, callback: ServerWebsocketCallback, user_data: object | None, destroy: GLib.DestroyNotify) -> None: ...
...
class ServerMessage(GObject.Object): 
    ...
    def set_response(self, content_type: str | None, resp_use: MemoryUse, resp_body: list[int] | None, resp_length: gsize) -> None: ...
...
class Session(GObject.Object): 
    ...
    def get_async_result_message(self, result: Gio.AsyncResult) -> Message | None: ...
    def get_feature(self, feature_type: GObject.Type) -> SessionFeature | None: ...
    def get_feature_for_message(self, feature_type: GObject.Type, msg: Message) -> SessionFeature | None: ...
    ...
    def preconnect_async(self, msg: Message, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    ...
    def send(self, msg: Message, cancellable: Gio.Cancellable | None) -> Gio.InputStream: ...
    def send_and_read(self, msg: Message, cancellable: Gio.Cancellable | None) -> GLib.Bytes: ...
    def send_and_read_async(self, msg: Message, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    def send_and_read_finish(self, result: Gio.AsyncResult) -> GLib.Bytes: ...
    def send_async(self, msg: Message, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    ...
    def set_proxy_resolver(self, proxy_resolver: Gio.ProxyResolver | None) -> None: ...
    def set_timeout(self, timeout: int) -> None: ...
    def set_tls_database(self, tls_database: Gio.TlsDatabase | None) -> None: ...
    def set_tls_interaction(self, tls_interaction: Gio.TlsInteraction | None) -> None: ...
    def set_user_agent(self, user_agent: str) -> None: ...
    def websocket_connect_async(self, msg: Message, origin: str | None, protocols: list[str] | None, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    def websocket_connect_finish(self, result: Gio.AsyncResult) -> WebsocketConnection: ...

class WebsocketConnection(GObject.Object): 
    @classmethod
    def new(cls, stream: Gio.IOStream, uri: GLib.Uri, type: WebsocketConnectionType, origin: str | None, protocol: str | None, extensions: GLib.List) -> WebsocketConnection: ...
    def close(self, code: gushort, data: str | None) -> None: ...
    ...
    def get_uri(self) -> GLib.Uri: ...
    def send_binary(self, data: list[int] | None, length: gsize) -> None: ...
...
class WebsocketExtension(GObject.Object): 
    def configure(self, connection_type: WebsocketConnectionType, params: GLib.HashTable | None) -> bool: ...
