...
def attr_list_from_string(text: str) -> AttrList: ...
...
def attr_shape_new_with_data(ink_rect: Rectangle, logical_rect: Rectangle, data: object, copy_func: AttrDataCopyFunc, destroy_func: GLib.DestroyNotify) -> Attribute: ...
...
def attr_type_get_name(type: AttrType) -> str: ...
...
def default_break(text: str, length: int, analysis: Analysis, attrs: LogAttr, attrs_len: int) -> None: ...
def extents_to_pixels(inclusive: Rectangle, nearest: Rectangle) -> None: ...
...
def gravity_get_for_matrix(matrix: Matrix) -> Gravity: ...
...
def itemize(context: Context, text: str, start_index: int, length: int, attrs: AttrList, cached_iter: AttrIterator) -> GLib.List: ...
def itemize_with_base_dir(context: Context, base_dir: Direction, text: str, start_index: int, length: int, attrs: AttrList, cached_iter: AttrIterator) -> GLib.List: ...
def language_from_string(language: str) -> Language: ...
...
def parse_enum(type: GObject.Type, str: str, value: int, warn: bool, possible_values: str) -> bool: ...
...
def read_line(stream: object, str: GLib.String) -> int: ...
...
def script_get_sample_language(script: Script) -> Language: ...
def shape(text: str, length: int, analysis: Analysis, glyphs: GlyphString) -> None: ...
def shape_full(item_text: str, item_length: int, paragraph_text: str, paragraph_length: int, analysis: Analysis, glyphs: GlyphString) -> None: ...
def shape_item(item: Item, paragraph_text: str, paragraph_length: int, log_attrs: LogAttr, glyphs: GlyphString, flags: ShapeFlags) -> None: ...
def shape_with_flags(item_text: str, item_length: int, paragraph_text: str, paragraph_length: int, analysis: Analysis, glyphs: GlyphString, flags: ShapeFlags) -> None: ...
def skip_space(pos: str) -> bool: ...
def split_file_list(str: str) -> list[str]: ...
def tab_array_from_string(text: str) -> TabArray: ...
...
class Context(GObject.Object): 
    ...
    def get_metrics(self, desc: FontDescription, language: Language) -> FontMetrics: ...
...
class Coverage(GObject.Object): 
    ...
    @classmethod
    def from_bytes(cls, bytes: list[int], n_bytes: int) -> Coverage: ...
...
class Font(GObject.Object): 
    @classmethod
    def descriptions_free(cls, descs: list[FontDescription], n_descs: int) -> None: ...
    @classmethod
    def deserialize(cls, context: Context, bytes: GLib.Bytes) -> Font: ...
...
class FontFace(GObject.Object): 
    ...
    def list_sizes(self, sizes: list[int], n_sizes: int) -> None: ...

class FontFamily(GObject.Object, Gio.ListModel): 
    def get_face(self, name: str) -> FontFace: ...
...
class Fontset(GObject.Object): 
    def foreach(self, func: FontsetForeachFunc, data: object) -> None: ...
...
class Layout(GObject.Object): 
    ...
    @classmethod
    def deserialize(cls, context: Context, bytes: GLib.Bytes, flags: LayoutDeserializeFlags) -> Layout: ...
    ...
    def set_tabs(self, tabs: TabArray) -> None: ...
...
class Renderer(GObject.Object): 
    ...
    def draw_glyph_item(self, text: str, glyph_item: GlyphItem, x: int, y: int) -> None: ...
    ...
    def set_color(self, part: RenderPart, color: Color) -> None: ...
    def set_matrix(self, matrix: Matrix) -> None: ...
