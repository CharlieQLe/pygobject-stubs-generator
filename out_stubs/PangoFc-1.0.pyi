...
class Font(Pango.Font): 
    ...
    def get_languages(self) -> list[Pango.Language] | None: ...
...
class FontMap(Pango.FontMap, Gio.ListModel): 
    def add_decoder_find_func(self, findfunc: DecoderFindFunc, user_data: object | None, dnotify: GLib.DestroyNotify) -> None: ...
    def cache_clear(self) -> None: ...
    def config_changed(self) -> None: ...
    def create_context(self) -> Pango.Context: ...
    def find_decoder(self, pattern: fontconfig.Pattern) -> Decoder | None: ...
    def get_config(self) -> fontconfig.Config | None: ...
    def get_hb_face(self, fcfont: Font) -> HarfBuzz.face_t | None: ...
    def set_config(self, fcconfig: fontconfig.Config | None) -> None: ...
    def set_default_substitute(self, func: SubstituteFunc, data: object | None, notify: GLib.DestroyNotify) -> None: ...
