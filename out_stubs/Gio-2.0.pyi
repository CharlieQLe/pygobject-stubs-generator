...
def app_info_create_from_commandline(commandline: filename, application_name: str, flags: AppInfoCreateFlags) -> AppInfo: ...
def app_info_get_all() -> GLib.List: ...
def app_info_get_all_for_type(content_type: str) -> GLib.List: ...
def app_info_get_default_for_type(content_type: str, must_support_uris: bool) -> AppInfo: ...
def app_info_get_default_for_type_async(content_type: str, must_support_uris: bool, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
def app_info_get_default_for_type_finish(result: AsyncResult) -> AppInfo: ...
def app_info_get_default_for_uri_scheme(uri_scheme: str) -> AppInfo: ...
def app_info_get_default_for_uri_scheme_async(uri_scheme: str, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
def app_info_launch_default_for_uri(uri: str, context: AppLaunchContext) -> bool: ...
def app_info_launch_default_for_uri_async(uri: str, context: AppLaunchContext, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
def async_initable_newv_async(object_type: GObject.Type, n_parameters: int, parameters: GObject.Parameter, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
def bus_get(bus_type: BusType, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
def bus_get_finish(res: AsyncResult) -> DBusConnection: ...
def bus_get_sync(bus_type: BusType, cancellable: Cancellable) -> DBusConnection: ...
def bus_own_name(bus_type: BusType, name: str, flags: BusNameOwnerFlags, bus_acquired_handler: BusAcquiredCallback, name_acquired_handler: BusNameAcquiredCallback, name_lost_handler: BusNameLostCallback, user_data: object, user_data_free_func: GLib.DestroyNotify) -> int: ...
def bus_own_name_on_connection(connection: DBusConnection, name: str, flags: BusNameOwnerFlags, name_acquired_handler: BusNameAcquiredCallback, name_lost_handler: BusNameLostCallback, user_data: object, user_data_free_func: GLib.DestroyNotify) -> int: ...
def bus_own_name_on_connection_with_closures(connection: DBusConnection, name: str, flags: BusNameOwnerFlags, name_acquired_closure: GObject.Closure, name_lost_closure: GObject.Closure) -> int: ...
def bus_own_name_with_closures(bus_type: BusType, name: str, flags: BusNameOwnerFlags, bus_acquired_closure: GObject.Closure, name_acquired_closure: GObject.Closure, name_lost_closure: GObject.Closure) -> int: ...
def bus_unown_name(owner_id: int) -> None: ...
def bus_unwatch_name(watcher_id: int) -> None: ...
def bus_watch_name(bus_type: BusType, name: str, flags: BusNameWatcherFlags, name_appeared_handler: BusNameAppearedCallback, name_vanished_handler: BusNameVanishedCallback, user_data: object, user_data_free_func: GLib.DestroyNotify) -> int: ...
def bus_watch_name_on_connection(connection: DBusConnection, name: str, flags: BusNameWatcherFlags, name_appeared_handler: BusNameAppearedCallback, name_vanished_handler: BusNameVanishedCallback, user_data: object, user_data_free_func: GLib.DestroyNotify) -> int: ...
def bus_watch_name_on_connection_with_closures(connection: DBusConnection, name: str, flags: BusNameWatcherFlags, name_appeared_closure: GObject.Closure, name_vanished_closure: GObject.Closure) -> int: ...
def bus_watch_name_with_closures(bus_type: BusType, name: str, flags: BusNameWatcherFlags, name_appeared_closure: GObject.Closure, name_vanished_closure: GObject.Closure) -> int: ...
...
def content_type_guess(filename: filename, data: list[int], data_size: gsize, result_uncertain: bool) -> str: ...
...
def content_type_set_mime_dirs(dirs: list[str]) -> None: ...
def content_types_get_registered() -> GLib.List: ...
def dbus_address_escape_value(string: str) -> str: ...
def dbus_address_get_for_bus_sync(bus_type: BusType, cancellable: Cancellable) -> str: ...
def dbus_address_get_stream(address: str, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
def dbus_address_get_stream_finish(res: AsyncResult, out_guid: str) -> IOStream: ...
def dbus_address_get_stream_sync(address: str, out_guid: str, cancellable: Cancellable) -> IOStream: ...
def dbus_annotation_info_lookup(annotations: list[DBusAnnotationInfo], name: str) -> str: ...
def dbus_error_encode_gerror(error: GLib.Error) -> str: ...
def dbus_error_get_remote_error(error: GLib.Error) -> str: ...
...
def dbus_unescape_object_path(s: str) -> list[int]: ...
def dtls_client_connection_new(base_socket: DatagramBased, server_identity: SocketConnectable) -> DtlsClientConnection: ...
def dtls_server_connection_new(base_socket: DatagramBased, certificate: TlsCertificate) -> DtlsServerConnection: ...
...
def file_new_tmp(tmpl: filename, iostream: FileIOStream) -> File: ...
def file_new_tmp_async(tmpl: filename, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
def file_new_tmp_dir_async(tmpl: filename, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
def initable_newv(object_type: GObject.Type, n_parameters: int, parameters: list[GObject.Parameter], cancellable: Cancellable) -> GObject.Object: ...
...
def io_scheduler_push_job(job_func: IOSchedulerJobFunc, user_data: object, notify: GLib.DestroyNotify, io_priority: int, cancellable: Cancellable) -> None: ...
def keyfile_settings_backend_new(filename: str, root_path: str, root_group: str) -> SettingsBackend: ...
...
def pollable_source_new_full(pollable_stream: GObject.Object, child_source: GLib.Source, cancellable: Cancellable) -> GLib.Source: ...
def pollable_stream_read(stream: InputStream, buffer: list[int], count: gsize, blocking: bool, cancellable: Cancellable) -> gssize: ...
def pollable_stream_write(stream: OutputStream, buffer: list[int], count: gsize, blocking: bool, cancellable: Cancellable) -> gssize: ...
def pollable_stream_write_all(stream: OutputStream, buffer: list[int], count: gsize, blocking: bool, bytes_written: gsize, cancellable: Cancellable) -> bool: ...
def power_profile_monitor_dup_default() -> PowerProfileMonitor: ...
def proxy_get_default_for_protocol(protocol: str) -> Proxy: ...
...
def settings_schema_source_get_default() -> SettingsSchemaSource: ...
def simple_async_report_error_in_idle(object: GObject.Object, callback: AsyncReadyCallback, user_data: object, domain: GLib.Quark, code: int, format: str) -> None: ...
def simple_async_report_gerror_in_idle(object: GObject.Object, callback: AsyncReadyCallback, user_data: object, error: GLib.Error) -> None: ...
def simple_async_report_take_gerror_in_idle(object: GObject.Object, callback: AsyncReadyCallback, user_data: object, error: GLib.Error) -> None: ...
...
def tls_client_connection_new(base_io_stream: IOStream, server_identity: SocketConnectable) -> TlsClientConnection: ...
def tls_error_quark() -> GLib.Quark: ...
def tls_file_database_new(anchors: filename) -> TlsFileDatabase: ...
def tls_server_connection_new(base_io_stream: IOStream, certificate: TlsCertificate) -> TlsServerConnection: ...
...
def unix_mount_at(mount_path: filename, time_read: int) -> UnixMountEntry: ...
...
def unix_mount_for(file_path: filename, time_read: int) -> UnixMountEntry: ...
...
def unix_mount_point_at(mount_path: filename, time_read: int) -> UnixMountPoint: ...
...
class Application(GObject.Object, ActionGroup, ActionMap): 
    ...
    def add_main_option(self, long_name: str, short_name: str, flags: GLib.OptionFlags, arg: GLib.OptionArg, description: str, arg_description: str) -> None: ...
    ...
    def quit(self) -> None: ...
    def register(self, cancellable: Cancellable) -> bool: ...
    def release(self) -> None: ...
    def run(self, argc: int, argv: list[filename]) -> int: ...
    def send_notification(self, id: str, notification: Notification) -> None: ...
    def set_action_group(self, action_group: ActionGroup) -> None: ...
    ...
    def set_option_context_description(self, description: str) -> None: ...
    def set_option_context_parameter_string(self, parameter_string: str) -> None: ...
    def set_option_context_summary(self, summary: str) -> None: ...
    def set_resource_base_path(self, resource_path: str) -> None: ...
...
class ApplicationCommandLine(GObject.Object): 
    ...
    def getenv(self, name: filename) -> str: ...
...
class BufferedInputStream(FilterInputStream, Seekable): 
    ...
    def fill(self, count: gssize, cancellable: Cancellable) -> gssize: ...
    def fill_async(self, count: gssize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def read_byte(self, cancellable: Cancellable) -> int: ...
...
class Cancellable(GObject.Object): 
    ...
    def connect(self, callback: GObject.Callback, data: object, data_destroy_func: GLib.DestroyNotify) -> int: ...
...
class DBusActionGroup(GObject.Object, ActionGroup, RemoteActionGroup): 
    @classmethod
    def get(cls, connection: DBusConnection, bus_name: str, object_path: str) -> DBusActionGroup: ...

class DBusAuthObserver(GObject.Object): 
    @classmethod
    def new(cls) -> DBusAuthObserver: ...
    def allow_mechanism(self, mechanism: str) -> bool: ...
    def authorize_authenticated_peer(self, stream: IOStream, credentials: Credentials) -> bool: ...

class DBusConnection(GObject.Object, AsyncInitable, Initable): 
    @classmethod
    def new_finish(cls, res: AsyncResult) -> DBusConnection: ...
    @classmethod
    def new(cls, stream: IOStream, guid: str, flags: DBusConnectionFlags, observer: DBusAuthObserver, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    @classmethod
    def new_for_address(cls, address: str, flags: DBusConnectionFlags, observer: DBusAuthObserver, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def add_filter(self, filter_function: DBusMessageFilterFunction, user_data: object, user_data_free_func: GLib.DestroyNotify) -> int: ...
    def call(self, bus_name: str, object_path: str, interface_name: str, method_name: str, parameters: GLib.Variant, reply_type: GLib.VariantType, flags: DBusCallFlags, timeout_msec: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def call_finish(self, res: AsyncResult) -> GLib.Variant: ...
    def call_sync(self, bus_name: str, object_path: str, interface_name: str, method_name: str, parameters: GLib.Variant, reply_type: GLib.VariantType, flags: DBusCallFlags, timeout_msec: int, cancellable: Cancellable) -> GLib.Variant: ...
    def call_with_unix_fd_list(self, bus_name: str, object_path: str, interface_name: str, method_name: str, parameters: GLib.Variant, reply_type: GLib.VariantType, flags: DBusCallFlags, timeout_msec: int, fd_list: UnixFDList, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def call_with_unix_fd_list_finish(self, out_fd_list: UnixFDList, res: AsyncResult) -> GLib.Variant: ...
    def call_with_unix_fd_list_sync(self, bus_name: str, object_path: str, interface_name: str, method_name: str, parameters: GLib.Variant, reply_type: GLib.VariantType, flags: DBusCallFlags, timeout_msec: int, fd_list: UnixFDList, out_fd_list: UnixFDList, cancellable: Cancellable) -> GLib.Variant: ...
    def close(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def close_finish(self, res: AsyncResult) -> bool: ...
    def close_sync(self, cancellable: Cancellable) -> bool: ...
    ...
    def flush(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def flush_finish(self, res: AsyncResult) -> bool: ...
    def flush_sync(self, cancellable: Cancellable) -> bool: ...
    ...
    def register_object(self, object_path: str, interface_info: DBusInterfaceInfo, vtable: DBusInterfaceVTable, user_data: object, user_data_free_func: GLib.DestroyNotify) -> int: ...
    def register_object_with_closures(self, object_path: str, interface_info: DBusInterfaceInfo, method_call_closure: GObject.Closure, get_property_closure: GObject.Closure, set_property_closure: GObject.Closure) -> int: ...
    def register_subtree(self, object_path: str, vtable: DBusSubtreeVTable, flags: DBusSubtreeFlags, user_data: object, user_data_free_func: GLib.DestroyNotify) -> int: ...
    ...
    def send_message_with_reply(self, message: DBusMessage, flags: DBusSendMessageFlags, timeout_msec: int, out_serial: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def send_message_with_reply_finish(self, res: AsyncResult) -> DBusMessage: ...
    def send_message_with_reply_sync(self, message: DBusMessage, flags: DBusSendMessageFlags, timeout_msec: int, out_serial: int, cancellable: Cancellable) -> DBusMessage: ...
    def set_exit_on_close(self, exit_on_close: bool) -> None: ...
    def signal_subscribe(self, sender: str, interface_name: str, member: str, object_path: str, arg0: str, flags: DBusSignalFlags, callback: DBusSignalCallback, user_data: object, user_data_free_func: GLib.DestroyNotify) -> int: ...
...
class DBusMenuModel(MenuModel): 
    @classmethod
    def get(cls, connection: DBusConnection, bus_name: str, object_path: str) -> DBusMenuModel: ...
...
class DBusMessage(GObject.Object): 
    ...
    def set_header(self, header_field: DBusMessageHeaderField, value: GLib.Variant) -> None: ...
    def set_interface(self, value: str) -> None: ...
    def set_member(self, value: str) -> None: ...
    ...
    def set_signature(self, value: str) -> None: ...
    def set_unix_fd_list(self, fd_list: UnixFDList) -> None: ...
...
class DBusMethodInvocation(GObject.Object): 
    ...
    def return_value(self, parameters: GLib.Variant) -> None: ...
    def return_value_with_unix_fd_list(self, parameters: GLib.Variant, fd_list: UnixFDList) -> None: ...
...
class DBusObjectManagerClient(GObject.Object, AsyncInitable, DBusObjectManager, Initable): 
    ...
    @classmethod
    def new(cls, connection: DBusConnection, flags: DBusObjectManagerClientFlags, name: str, object_path: str, get_proxy_type_func: DBusProxyTypeFunc, get_proxy_type_user_data: object, get_proxy_type_destroy_notify: GLib.DestroyNotify, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    @classmethod
    def new_for_bus(cls, bus_type: BusType, flags: DBusObjectManagerClientFlags, name: str, object_path: str, get_proxy_type_func: DBusProxyTypeFunc, get_proxy_type_user_data: object, get_proxy_type_destroy_notify: GLib.DestroyNotify, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def get_connection(self) -> DBusConnection: ...
...
class DBusObjectManagerServer(GObject.Object, DBusObjectManager): 
    ...
    def set_connection(self, connection: DBusConnection) -> None: ...
...
class DBusProxy(GObject.Object, AsyncInitable, DBusInterface, Initable): 
    ...
    @classmethod
    def new(cls, connection: DBusConnection, flags: DBusProxyFlags, info: DBusInterfaceInfo, name: str, object_path: str, interface_name: str, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    @classmethod
    def new_for_bus(cls, bus_type: BusType, flags: DBusProxyFlags, info: DBusInterfaceInfo, name: str, object_path: str, interface_name: str, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def call(self, method_name: str, parameters: GLib.Variant, flags: DBusCallFlags, timeout_msec: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def call_finish(self, res: AsyncResult) -> GLib.Variant: ...
    def call_sync(self, method_name: str, parameters: GLib.Variant, flags: DBusCallFlags, timeout_msec: int, cancellable: Cancellable) -> GLib.Variant: ...
    def call_with_unix_fd_list(self, method_name: str, parameters: GLib.Variant, flags: DBusCallFlags, timeout_msec: int, fd_list: UnixFDList, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def call_with_unix_fd_list_finish(self, out_fd_list: UnixFDList, res: AsyncResult) -> GLib.Variant: ...
    def call_with_unix_fd_list_sync(self, method_name: str, parameters: GLib.Variant, flags: DBusCallFlags, timeout_msec: int, fd_list: UnixFDList, out_fd_list: UnixFDList, cancellable: Cancellable) -> GLib.Variant: ...
    ...
    def get_name_owner(self) -> str: ...
    def get_object_path(self) -> str: ...
    def set_cached_property(self, property_name: str, value: GLib.Variant) -> None: ...
    def set_default_timeout(self, timeout_msec: int) -> None: ...
    def set_interface_info(self, info: DBusInterfaceInfo) -> None: ...

class DBusServer(GObject.Object, Initable): 
    @classmethod
    def new_sync(cls, address: str, flags: DBusServerFlags, guid: str, observer: DBusAuthObserver, cancellable: Cancellable) -> DBusServer: ...
...
class DataInputStream(BufferedInputStream, Seekable): 
    ...
    def read_byte(self, cancellable: Cancellable) -> int: ...
    def read_int16(self, cancellable: Cancellable) -> int: ...
    def read_int32(self, cancellable: Cancellable) -> int: ...
    def read_int64(self, cancellable: Cancellable) -> int: ...
    def read_line(self, length: gsize, cancellable: Cancellable) -> list[int]: ...
    def read_line_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def read_line_finish(self, result: AsyncResult, length: gsize) -> list[int]: ...
    def read_line_finish_utf8(self, result: AsyncResult, length: gsize) -> str: ...
    def read_line_utf8(self, length: gsize, cancellable: Cancellable) -> str: ...
    def read_uint16(self, cancellable: Cancellable) -> int: ...
    def read_uint32(self, cancellable: Cancellable) -> int: ...
    def read_uint64(self, cancellable: Cancellable) -> int: ...
    def read_until(self, stop_chars: str, length: gsize, cancellable: Cancellable) -> str: ...
    def read_until_async(self, stop_chars: str, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def read_until_finish(self, result: AsyncResult, length: gsize) -> str: ...
    def read_upto(self, stop_chars: str, stop_chars_len: gssize, length: gsize, cancellable: Cancellable) -> str: ...
    def read_upto_async(self, stop_chars: str, stop_chars_len: gssize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class DataOutputStream(FilterOutputStream, Seekable): 
    ...
    def get_byte_order(self) -> DataStreamByteOrder: ...
    def put_byte(self, data: int, cancellable: Cancellable) -> bool: ...
    def put_int16(self, data: int, cancellable: Cancellable) -> bool: ...
    def put_int32(self, data: int, cancellable: Cancellable) -> bool: ...
    def put_int64(self, data: int, cancellable: Cancellable) -> bool: ...
    def put_string(self, str: str, cancellable: Cancellable) -> bool: ...
    def put_uint16(self, data: int, cancellable: Cancellable) -> bool: ...
    def put_uint32(self, data: int, cancellable: Cancellable) -> bool: ...
    def put_uint64(self, data: int, cancellable: Cancellable) -> bool: ...
    def set_byte_order(self, order: DataStreamByteOrder) -> None: ...

class DebugControllerDBus(GObject.Object, DebugController, Initable): 
    @classmethod
    def new(cls, connection: DBusConnection, cancellable: Cancellable) -> DebugControllerDBus: ...
    def stop(self) -> None: ...
...
class DesktopAppInfo(GObject.Object, AppInfo): 
    ...
    def get_show_in(self, desktop_env: str) -> bool: ...
    def get_startup_wm_class(self) -> str: ...
    def get_string(self, key: str) -> str: ...
    def get_string_list(self, key: str, length: gsize) -> list[str]: ...
    def has_key(self, key: str) -> bool: ...
    def launch_action(self, action_name: str, launch_context: AppLaunchContext) -> None: ...
    def launch_uris_as_manager(self, uris: GLib.List, launch_context: AppLaunchContext, spawn_flags: GLib.SpawnFlags, user_setup: GLib.SpawnChildSetupFunc, user_setup_data: object, pid_callback: DesktopAppLaunchCallback, pid_callback_data: object) -> bool: ...
    def launch_uris_as_manager_with_fds(self, uris: GLib.List, launch_context: AppLaunchContext, spawn_flags: GLib.SpawnFlags, user_setup: GLib.SpawnChildSetupFunc, user_setup_data: object, pid_callback: DesktopAppLaunchCallback, pid_callback_data: object, stdin_fd: int, stdout_fd: int, stderr_fd: int) -> bool: ...
...
class EmblemedIcon(GObject.Object, Icon): 
    @classmethod
    def new(cls, icon: Icon, emblem: Emblem) -> EmblemedIcon: ...
...
class FileEnumerator(GObject.Object): 
    def close(self, cancellable: Cancellable) -> bool: ...
    def close_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def close_finish(self, result: AsyncResult) -> bool: ...
    def get_child(self, info: FileInfo) -> File: ...
    def get_container(self) -> File: ...
    def has_pending(self) -> bool: ...
    def is_closed(self) -> bool: ...
    def iterate(self, out_info: FileInfo, out_child: File, cancellable: Cancellable) -> bool: ...
    def next_file(self, cancellable: Cancellable) -> FileInfo: ...
    def next_files_async(self, num_files: int, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def next_files_finish(self, result: AsyncResult) -> GLib.List: ...
    def set_pending(self, pending: bool) -> None: ...

class FileIOStream(IOStream, Seekable): 
    def get_etag(self) -> str: ...
    def query_info(self, attributes: str, cancellable: Cancellable) -> FileInfo: ...
    def query_info_async(self, attributes: str, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class FileInfo(GObject.Object): 
    ...
    def list_attributes(self, name_space: str) -> list[str]: ...
...
class IOStream(GObject.Object): 
    ...
    def splice_async(self, stream2: IOStream, flags: IOStreamSpliceFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class InputStream(GObject.Object): 
    ...
    def has_pending(self) -> bool: ...
    def is_closed(self) -> bool: ...
    def read(self, buffer: list[int], count: gsize, cancellable: Cancellable) -> gssize: ...
    def read_all(self, buffer: list[int], count: gsize, bytes_read: gsize, cancellable: Cancellable) -> bool: ...
    def read_all_async(self, buffer: list[int], count: gsize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def read_all_finish(self, result: AsyncResult, bytes_read: gsize) -> bool: ...
    def read_async(self, buffer: list[int], count: gsize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def read_bytes(self, count: gsize, cancellable: Cancellable) -> GLib.Bytes: ...
    def read_bytes_async(self, count: gsize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def read_bytes_finish(self, result: AsyncResult) -> GLib.Bytes: ...
    def read_finish(self, result: AsyncResult) -> gssize: ...
    def set_pending(self) -> bool: ...
    def skip(self, count: gsize, cancellable: Cancellable) -> gssize: ...
    def skip_async(self, count: gsize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class ListStore(GObject.Object, ListModel): 
    ...
    def find_with_equal_func_full(self, item: GObject.Object, equal_func: GLib.EqualFuncFull, user_data: object, position: int) -> bool: ...
    def insert(self, position: int, item: GObject.Object) -> None: ...
    def insert_sorted(self, item: GObject.Object, compare_func: GLib.CompareDataFunc, user_data: object) -> int: ...
    def remove(self, position: int) -> None: ...
    def remove_all(self) -> None: ...
    def sort(self, compare_func: GLib.CompareDataFunc, user_data: object) -> None: ...
...
class MemoryInputStream(InputStream, PollableInputStream, Seekable): 
    ...
    def add_data(self, data: list[int], len: gssize, destroy: GLib.DestroyNotify) -> None: ...

class MemoryOutputStream(OutputStream, PollableOutputStream, Seekable): 
    @classmethod
    def new(cls, data: object, size: gsize, realloc_function: ReallocFunc, destroy_function: GLib.DestroyNotify) -> OutputStream: ...
...
class Menu(MenuModel): 
    @classmethod
    def new(cls) -> Menu: ...
    def append(self, label: str, detailed_action: str) -> None: ...
    def append_item(self, item: MenuItem) -> None: ...
    def append_section(self, label: str, section: MenuModel) -> None: ...
    def append_submenu(self, label: str, submenu: MenuModel) -> None: ...
    def freeze(self) -> None: ...
    def insert(self, position: int, label: str, detailed_action: str) -> None: ...
    def insert_item(self, position: int, item: MenuItem) -> None: ...
    def insert_section(self, position: int, label: str, section: MenuModel) -> None: ...
    def insert_submenu(self, position: int, label: str, submenu: MenuModel) -> None: ...
    def prepend(self, label: str, detailed_action: str) -> None: ...
    def prepend_item(self, item: MenuItem) -> None: ...
    def prepend_section(self, label: str, section: MenuModel) -> None: ...
    def prepend_submenu(self, label: str, submenu: MenuModel) -> None: ...
    def remove(self, position: int) -> None: ...
    def remove_all(self) -> None: ...
...
class MenuItem(GObject.Object): 
    @classmethod
    def new(cls, label: str, detailed_action: str) -> MenuItem: ...
    def get_attribute(self, attribute: str, format_string: str) -> bool: ...
    def get_attribute_value(self, attribute: str, expected_type: GLib.VariantType) -> GLib.Variant: ...
    def get_link(self, link: str) -> MenuModel: ...
    def set_action_and_target(self, action: str, format_string: str) -> None: ...
    def set_action_and_target_value(self, action: str, target_value: GLib.Variant) -> None: ...
    def set_attribute(self, attribute: str, format_string: str) -> None: ...
    def set_attribute_value(self, attribute: str, value: GLib.Variant) -> None: ...
    def set_detailed_action(self, detailed_action: str) -> None: ...
    def set_icon(self, icon: Icon) -> None: ...
    def set_label(self, label: str) -> None: ...
    def set_link(self, link: str, model: MenuModel) -> None: ...
    def set_section(self, section: MenuModel) -> None: ...
    def set_submenu(self, submenu: MenuModel) -> None: ...
...
class MenuModel(GObject.Object): 
    ...
    def get_item_attribute_value(self, item_index: int, attribute: str, expected_type: GLib.VariantType) -> GLib.Variant: ...
...
class NativeSocketAddress(SocketAddress, SocketConnectable): 
    @classmethod
    def new(cls, native: object, len: gsize) -> SocketAddress: ...
...
class Notification(GObject.Object): 
    ...
    def add_button_with_target(self, label: str, action: str, target_format: str) -> None: ...
    def add_button_with_target_value(self, label: str, action: str, target: GLib.Variant) -> None: ...
    def set_body(self, body: str) -> None: ...
    def set_category(self, category: str) -> None: ...
    def set_default_action(self, detailed_action: str) -> None: ...
    def set_default_action_and_target(self, action: str, target_format: str) -> None: ...
    def set_default_action_and_target_value(self, action: str, target: GLib.Variant) -> None: ...
    def set_icon(self, icon: Icon) -> None: ...
...
class OutputStream(GObject.Object): 
    ...
    def close_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def close_finish(self, result: AsyncResult) -> bool: ...
    def flush(self, cancellable: Cancellable) -> bool: ...
    def flush_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def flush_finish(self, result: AsyncResult) -> bool: ...
    def has_pending(self) -> bool: ...
    def is_closed(self) -> bool: ...
    def is_closing(self) -> bool: ...
    def printf(self, bytes_written: gsize, cancellable: Cancellable, error: GLib.Error, format: str) -> bool: ...
    def set_pending(self) -> bool: ...
    def splice(self, source: InputStream, flags: OutputStreamSpliceFlags, cancellable: Cancellable) -> gssize: ...
    def splice_async(self, source: InputStream, flags: OutputStreamSpliceFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def splice_finish(self, result: AsyncResult) -> gssize: ...
    def vprintf(self, bytes_written: gsize, cancellable: Cancellable, error: GLib.Error, format: str, args: va_list) -> bool: ...
    def write(self, buffer: list[int], count: gsize, cancellable: Cancellable) -> gssize: ...
    def write_all(self, buffer: list[int], count: gsize, bytes_written: gsize, cancellable: Cancellable) -> bool: ...
    def write_all_async(self, buffer: list[int], count: gsize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def write_all_finish(self, result: AsyncResult, bytes_written: gsize) -> bool: ...
    def write_async(self, buffer: list[int], count: gsize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def write_bytes(self, bytes: GLib.Bytes, cancellable: Cancellable) -> gssize: ...
    def write_bytes_async(self, bytes: GLib.Bytes, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def write_bytes_finish(self, result: AsyncResult) -> gssize: ...
    def write_finish(self, result: AsyncResult) -> gssize: ...
    def writev(self, vectors: list[OutputVector], n_vectors: gsize, bytes_written: gsize, cancellable: Cancellable) -> bool: ...
    def writev_all(self, vectors: list[OutputVector], n_vectors: gsize, bytes_written: gsize, cancellable: Cancellable) -> bool: ...
    def writev_all_async(self, vectors: list[OutputVector], n_vectors: gsize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def writev_all_finish(self, result: AsyncResult, bytes_written: gsize) -> bool: ...
    def writev_async(self, vectors: list[OutputVector], n_vectors: gsize, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def writev_finish(self, result: AsyncResult, bytes_written: gsize) -> bool: ...

class Permission(GObject.Object): 
    def acquire(self, cancellable: Cancellable) -> bool: ...
    def acquire_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def release(self, cancellable: Cancellable) -> bool: ...
    def release_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class ProxyAddress(InetSocketAddress, SocketConnectable): 
    @classmethod
    def new(cls, inetaddr: InetAddress, port: int, protocol: str, dest_hostname: str, dest_port: int, username: str, password: str) -> SocketAddress: ...
...
class Resolver(GObject.Object): 
    ...
    def lookup_by_address(self, address: InetAddress, cancellable: Cancellable) -> str: ...
    def lookup_by_address_async(self, address: InetAddress, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def lookup_by_address_finish(self, result: AsyncResult) -> str: ...
    def lookup_by_name(self, hostname: str, cancellable: Cancellable) -> GLib.List: ...
    def lookup_by_name_async(self, hostname: str, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def lookup_by_name_finish(self, result: AsyncResult) -> GLib.List: ...
    def lookup_by_name_with_flags(self, hostname: str, flags: ResolverNameLookupFlags, cancellable: Cancellable) -> GLib.List: ...
    def lookup_by_name_with_flags_async(self, hostname: str, flags: ResolverNameLookupFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def lookup_by_name_with_flags_finish(self, result: AsyncResult) -> GLib.List: ...
    def lookup_records(self, rrname: str, record_type: ResolverRecordType, cancellable: Cancellable) -> GLib.List: ...
    def lookup_records_async(self, rrname: str, record_type: ResolverRecordType, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def lookup_records_finish(self, result: AsyncResult) -> GLib.List: ...
    def lookup_service(self, service: str, protocol: str, domain: str, cancellable: Cancellable) -> GLib.List: ...
    def lookup_service_async(self, service: str, protocol: str, domain: str, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class Settings(GObject.Object): 
    ...
    def bind_with_mapping(self, key: str, object: GObject.Object, property: str, flags: SettingsBindFlags, get_mapping: SettingsBindGetMapping, set_mapping: SettingsBindSetMapping, user_data: object, destroy: GLib.DestroyNotify) -> None: ...
    ...
    def get_mapped(self, key: str, mapping: SettingsGetMapping, user_data: object) -> object: ...
    ...
    def set_strv(self, key: str, value: list[str]) -> bool: ...
...
class SettingsBackend(GObject.Object): 
    ...
    def changed(self, key: str, origin_tag: object) -> None: ...
    def changed_tree(self, tree: GLib.Tree, origin_tag: object) -> None: ...
    def keys_changed(self, path: str, items: list[str], origin_tag: object) -> None: ...
    def path_changed(self, path: str, origin_tag: object) -> None: ...
...
class SimpleAction(GObject.Object, Action): 
    @classmethod
    def new(cls, name: str, parameter_type: GLib.VariantType) -> SimpleAction: ...
    def set_enabled(self, enabled: bool) -> None: ...
    def set_state(self, value: GLib.Variant) -> None: ...
    def set_state_hint(self, state_hint: GLib.Variant) -> None: ...

class SimpleActionGroup(GObject.Object, ActionGroup, ActionMap): 
    @classmethod
    def new(cls) -> SimpleActionGroup: ...
    def add_entries(self, entries: list[ActionEntry], n_entries: int, user_data: object) -> None: ...
...
class SimpleAsyncResult(GObject.Object, AsyncResult): 
    @classmethod
    def new(cls, source_object: GObject.Object, callback: AsyncReadyCallback, user_data: object, source_tag: object) -> SimpleAsyncResult: ...
    @classmethod
    def is_valid(cls, result: AsyncResult, source: GObject.Object, source_tag: object) -> bool: ...
    ...
    def run_in_thread(self, func: SimpleAsyncThreadFunc, io_priority: int, cancellable: Cancellable) -> None: ...
    def set_check_cancellable(self, check_cancellable: Cancellable) -> None: ...
    ...
    def set_op_res_gpointer(self, op_res: object, destroy_op_res: GLib.DestroyNotify) -> None: ...
...
class SimpleProxyResolver(GObject.Object, ProxyResolver): 
    @classmethod
    def new(cls, default_proxy: str, ignore_hosts: list[str]) -> ProxyResolver: ...
    def set_default_proxy(self, default_proxy: str) -> None: ...
...
class Socket(GObject.Object, DatagramBased, Initable): 
    ...
    def accept(self, cancellable: Cancellable) -> Socket: ...
    ...
    def condition_timed_wait(self, condition: GLib.IOCondition, timeout_us: int, cancellable: Cancellable) -> bool: ...
    def condition_wait(self, condition: GLib.IOCondition, cancellable: Cancellable) -> bool: ...
    def connect(self, address: SocketAddress, cancellable: Cancellable) -> bool: ...
    def connection_factory_create_connection(self) -> SocketConnection: ...
    def create_source(self, condition: GLib.IOCondition, cancellable: Cancellable) -> GLib.Source: ...
    ...
    def join_multicast_group(self, group: InetAddress, source_specific: bool, iface: str) -> bool: ...
    def join_multicast_group_ssm(self, group: InetAddress, source_specific: InetAddress, iface: str) -> bool: ...
    def leave_multicast_group(self, group: InetAddress, source_specific: bool, iface: str) -> bool: ...
    def leave_multicast_group_ssm(self, group: InetAddress, source_specific: InetAddress, iface: str) -> bool: ...
    def listen(self) -> bool: ...
    def receive(self, buffer: list[int], size: gsize, cancellable: Cancellable) -> gssize: ...
    def receive_from(self, address: SocketAddress, buffer: list[int], size: gsize, cancellable: Cancellable) -> gssize: ...
    def receive_message(self, address: SocketAddress, vectors: list[InputVector], num_vectors: int, messages: list[SocketControlMessage], num_messages: int, flags: int, cancellable: Cancellable) -> gssize: ...
    def receive_messages(self, messages: list[InputMessage], num_messages: int, flags: int, cancellable: Cancellable) -> int: ...
    def receive_with_blocking(self, buffer: list[int], size: gsize, blocking: bool, cancellable: Cancellable) -> gssize: ...
    def send(self, buffer: list[int], size: gsize, cancellable: Cancellable) -> gssize: ...
    def send_message(self, address: SocketAddress, vectors: list[OutputVector], num_vectors: int, messages: list[SocketControlMessage], num_messages: int, flags: int, cancellable: Cancellable) -> gssize: ...
    def send_message_with_timeout(self, address: SocketAddress, vectors: list[OutputVector], num_vectors: int, messages: list[SocketControlMessage], num_messages: int, flags: int, timeout_us: int, bytes_written: gsize, cancellable: Cancellable) -> PollableReturn: ...
    def send_messages(self, messages: list[OutputMessage], num_messages: int, flags: int, cancellable: Cancellable) -> int: ...
    def send_to(self, address: SocketAddress, buffer: list[int], size: gsize, cancellable: Cancellable) -> gssize: ...
    def send_with_blocking(self, buffer: list[int], size: gsize, blocking: bool, cancellable: Cancellable) -> gssize: ...
...
class SocketAddress(GObject.Object, SocketConnectable): 
    ...
    def to_native(self, dest: object, destlen: gsize) -> bool: ...

class SocketAddressEnumerator(GObject.Object): 
    def next(self, cancellable: Cancellable) -> SocketAddress: ...
    def next_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class SocketClient(GObject.Object): 
    ...
    def connect(self, connectable: SocketConnectable, cancellable: Cancellable) -> SocketConnection: ...
    def connect_async(self, connectable: SocketConnectable, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def connect_finish(self, result: AsyncResult) -> SocketConnection: ...
    def connect_to_host(self, host_and_port: str, default_port: int, cancellable: Cancellable) -> SocketConnection: ...
    def connect_to_host_async(self, host_and_port: str, default_port: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def connect_to_host_finish(self, result: AsyncResult) -> SocketConnection: ...
    def connect_to_service(self, domain: str, service: str, cancellable: Cancellable) -> SocketConnection: ...
    def connect_to_service_async(self, domain: str, service: str, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def connect_to_service_finish(self, result: AsyncResult) -> SocketConnection: ...
    def connect_to_uri(self, uri: str, default_port: int, cancellable: Cancellable) -> SocketConnection: ...
    def connect_to_uri_async(self, uri: str, default_port: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def set_local_address(self, address: SocketAddress) -> None: ...
    def set_protocol(self, protocol: SocketProtocol) -> None: ...
    def set_proxy_resolver(self, proxy_resolver: ProxyResolver) -> None: ...
...
class SocketConnection(IOStream): 
    ...
    def connect(self, address: SocketAddress, cancellable: Cancellable) -> bool: ...
    def connect_async(self, address: SocketAddress, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class SocketListener(GObject.Object): 
    ...
    def accept(self, source_object: GObject.Object, cancellable: Cancellable) -> SocketConnection: ...
    def accept_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def accept_finish(self, result: AsyncResult, source_object: GObject.Object) -> SocketConnection: ...
    def accept_socket(self, source_object: GObject.Object, cancellable: Cancellable) -> Socket: ...
    def accept_socket_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def accept_socket_finish(self, result: AsyncResult, source_object: GObject.Object) -> Socket: ...
    def add_address(self, address: SocketAddress, type: SocketType, protocol: SocketProtocol, source_object: GObject.Object, effective_address: SocketAddress) -> bool: ...
    ...
    def add_socket(self, socket: Socket, source_object: GObject.Object) -> bool: ...
    def close(self) -> None: ...
...
class Subprocess(GObject.Object, Initable): 
    @classmethod
    def new(cls, flags: SubprocessFlags, error: GLib.Error, argv0: str) -> Subprocess: ...
    def communicate(self, stdin_buf: GLib.Bytes, cancellable: Cancellable, stdout_buf: GLib.Bytes, stderr_buf: GLib.Bytes) -> bool: ...
    def communicate_async(self, stdin_buf: GLib.Bytes, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def communicate_finish(self, result: AsyncResult, stdout_buf: GLib.Bytes, stderr_buf: GLib.Bytes) -> bool: ...
    def communicate_utf8(self, stdin_buf: str, cancellable: Cancellable, stdout_buf: str, stderr_buf: str) -> bool: ...
    def communicate_utf8_async(self, stdin_buf: str, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def communicate_utf8_finish(self, result: AsyncResult, stdout_buf: str, stderr_buf: str) -> bool: ...
    ...
    def wait(self, cancellable: Cancellable) -> bool: ...
    def wait_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def wait_check(self, cancellable: Cancellable) -> bool: ...
    def wait_check_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class SubprocessLauncher(GObject.Object): 
    ...
    def close(self) -> None: ...
    def getenv(self, variable: filename) -> filename: ...
    def set_child_setup(self, child_setup: GLib.SpawnChildSetupFunc, user_data: object, destroy_notify: GLib.DestroyNotify) -> None: ...
    ...
    def set_stderr_file_path(self, path: filename) -> None: ...
    def set_stdin_file_path(self, path: str) -> None: ...
    def set_stdout_file_path(self, path: filename) -> None: ...
...
class Task(GObject.Object, AsyncResult): 
    @classmethod
    def new(cls, source_object: GObject.Object, cancellable: Cancellable, callback: AsyncReadyCallback, callback_data: object) -> Task: ...
    @classmethod
    def is_valid(cls, result: AsyncResult, source_object: GObject.Object) -> bool: ...
    @classmethod
    def report_error(cls, source_object: GObject.Object, callback: AsyncReadyCallback, callback_data: object, source_tag: object, error: GLib.Error) -> None: ...
    @classmethod
    def report_new_error(cls, source_object: GObject.Object, callback: AsyncReadyCallback, callback_data: object, source_tag: object, domain: GLib.Quark, code: int, format: str) -> None: ...
    ...
    def return_pointer(self, result: object, result_destroy: GLib.DestroyNotify) -> None: ...
    def return_value(self, result: GObject.Value) -> None: ...
    ...
    def set_source_tag(self, source_tag: object) -> None: ...
    def set_task_data(self, task_data: object, task_data_destroy: GLib.DestroyNotify) -> None: ...
...
class TlsCertificate(GObject.Object): 
    ...
    def verify(self, identity: SocketConnectable, trusted_ca: TlsCertificate) -> TlsCertificateFlags: ...
...
class TlsConnection(IOStream): 
    ...
    def handshake(self, cancellable: Cancellable) -> bool: ...
    def handshake_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def handshake_finish(self, result: AsyncResult) -> bool: ...
    def set_advertised_protocols(self, protocols: list[str]) -> None: ...
    def set_certificate(self, certificate: TlsCertificate) -> None: ...
    def set_database(self, database: TlsDatabase) -> None: ...
    def set_interaction(self, interaction: TlsInteraction) -> None: ...
...
class TlsDatabase(GObject.Object): 
    ...
    def lookup_certificate_for_handle(self, handle: str, interaction: TlsInteraction, flags: TlsDatabaseLookupFlags, cancellable: Cancellable) -> TlsCertificate: ...
    def lookup_certificate_for_handle_async(self, handle: str, interaction: TlsInteraction, flags: TlsDatabaseLookupFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def lookup_certificate_for_handle_finish(self, result: AsyncResult) -> TlsCertificate: ...
    def lookup_certificate_issuer(self, certificate: TlsCertificate, interaction: TlsInteraction, flags: TlsDatabaseLookupFlags, cancellable: Cancellable) -> TlsCertificate: ...
    def lookup_certificate_issuer_async(self, certificate: TlsCertificate, interaction: TlsInteraction, flags: TlsDatabaseLookupFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def lookup_certificate_issuer_finish(self, result: AsyncResult) -> TlsCertificate: ...
    def lookup_certificates_issued_by(self, issuer_raw_dn: list[int], interaction: TlsInteraction, flags: TlsDatabaseLookupFlags, cancellable: Cancellable) -> GLib.List: ...
    def lookup_certificates_issued_by_async(self, issuer_raw_dn: list[int], interaction: TlsInteraction, flags: TlsDatabaseLookupFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def lookup_certificates_issued_by_finish(self, result: AsyncResult) -> GLib.List: ...
    def verify_chain(self, chain: TlsCertificate, purpose: str, identity: SocketConnectable, interaction: TlsInteraction, flags: TlsDatabaseVerifyFlags, cancellable: Cancellable) -> TlsCertificateFlags: ...
    def verify_chain_async(self, chain: TlsCertificate, purpose: str, identity: SocketConnectable, interaction: TlsInteraction, flags: TlsDatabaseVerifyFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def verify_chain_finish(self, result: AsyncResult) -> TlsCertificateFlags: ...

class TlsInteraction(GObject.Object): 
    def ask_password(self, password: TlsPassword, cancellable: Cancellable) -> TlsInteractionResult: ...
    def ask_password_async(self, password: TlsPassword, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def ask_password_finish(self, result: AsyncResult) -> TlsInteractionResult: ...
    def invoke_ask_password(self, password: TlsPassword, cancellable: Cancellable) -> TlsInteractionResult: ...
    def invoke_request_certificate(self, connection: TlsConnection, flags: TlsCertificateRequestFlags, cancellable: Cancellable) -> TlsInteractionResult: ...
    def request_certificate(self, connection: TlsConnection, flags: TlsCertificateRequestFlags, cancellable: Cancellable) -> TlsInteractionResult: ...
    def request_certificate_async(self, connection: TlsConnection, flags: TlsCertificateRequestFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class TlsPassword(GObject.Object): 
    ...
    def set_value_full(self, value: list[int], length: gssize, destroy: GLib.DestroyNotify) -> None: ...
    def set_warning(self, warning: str) -> None: ...

class UnixConnection(SocketConnection): 
    def receive_credentials(self, cancellable: Cancellable) -> Credentials: ...
    def receive_credentials_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def receive_credentials_finish(self, result: AsyncResult) -> Credentials: ...
    def receive_fd(self, cancellable: Cancellable) -> int: ...
    def send_credentials(self, cancellable: Cancellable) -> bool: ...
    def send_credentials_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def send_credentials_finish(self, result: AsyncResult) -> bool: ...
    def send_fd(self, fd: int, cancellable: Cancellable) -> bool: ...
...
class Vfs(GObject.Object): 
    ...
    def register_uri_scheme(self, scheme: str, uri_func: VfsFileLookupFunc, uri_data: object, uri_destroy: GLib.DestroyNotify, parse_name_func: VfsFileLookupFunc, parse_name_data: object, parse_name_destroy: GLib.DestroyNotify) -> bool: ...
...
class Action: 
    def activate(self, parameter: GLib.Variant) -> None: ...
    def change_state(self, value: GLib.Variant) -> None: ...
    def get_enabled(self) -> bool: ...
    def get_name(self) -> str: ...
    def get_parameter_type(self) -> GLib.VariantType: ...
    def get_state(self) -> GLib.Variant: ...
    def get_state_hint(self) -> GLib.Variant: ...
    def get_state_type(self) -> GLib.VariantType: ...
    def activate(self, parameter: GLib.Variant) -> None: ...
    def change_state(self, value: GLib.Variant) -> None: ...
    def get_enabled(self) -> bool: ...
    def get_name(self) -> str: ...
...
class ActionGroup: 
    ...
    def activate_action(self, action_name: str, parameter: GLib.Variant) -> None: ...
    def change_action_state(self, action_name: str, value: GLib.Variant) -> None: ...
    def get_action_enabled(self, action_name: str) -> bool: ...
    def get_action_parameter_type(self, action_name: str) -> GLib.VariantType: ...
    def get_action_state(self, action_name: str) -> GLib.Variant: ...
    def get_action_state_hint(self, action_name: str) -> GLib.Variant: ...
    def get_action_state_type(self, action_name: str) -> GLib.VariantType: ...
...
class ActionMap: 
    ...
    def lookup_action(self, action_name: str) -> Action: ...
    def remove_action(self, action_name: str) -> None: ...
    def add_action(self, action: Action) -> None: ...
    def add_action_entries(self, entries: list[ActionEntry], n_entries: int, user_data: object) -> None: ...
    def lookup_action(self, action_name: str) -> Action: ...
    def remove_action(self, action_name: str) -> None: ...
class AppInfo: 
    ...
    def get_commandline(self) -> filename: ...
    def get_description(self) -> str: ...
    def get_display_name(self) -> str: ...
    ...
    def launch(self, files: GLib.List, context: AppLaunchContext) -> bool: ...
    def launch_uris(self, uris: GLib.List, context: AppLaunchContext) -> bool: ...
    def launch_uris_async(self, uris: GLib.List, context: AppLaunchContext, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def supports_uris(self) -> bool: ...
class AsyncInitable: 
    def init_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class AsyncResult: 
    def get_source_object(self) -> GObject.Object: ...
    def get_user_data(self) -> object: ...
    def is_tagged(self, source_tag: object) -> bool: ...
    def get_source_object(self) -> GObject.Object: ...
    def get_user_data(self) -> object: ...
    def is_tagged(self, source_tag: object) -> bool: ...
...
class Converter: 
    ...
    def reset(self) -> None: ...
class DBusInterface: 
    def dup_object(self) -> DBusObject: ...
    def get_info(self) -> DBusInterfaceInfo: ...
    def get_object(self) -> DBusObject: ...
    def set_object(self, object: DBusObject) -> None: ...
    def dup_object(self) -> DBusObject: ...
    def get_info(self) -> DBusInterfaceInfo: ...
    def get_object(self) -> DBusObject: ...
    def set_object(self, object: DBusObject) -> None: ...
class DBusObject: 
    def get_interface(self, interface_name: str) -> DBusInterface: ...
...
class DBusObjectManager: 
    def get_interface(self, object_path: str, interface_name: str) -> DBusInterface: ...
    def get_object(self, object_path: str) -> DBusObject: ...
    def get_object_path(self) -> str: ...
...
class DatagramBased: 
    def condition_check(self, condition: GLib.IOCondition) -> GLib.IOCondition: ...
    def condition_wait(self, condition: GLib.IOCondition, timeout: int, cancellable: Cancellable) -> bool: ...
    def create_source(self, condition: GLib.IOCondition, cancellable: Cancellable) -> GLib.Source: ...
    def receive_messages(self, messages: list[InputMessage], num_messages: int, flags: int, timeout: int, cancellable: Cancellable) -> int: ...
    def send_messages(self, messages: list[OutputMessage], num_messages: int, flags: int, timeout: int, cancellable: Cancellable) -> int: ...
    def condition_check(self, condition: GLib.IOCondition) -> GLib.IOCondition: ...
    def condition_wait(self, condition: GLib.IOCondition, timeout: int, cancellable: Cancellable) -> bool: ...
    def create_source(self, condition: GLib.IOCondition, cancellable: Cancellable) -> GLib.Source: ...
    def receive_messages(self, messages: list[InputMessage], num_messages: int, flags: int, timeout: int, cancellable: Cancellable) -> int: ...
...
class DesktopAppInfoLookup: 
    def get_default_for_uri_scheme(self, uri_scheme: str) -> AppInfo: ...
    def get_default_for_uri_scheme(self, uri_scheme: str) -> AppInfo: ...
class Drive: 
    ...
    def eject(self, flags: MountUnmountFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def eject_button(self) -> None: ...
    def eject_finish(self, result: AsyncResult) -> bool: ...
    def eject_with_operation(self, flags: MountUnmountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def eject_with_operation_finish(self, result: AsyncResult) -> bool: ...
    def enumerate_identifiers(self) -> list[str]: ...
    def get_icon(self) -> Icon: ...
    def get_identifier(self, kind: str) -> str: ...
    def get_name(self) -> str: ...
    ...
    def poll_for_media(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def poll_for_media_finish(self, result: AsyncResult) -> bool: ...
    def start(self, flags: DriveStartFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def start_finish(self, result: AsyncResult) -> bool: ...
    def stop(self, flags: MountUnmountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class DtlsConnection(DatagramBased): 
    ...
    def handshake_finish(self, result: AsyncResult) -> bool: ...
    def set_advertised_protocols(self, protocols: list[str]) -> None: ...
    def shutdown(self, shutdown_read: bool, shutdown_write: bool, cancellable: Cancellable) -> bool: ...
    def shutdown_async(self, shutdown_read: bool, shutdown_write: bool, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class File: 
    def append_to(self, flags: FileCreateFlags, cancellable: Cancellable) -> FileOutputStream: ...
    def append_to_async(self, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def append_to_finish(self, res: AsyncResult) -> FileOutputStream: ...
    def copy(self, destination: File, flags: FileCopyFlags, cancellable: Cancellable, progress_callback: FileProgressCallback, progress_callback_data: object) -> bool: ...
    def copy_async(self, destination: File, flags: FileCopyFlags, io_priority: int, cancellable: Cancellable, progress_callback: FileProgressCallback, progress_callback_data: object, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def copy_finish(self, res: AsyncResult) -> bool: ...
    def create(self, flags: FileCreateFlags, cancellable: Cancellable) -> FileOutputStream: ...
    def create_async(self, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def create_finish(self, res: AsyncResult) -> FileOutputStream: ...
    def create_readwrite(self, flags: FileCreateFlags, cancellable: Cancellable) -> FileIOStream: ...
    def create_readwrite_async(self, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def create_readwrite_finish(self, res: AsyncResult) -> FileIOStream: ...
    def delete_file(self, cancellable: Cancellable) -> bool: ...
    def delete_file_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def delete_file_finish(self, result: AsyncResult) -> bool: ...
    def dup(self) -> File: ...
    def eject_mountable(self, flags: MountUnmountFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def eject_mountable_finish(self, result: AsyncResult) -> bool: ...
    def eject_mountable_with_operation(self, flags: MountUnmountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def eject_mountable_with_operation_finish(self, result: AsyncResult) -> bool: ...
    def enumerate_children(self, attributes: str, flags: FileQueryInfoFlags, cancellable: Cancellable) -> FileEnumerator: ...
    def enumerate_children_async(self, attributes: str, flags: FileQueryInfoFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def enumerate_children_finish(self, res: AsyncResult) -> FileEnumerator: ...
    def equal(self, file2: File) -> bool: ...
    def find_enclosing_mount(self, cancellable: Cancellable) -> Mount: ...
    def find_enclosing_mount_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def get_relative_path(self, descendant: File) -> filename: ...
    def get_uri(self) -> str: ...
    def get_uri_scheme(self) -> str: ...
    def has_uri_scheme(self, uri_scheme: str) -> bool: ...
    def hash(self) -> int: ...
    def is_native(self) -> bool: ...
    def make_directory(self, cancellable: Cancellable) -> bool: ...
    def make_directory_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def make_directory_finish(self, result: AsyncResult) -> bool: ...
    def make_symbolic_link(self, symlink_value: filename, cancellable: Cancellable) -> bool: ...
    def make_symbolic_link_async(self, symlink_value: filename, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def make_symbolic_link_finish(self, result: AsyncResult) -> bool: ...
    def measure_disk_usage(self, flags: FileMeasureFlags, cancellable: Cancellable, progress_callback: FileMeasureProgressCallback, progress_data: object, disk_usage: int, num_dirs: int, num_files: int) -> bool: ...
    def measure_disk_usage_async(self, flags: FileMeasureFlags, io_priority: int, cancellable: Cancellable, progress_callback: FileMeasureProgressCallback, progress_data: object, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def measure_disk_usage_finish(self, result: AsyncResult, disk_usage: int, num_dirs: int, num_files: int) -> bool: ...
    def monitor_dir(self, flags: FileMonitorFlags, cancellable: Cancellable) -> FileMonitor: ...
    def monitor_file(self, flags: FileMonitorFlags, cancellable: Cancellable) -> FileMonitor: ...
    def mount_enclosing_volume(self, flags: MountMountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def mount_enclosing_volume_finish(self, result: AsyncResult) -> bool: ...
    def mount_mountable(self, flags: MountMountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def mount_mountable_finish(self, result: AsyncResult) -> File: ...
    def move(self, destination: File, flags: FileCopyFlags, cancellable: Cancellable, progress_callback: FileProgressCallback, progress_callback_data: object) -> bool: ...
    def move_async(self, destination: File, flags: FileCopyFlags, io_priority: int, cancellable: Cancellable, progress_callback: FileProgressCallback, progress_callback_data: object, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def move_finish(self, result: AsyncResult) -> bool: ...
    def open_readwrite(self, cancellable: Cancellable) -> FileIOStream: ...
    def open_readwrite_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def open_readwrite_finish(self, res: AsyncResult) -> FileIOStream: ...
    def poll_mountable(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def poll_mountable_finish(self, result: AsyncResult) -> bool: ...
    def prefix_matches(self, file: File) -> bool: ...
    def query_filesystem_info(self, attributes: str, cancellable: Cancellable) -> FileInfo: ...
    def query_filesystem_info_async(self, attributes: str, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def query_filesystem_info_finish(self, res: AsyncResult) -> FileInfo: ...
    def query_info(self, attributes: str, flags: FileQueryInfoFlags, cancellable: Cancellable) -> FileInfo: ...
    def query_info_async(self, attributes: str, flags: FileQueryInfoFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def query_info_finish(self, res: AsyncResult) -> FileInfo: ...
    def query_settable_attributes(self, cancellable: Cancellable) -> FileAttributeInfoList: ...
    def query_writable_namespaces(self, cancellable: Cancellable) -> FileAttributeInfoList: ...
    def read_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def read_finish(self, res: AsyncResult) -> FileInputStream: ...
    def read_fn(self, cancellable: Cancellable) -> FileInputStream: ...
    def replace(self, etag: str, make_backup: bool, flags: FileCreateFlags, cancellable: Cancellable) -> FileOutputStream: ...
    def replace_async(self, etag: str, make_backup: bool, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def replace_finish(self, res: AsyncResult) -> FileOutputStream: ...
    def replace_readwrite(self, etag: str, make_backup: bool, flags: FileCreateFlags, cancellable: Cancellable) -> FileIOStream: ...
    def replace_readwrite_async(self, etag: str, make_backup: bool, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def replace_readwrite_finish(self, res: AsyncResult) -> FileIOStream: ...
    def resolve_relative_path(self, relative_path: filename) -> File: ...
    def set_attribute(self, attribute: str, type: FileAttributeType, value_p: object, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_attributes_async(self, info: FileInfo, flags: FileQueryInfoFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def set_attributes_finish(self, result: AsyncResult, info: FileInfo) -> bool: ...
    def set_attributes_from_info(self, info: FileInfo, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_display_name(self, display_name: str, cancellable: Cancellable) -> File: ...
    def set_display_name_async(self, display_name: str, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def set_display_name_finish(self, res: AsyncResult) -> File: ...
    def start_mountable(self, flags: DriveStartFlags, start_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def start_mountable_finish(self, result: AsyncResult) -> bool: ...
    def stop_mountable(self, flags: MountUnmountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def stop_mountable_finish(self, result: AsyncResult) -> bool: ...
    def trash(self, cancellable: Cancellable) -> bool: ...
    def trash_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def trash_finish(self, result: AsyncResult) -> bool: ...
    def unmount_mountable(self, flags: MountUnmountFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def unmount_mountable_finish(self, result: AsyncResult) -> bool: ...
    def unmount_mountable_with_operation(self, flags: MountUnmountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def unmount_mountable_with_operation_finish(self, result: AsyncResult) -> bool: ...
    def append_to(self, flags: FileCreateFlags, cancellable: Cancellable) -> FileOutputStream: ...
    def append_to_async(self, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def append_to_finish(self, res: AsyncResult) -> FileOutputStream: ...
    def build_attribute_list_for_copy(self, flags: FileCopyFlags, cancellable: Cancellable) -> str: ...
    def copy(self, destination: File, flags: FileCopyFlags, cancellable: Cancellable, progress_callback: FileProgressCallback, progress_callback_data: object) -> bool: ...
    def copy_async(self, destination: File, flags: FileCopyFlags, io_priority: int, cancellable: Cancellable, progress_callback: FileProgressCallback, progress_callback_data: object, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def copy_attributes(self, destination: File, flags: FileCopyFlags, cancellable: Cancellable) -> bool: ...
    def copy_finish(self, res: AsyncResult) -> bool: ...
    def create(self, flags: FileCreateFlags, cancellable: Cancellable) -> FileOutputStream: ...
    def create_async(self, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def create_finish(self, res: AsyncResult) -> FileOutputStream: ...
    ...
    def create_readwrite_async(self, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def create_readwrite_finish(self, res: AsyncResult) -> FileIOStream: ...
    def delete(self, cancellable: Cancellable) -> bool: ...
    def delete_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def get_uri(self) -> str: ...
    def get_uri_scheme(self) -> str: ...
    def has_parent(self, parent: File) -> bool: ...
    def has_prefix(self, prefix: File) -> bool: ...
    def has_uri_scheme(self, uri_scheme: str) -> bool: ...
    def hash(self) -> int: ...
    def is_native(self) -> bool: ...
    def load_bytes(self, cancellable: Cancellable, etag_out: str) -> GLib.Bytes: ...
    def load_bytes_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def load_bytes_finish(self, result: AsyncResult, etag_out: str) -> GLib.Bytes: ...
    def load_contents(self, cancellable: Cancellable, contents: list[int], length: gsize, etag_out: str) -> bool: ...
    def load_contents_async(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def load_contents_finish(self, res: AsyncResult, contents: list[int], length: gsize, etag_out: str) -> bool: ...
    def load_partial_contents_async(self, cancellable: Cancellable, read_more_callback: FileReadMoreCallback, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def load_partial_contents_finish(self, res: AsyncResult, contents: list[int], length: gsize, etag_out: str) -> bool: ...
    def make_directory(self, cancellable: Cancellable) -> bool: ...
    def make_directory_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def make_directory_finish(self, result: AsyncResult) -> bool: ...
    def make_directory_with_parents(self, cancellable: Cancellable) -> bool: ...
    def make_symbolic_link(self, symlink_value: filename, cancellable: Cancellable) -> bool: ...
    def make_symbolic_link_async(self, symlink_value: filename, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def make_symbolic_link_finish(self, result: AsyncResult) -> bool: ...
    def measure_disk_usage(self, flags: FileMeasureFlags, cancellable: Cancellable, progress_callback: FileMeasureProgressCallback, progress_data: object, disk_usage: int, num_dirs: int, num_files: int) -> bool: ...
    def measure_disk_usage_async(self, flags: FileMeasureFlags, io_priority: int, cancellable: Cancellable, progress_callback: FileMeasureProgressCallback, progress_data: object, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def measure_disk_usage_finish(self, result: AsyncResult, disk_usage: int, num_dirs: int, num_files: int) -> bool: ...
    def monitor(self, flags: FileMonitorFlags, cancellable: Cancellable) -> FileMonitor: ...
    def monitor_directory(self, flags: FileMonitorFlags, cancellable: Cancellable) -> FileMonitor: ...
    def monitor_file(self, flags: FileMonitorFlags, cancellable: Cancellable) -> FileMonitor: ...
    def mount_enclosing_volume(self, flags: MountMountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def mount_enclosing_volume_finish(self, result: AsyncResult) -> bool: ...
    def mount_mountable(self, flags: MountMountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def open_readwrite_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def open_readwrite_finish(self, res: AsyncResult) -> FileIOStream: ...
    def peek_path(self) -> filename: ...
    def poll_mountable(self, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def poll_mountable_finish(self, result: AsyncResult) -> bool: ...
    def query_default_handler(self, cancellable: Cancellable) -> AppInfo: ...
    def query_default_handler_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def query_default_handler_finish(self, result: AsyncResult) -> AppInfo: ...
    def query_exists(self, cancellable: Cancellable) -> bool: ...
    def query_file_type(self, flags: FileQueryInfoFlags, cancellable: Cancellable) -> FileType: ...
    def query_filesystem_info(self, attributes: str, cancellable: Cancellable) -> FileInfo: ...
    def query_filesystem_info_async(self, attributes: str, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def query_filesystem_info_finish(self, res: AsyncResult) -> FileInfo: ...
    def query_info(self, attributes: str, flags: FileQueryInfoFlags, cancellable: Cancellable) -> FileInfo: ...
    ...
    def query_settable_attributes(self, cancellable: Cancellable) -> FileAttributeInfoList: ...
    def query_writable_namespaces(self, cancellable: Cancellable) -> FileAttributeInfoList: ...
    def read(self, cancellable: Cancellable) -> FileInputStream: ...
    def read_async(self, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def read_finish(self, res: AsyncResult) -> FileInputStream: ...
    def replace(self, etag: str, make_backup: bool, flags: FileCreateFlags, cancellable: Cancellable) -> FileOutputStream: ...
    def replace_async(self, etag: str, make_backup: bool, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def replace_contents(self, contents: list[int], length: gsize, etag: str, make_backup: bool, flags: FileCreateFlags, new_etag: str, cancellable: Cancellable) -> bool: ...
    def replace_contents_async(self, contents: list[int], length: gsize, etag: str, make_backup: bool, flags: FileCreateFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def replace_contents_bytes_async(self, contents: GLib.Bytes, etag: str, make_backup: bool, flags: FileCreateFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def replace_contents_finish(self, res: AsyncResult, new_etag: str) -> bool: ...
    def replace_finish(self, res: AsyncResult) -> FileOutputStream: ...
    def replace_readwrite(self, etag: str, make_backup: bool, flags: FileCreateFlags, cancellable: Cancellable) -> FileIOStream: ...
    def replace_readwrite_async(self, etag: str, make_backup: bool, flags: FileCreateFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def replace_readwrite_finish(self, res: AsyncResult) -> FileIOStream: ...
    def resolve_relative_path(self, relative_path: filename) -> File: ...
    def set_attribute(self, attribute: str, type: FileAttributeType, value_p: object, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_attribute_byte_string(self, attribute: str, value: str, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_attribute_int32(self, attribute: str, value: int, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_attribute_int64(self, attribute: str, value: int, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_attribute_string(self, attribute: str, value: str, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_attribute_uint32(self, attribute: str, value: int, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_attribute_uint64(self, attribute: str, value: int, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_attributes_async(self, info: FileInfo, flags: FileQueryInfoFlags, io_priority: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def set_attributes_finish(self, result: AsyncResult, info: FileInfo) -> bool: ...
    def set_attributes_from_info(self, info: FileInfo, flags: FileQueryInfoFlags, cancellable: Cancellable) -> bool: ...
    def set_display_name(self, display_name: str, cancellable: Cancellable) -> File: ...
...
class FileDescriptorBased: 
    ...
    def get_fd(self) -> int: ...
class Icon: 
    def equal(self, icon2: Icon) -> bool: ...
    def hash(self) -> int: ...
    ...
    def to_string(self) -> str: ...
class Initable: 
    def init(self, cancellable: Cancellable) -> bool: ...
    def init(self, cancellable: Cancellable) -> bool: ...
class ListModel: 
    def get_item(self, position: int) -> GObject.Object: ...
    def get_item_type(self) -> GObject.Type: ...
    def get_n_items(self) -> int: ...
    def get_item(self, position: int) -> object: ...
    def get_item_type(self) -> GObject.Type: ...
    def get_n_items(self) -> int: ...
    def get_object(self, position: int) -> GObject.Object: ...
    def items_changed(self, position: int, removed: int, added: int) -> None: ...
class LoadableIcon(Icon): 
    def load(self, size: int, type: str, cancellable: Cancellable) -> InputStream: ...
    def load_async(self, size: int, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class Mount: 
    ...
    def guess_content_type(self, force_rescan: bool, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def guess_content_type_finish(self, result: AsyncResult) -> list[str]: ...
    def guess_content_type_sync(self, force_rescan: bool, cancellable: Cancellable) -> list[str]: ...
    def pre_unmount(self) -> None: ...
    def remount(self, flags: MountMountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def remount_finish(self, result: AsyncResult) -> bool: ...
    def unmount(self, flags: MountUnmountFlags, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def unmount_finish(self, result: AsyncResult) -> bool: ...
    def unmount_with_operation(self, flags: MountUnmountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class NetworkMonitor(Initable): 
    def can_reach(self, connectable: SocketConnectable, cancellable: Cancellable) -> bool: ...
    def can_reach_async(self, connectable: SocketConnectable, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class PollableInputStream(InputStream): 
    ...
    def create_source(self, cancellable: Cancellable) -> GLib.Source: ...
    def is_readable(self) -> bool: ...
    def read_nonblocking(self, buffer: list[int], count: gsize) -> gssize: ...
    def can_poll(self) -> bool: ...
    def create_source(self, cancellable: Cancellable) -> GLib.Source: ...
    def is_readable(self) -> bool: ...
    def read_nonblocking(self, buffer: list[int], count: gsize, cancellable: Cancellable) -> gssize: ...
class PollableOutputStream(OutputStream): 
    def can_poll(self) -> bool: ...
    def create_source(self, cancellable: Cancellable) -> GLib.Source: ...
    def is_writable(self) -> bool: ...
    def write_nonblocking(self, buffer: list[int], count: gsize) -> gssize: ...
    def writev_nonblocking(self, vectors: list[OutputVector], n_vectors: gsize, bytes_written: gsize) -> PollableReturn: ...
    def can_poll(self) -> bool: ...
    def create_source(self, cancellable: Cancellable) -> GLib.Source: ...
    def is_writable(self) -> bool: ...
    def write_nonblocking(self, buffer: list[int], count: gsize, cancellable: Cancellable) -> gssize: ...
    def writev_nonblocking(self, vectors: list[OutputVector], n_vectors: gsize, bytes_written: gsize, cancellable: Cancellable) -> PollableReturn: ...
class PowerProfileMonitor(Initable): 
    def get_power_saver_enabled(self) -> bool: ...
class Proxy: 
    def connect(self, connection: IOStream, proxy_address: ProxyAddress, cancellable: Cancellable) -> IOStream: ...
    def connect_async(self, connection: IOStream, proxy_address: ProxyAddress, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class ProxyResolver: 
    ...
    def lookup(self, uri: str, cancellable: Cancellable) -> list[str]: ...
    def lookup_async(self, uri: str, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
...
class RemoteActionGroup(ActionGroup): 
    def activate_action_full(self, action_name: str, parameter: GLib.Variant, platform_data: GLib.Variant) -> None: ...
...
class Seekable: 
    ...
    def seek(self, offset: int, type: GLib.SeekType, cancellable: Cancellable) -> bool: ...
    def tell(self) -> int: ...
    def truncate_fn(self, offset: int, cancellable: Cancellable) -> bool: ...
    def can_seek(self) -> bool: ...
    def can_truncate(self) -> bool: ...
    def seek(self, offset: int, type: GLib.SeekType, cancellable: Cancellable) -> bool: ...
    def tell(self) -> int: ...
    def truncate(self, offset: int, cancellable: Cancellable) -> bool: ...
...
class TlsBackend: 
    ...
    def set_default_database(self, database: TlsDatabase) -> None: ...
    def supports_dtls(self) -> bool: ...
    def supports_tls(self) -> bool: ...
...
class Volume: 
    ...
    def eject_with_operation_finish(self, result: AsyncResult) -> bool: ...
    def enumerate_identifiers(self) -> list[str]: ...
    def get_activation_root(self) -> File: ...
    def get_drive(self) -> Drive: ...
    def get_icon(self) -> Icon: ...
    def get_identifier(self, kind: str) -> str: ...
    ...
    def mount_fn(self, flags: MountMountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def get_symbolic_icon(self) -> Icon: ...
    def get_uuid(self) -> str: ...
    def mount(self, flags: MountMountFlags, mount_operation: MountOperation, cancellable: Cancellable, callback: AsyncReadyCallback, user_data: object) -> None: ...
    def mount_finish(self, result: AsyncResult) -> bool: ...
    def should_automount(self) -> bool: ...
