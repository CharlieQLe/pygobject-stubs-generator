...
def render_transformed(draw: xft.Draw, color: xft.Color, matrix: Pango.Matrix | None, font: Pango.Font, glyphs: Pango.GlyphString, x: int, y: int) -> None: ...
def set_default_substitute(display: xlib.Display, screen: int, func: SubstituteFunc, data: object | None, notify: GLib.DestroyNotify) -> None: ...
...
class Font(PangoFc.Font): 
    @classmethod
    def get_font(cls, font: Pango.Font | None) -> xft.Font | None: ...
