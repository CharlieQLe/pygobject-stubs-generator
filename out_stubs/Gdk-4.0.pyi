...
def content_deserialize_async(stream: Gio.InputStream, mime_type: str, type: GObject.Type, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
...
def content_register_deserializer(mime_type: str, type: GObject.Type, deserialize: ContentDeserializeFunc, data: object | None, notify: GLib.DestroyNotify) -> None: ...
def content_register_serializer(type: GObject.Type, mime_type: str, serialize: ContentSerializeFunc, data: object | None, notify: GLib.DestroyNotify) -> None: ...
def content_serialize_async(stream: Gio.OutputStream, mime_type: str, value: GObject.Value, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
...
class Clipboard(GObject.Object): 
    ...
    def read_async(self, mime_types: list[str], io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    def read_finish(self, result: Gio.AsyncResult, out_mime_type: str) -> Gio.InputStream | None: ...
    def read_text_async(self, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    def read_text_finish(self, result: Gio.AsyncResult) -> str | None: ...
    def read_texture_async(self, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    def read_texture_finish(self, result: Gio.AsyncResult) -> Texture | None: ...
    def read_value_async(self, type: GObject.Type, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    ...
    def store_async(self, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
...
class ContentProvider(GObject.Object): 
    ...
    def write_mime_type_async(self, mime_type: str, stream: Gio.OutputStream, io_priority: int, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
...
class Device(GObject.Object): 
    ...
    def get_surface_at_position(self, win_x: float, win_y: float) -> Surface | None: ...
...
class Drag(GObject.Object): 
    @classmethod
    def begin(cls, surface: Surface, device: Device, content: ContentProvider, actions: DragAction, dx: float, dy: float) -> Drag | None: ...
...
class Event: 
    ...
    def get_history(self, out_n_coords: int) -> list[TimeCoord] | None: ...
    def get_modifier_state(self) -> ModifierType: ...
...
class GLTexture(Texture, Paintable, Gio.Icon, Gio.LoadableIcon): 
    @classmethod
    def new(cls, context: GLContext, id: int, width: int, height: int, destroy: GLib.DestroyNotify, data: object | None) -> GLTexture: ...
...
class Toplevel(Surface): 
    ...
    def begin_resize(self, edge: SurfaceEdge, device: Device | None, button: int, x: float, y: float, timestamp: int) -> None: ...
