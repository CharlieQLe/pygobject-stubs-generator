from gi.repository import cairo, GdkPixbuf, Gio, GObject, GLib, Pango, GdkPixbuf, Gio, Pango, PangoCairo, cairo
...
def cairo_draw_from_gl(cr: cairo.Context, surface: Surface, source: int, source_type: int, buffer_scale: int, x: int, y: int, width: int, height: int) -> None: ...
...
def content_deserialize_async(stream: Gio.InputStream, mime_type: str, type: GObject.Type, io_priority: int, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
def content_deserialize_finish(result: Gio.AsyncResult, value: GObject.Value) -> bool: ...
def content_formats_parse(string: str) -> ContentFormats: ...
def content_register_deserializer(mime_type: str, type: GObject.Type, deserialize: ContentDeserializeFunc, data: object, notify: GLib.DestroyNotify) -> None: ...
def content_register_serializer(type: GObject.Type, mime_type: str, serialize: ContentSerializeFunc, data: object, notify: GLib.DestroyNotify) -> None: ...
def content_serialize_async(stream: Gio.OutputStream, mime_type: str, value: GObject.Value, io_priority: int, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
def intern_mime_type(string: str) -> str: ...
...
def pixbuf_get_from_texture(texture: Texture) -> GdkPixbuf.Pixbuf: ...
def set_allowed_backends(backends: str) -> None: ...
def texture_error_quark() -> GLib.Quark: ...
def toplevel_size_get_type() -> GObject.Type: ...
...
class Clipboard(GObject.Object): 
    ...
    def read_async(self, mime_types: list[str], io_priority: int, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def read_finish(self, result: Gio.AsyncResult, out_mime_type: str) -> Gio.InputStream: ...
    def read_text_async(self, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def read_text_finish(self, result: Gio.AsyncResult) -> str: ...
    def read_texture_async(self, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def read_texture_finish(self, result: Gio.AsyncResult) -> Texture: ...
    def read_value_async(self, type: GObject.Type, io_priority: int, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def read_value_finish(self, result: Gio.AsyncResult) -> GObject.Value: ...
    def set(self, type: GObject.Type) -> None: ...
    def set_content(self, provider: ContentProvider) -> bool: ...
    def set_text(self, text: str) -> None: ...
    def set_texture(self, texture: Texture) -> None: ...
    def set_valist(self, type: GObject.Type, args: va_list) -> None: ...
    def set_value(self, value: GObject.Value) -> None: ...
    def store_async(self, io_priority: int, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class ContentDeserializer(GObject.Object, Gio.AsyncResult): 
    ...
    def get_gtype(self) -> GObject.Type: ...
    ...
    def set_task_data(self, data: object, notify: GLib.DestroyNotify) -> None: ...

class ContentProvider(GObject.Object): 
    @classmethod
    def new_for_bytes(cls, mime_type: str, bytes: GLib.Bytes) -> ContentProvider: ...
    def content_changed(self) -> None: ...
    def get_value(self, value: GObject.Value) -> bool: ...
    def ref_formats(self) -> ContentFormats: ...
    def ref_storable_formats(self) -> ContentFormats: ...
    def write_mime_type_async(self, mime_type: str, stream: Gio.OutputStream, io_priority: int, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class Cursor(GObject.Object): 
    @classmethod
    def new_from_name(cls, name: str, fallback: Cursor) -> Cursor: ...
    def get_fallback(self) -> Cursor: ...
...
class Device(GObject.Object): 
    ...
    def get_surface_at_position(self, win_x: float, win_y: float) -> Surface: ...
...
class Display(GObject.Object): 
    ...
    @classmethod
    def open(cls, display_name: str) -> Display: ...
    def beep(self) -> None: ...
    def close(self) -> None: ...
    ...
    def map_keycode(self, keycode: int, keys: list[KeymapKey], keyvals: list[int], n_entries: int) -> bool: ...
    def map_keyval(self, keyval: int, keys: list[KeymapKey], n_keys: int) -> bool: ...
    def notify_startup_complete(self, startup_id: str) -> None: ...
    def prepare_gl(self) -> bool: ...
    def put_event(self, event: Event) -> None: ...
    def supports_input_shapes(self) -> bool: ...
    def sync(self) -> None: ...
    def translate_key(self, keycode: int, state: ModifierType, group: int, keyval: int, effective_group: int, level: int, consumed: ModifierType) -> bool: ...
...
class Drag(GObject.Object): 
    @classmethod
    def begin(cls, surface: Surface, device: Device, content: ContentProvider, actions: DragAction, dx: float, dy: float) -> Drag: ...
    def drop_done(self, success: bool) -> None: ...
    def get_actions(self) -> DragAction: ...
    def get_content(self) -> ContentProvider: ...
    def get_device(self) -> Device: ...
    def get_display(self) -> Display: ...
    def get_drag_surface(self) -> Surface: ...
    def get_formats(self) -> ContentFormats: ...
...
class DrawContext(GObject.Object): 
    ...
    def get_display(self) -> Display: ...
    def get_frame_region(self) -> cairo.Region: ...
    def get_surface(self) -> Surface: ...
...
class Event: 
    def _get_angle(self, event2: Event, angle: float) -> bool: ...
    def _get_center(self, event2: Event, x: float, y: float) -> bool: ...
    def _get_distance(self, event2: Event, distance: float) -> bool: ...
    def get_axes(self, axes: list[float], n_axes: int) -> bool: ...
    def get_axis(self, axis_use: AxisUse, value: float) -> bool: ...
    def get_device(self) -> Device: ...
    def get_device_tool(self) -> DeviceTool: ...
    def get_display(self) -> Display: ...
    def get_event_sequence(self) -> EventSequence: ...
    def get_event_type(self) -> EventType: ...
    def get_history(self, out_n_coords: int) -> list[TimeCoord]: ...
    def get_modifier_state(self) -> ModifierType: ...
    def get_pointer_emulated(self) -> bool: ...
    def get_position(self, x: float, y: float) -> bool: ...
    def get_seat(self) -> Seat: ...
    def get_surface(self) -> Surface: ...
...
class FrameClock(GObject.Object): 
    ...
    def get_timings(self, frame_counter: int) -> FrameTimings: ...
...
class GLTexture(Texture, Paintable, Gio.Icon, Gio.LoadableIcon): 
    @classmethod
    def new(cls, context: GLContext, id: int, width: int, height: int, destroy: GLib.DestroyNotify, data: object) -> GLTexture: ...
...
class KeyEvent(Event): 
    ...
    def get_match(self, keyval: int, modifiers: ModifierType) -> bool: ...
...
class MemoryTexture(Texture, Paintable, Gio.Icon, Gio.LoadableIcon): 
    @classmethod
    def new(cls, width: int, height: int, format: MemoryFormat, bytes: GLib.Bytes, stride: gsize) -> MemoryTexture: ...
...
class PadEvent(Event): 
    def get_axis_value(self, index: int, value: float) -> None: ...
    def get_button(self) -> int: ...
    def get_group_mode(self, group: int, mode: int) -> None: ...

class ProximityEvent(Event): ...

class ScrollEvent(Event): 
    def get_deltas(self, delta_x: float, delta_y: float) -> None: ...
...
class Seat(GObject.Object): 
    ...
    def get_devices(self, capabilities: SeatCapabilities) -> GLib.List: ...
    def get_display(self) -> Display: ...
    def get_keyboard(self) -> Device: ...
    def get_pointer(self) -> Device: ...
    def get_tools(self) -> GLib.List: ...
...
class Surface(GObject.Object): 
    ...
    def get_device_position(self, device: Device, x: float, y: float, mask: ModifierType) -> bool: ...
    def get_display(self) -> Display: ...
    ...
    def set_opaque_region(self, region: cairo.Region) -> None: ...
    def translate_coordinates(self, to: Surface, x: float, y: float) -> bool: ...

class Texture(GObject.Object, Paintable, Gio.Icon, Gio.LoadableIcon): 
    @classmethod
    def new_for_pixbuf(cls, pixbuf: GdkPixbuf.Pixbuf) -> Texture: ...
    def download(self, data: list[int], stride: gsize) -> None: ...
    def get_height(self) -> int: ...
    def get_width(self) -> int: ...
    def save_to_png(self, filename: filename) -> bool: ...
    def save_to_png_bytes(self) -> GLib.Bytes: ...
    def save_to_tiff(self, filename: filename) -> bool: ...
...
class TouchpadEvent(Event): 
    def get_deltas(self, dx: float, dy: float) -> None: ...
...
class Paintable: 
    ...
    def compute_concrete_size(self, specified_width: float, specified_height: float, default_width: float, default_height: float, concrete_width: float, concrete_height: float) -> None: ...
    def get_current_image(self) -> Paintable: ...
    def get_flags(self) -> PaintableFlags: ...
    def get_intrinsic_aspect_ratio(self) -> float: ...
    def get_intrinsic_height(self) -> int: ...
...
class Toplevel(Surface): 
    ...
    def begin_resize(self, edge: SurfaceEdge, device: Device, button: int, x: float, y: float, timestamp: int) -> None: ...
    def focus(self, timestamp: int) -> None: ...
    def get_state(self) -> ToplevelState: ...
    def inhibit_system_shortcuts(self, event: Event) -> None: ...
    def lower(self) -> bool: ...
    ...
    def set_icon_list(self, surfaces: GLib.List) -> None: ...
...
class PaintableFlags(GObject.GFlag): 
    SIZE = ...
    CONTENTS = ...
...
class ToplevelState(GObject.GFlag): 
    MINIMIZED = ...
    MAXIMIZED = ...
    STICKY = ...
    FULLSCREEN = ...
