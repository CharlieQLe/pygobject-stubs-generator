...
def aligned_alloc(n_blocks: gsize, n_block_bytes: gsize, alignment: gsize) -> object | None: ...
def aligned_alloc0(n_blocks: gsize, n_block_bytes: gsize, alignment: gsize) -> object | None: ...
def aligned_free(mem: object | None) -> None: ...
...
def assertion_message_expr(domain: str | None, file: str, line: int, func: str, expr: str | None) -> None: ...
...
def atomic_pointer_compare_and_exchange(atomic: object, oldval: object | None, newval: object | None) -> bool: ...
def atomic_pointer_compare_and_exchange_full(atomic: object, oldval: object | None, newval: object | None, preval: object) -> bool: ...
def atomic_pointer_exchange(atomic: object | None, newval: object | None) -> object | None: ...
def atomic_pointer_get(atomic: object) -> object | None: ...
def atomic_pointer_or(atomic: object, val: gsize) -> gsize: ...
def atomic_pointer_set(atomic: object, newval: object | None) -> None: ...
...
def base64_encode(data: list[int] | None, len: gsize) -> str: ...
...
def canonicalize_filename(filename: filename, relative_to: filename | None) -> filename: ...
...
def child_watch_add(pid: Pid, function: ChildWatchFunc, data: object | None) -> int: ...
def child_watch_add_full(priority: int, pid: Pid, function: ChildWatchFunc, data: object | None, notify: DestroyNotify | None) -> int: ...
def child_watch_source_new(pid: Pid) -> Source: ...
def clear_error() -> None: ...
def clear_handle_id(tag_ptr: int, clear_func: ClearHandleFunc) -> None: ...
def clear_list(list_ptr: GLib.List, destroy: DestroyNotify | None) -> None: ...
def clear_pointer(pp: object, destroy: DestroyNotify) -> None: ...
def clear_slist(slist_ptr: GLib.SList, destroy: DestroyNotify | None) -> None: ...
def close(fd: int) -> bool: ...
def compute_checksum_for_bytes(checksum_type: ChecksumType, data: Bytes) -> str | None: ...
def compute_checksum_for_data(checksum_type: ChecksumType, data: list[int], length: gsize) -> str | None: ...
def compute_checksum_for_string(checksum_type: ChecksumType, str: str, length: gssize) -> str | None: ...
...
def datalist_foreach(datalist: Data, func: DataForeachFunc, user_data: object | None) -> None: ...
def datalist_get_data(datalist: Data, key: str) -> object | None: ...
def datalist_get_flags(datalist: Data) -> int: ...
def datalist_id_dup_data(datalist: Data, key_id: Quark, dup_func: DuplicateFunc | None, user_data: object | None) -> object | None: ...
def datalist_id_get_data(datalist: Data, key_id: Quark) -> object | None: ...
def datalist_id_remove_multiple(datalist: Data, keys: list[Quark], n_keys: gsize) -> None: ...
def datalist_id_remove_no_notify(datalist: Data, key_id: Quark) -> object | None: ...
def datalist_id_replace_data(datalist: Data, key_id: Quark, oldval: object | None, newval: object | None, destroy: DestroyNotify | None, old_destroy: DestroyNotify) -> bool: ...
def datalist_id_set_data_full(datalist: Data, key_id: Quark, data: object | None, destroy_func: DestroyNotify | None) -> None: ...
...
def dataset_foreach(dataset_location: object, func: DataForeachFunc, user_data: object | None) -> None: ...
def dataset_id_get_data(dataset_location: object, key_id: Quark) -> object | None: ...
def dataset_id_remove_no_notify(dataset_location: object, key_id: Quark) -> object | None: ...
def dataset_id_set_data_full(dataset_location: object, key_id: Quark, data: object | None, destroy_func: DestroyNotify) -> None: ...
...
def dir_make_tmp(tmpl: filename | None) -> filename: ...
def direct_equal(v1: object | None, v2: object | None) -> bool: ...
def direct_hash(v: object | None) -> int: ...
...
def dpgettext(domain: str | None, msgctxtid: str, msgidoffset: gsize) -> str: ...
def dpgettext2(domain: str | None, context: str, msgid: str) -> str: ...
def environ_getenv(envp: list[filename] | None, variable: filename) -> filename | None: ...
def environ_setenv(envp: list[filename] | None, variable: filename, value: filename, overwrite: bool) -> list[filename]: ...
def environ_unsetenv(envp: list[filename] | None, variable: filename) -> list[filename]: ...
def file_error_from_errno(err_no: int) -> FileError: ...
def file_error_quark() -> Quark: ...
def file_get_contents(filename: filename, contents: list[int], length: gsize | None) -> bool: ...
def file_open_tmp(tmpl: filename | None, name_used: filename) -> int: ...
...
def get_user_special_dir(directory: UserDirectory) -> filename | None: ...
def get_user_state_dir() -> filename: ...
def getenv(variable: filename) -> filename | None: ...
def hash_table_add(hash_table: GLib.HashTable, key: object | None) -> bool: ...
def hash_table_contains(hash_table: GLib.HashTable, key: object | None) -> bool: ...
def hash_table_destroy(hash_table: GLib.HashTable) -> None: ...
def hash_table_insert(hash_table: GLib.HashTable, key: object | None, value: object | None) -> bool: ...
def hash_table_lookup(hash_table: GLib.HashTable, key: object | None) -> object | None: ...
def hash_table_lookup_extended(hash_table: GLib.HashTable, lookup_key: object | None, orig_key: object | None, value: object | None) -> bool: ...
def hash_table_new_similar(other_hash_table: GLib.HashTable) -> GLib.HashTable: ...
def hash_table_remove(hash_table: GLib.HashTable, key: object | None) -> bool: ...
def hash_table_remove_all(hash_table: GLib.HashTable) -> None: ...
def hash_table_replace(hash_table: GLib.HashTable, key: object | None, value: object | None) -> bool: ...
def hash_table_size(hash_table: GLib.HashTable) -> int: ...
def hash_table_steal(hash_table: GLib.HashTable, key: object | None) -> bool: ...
def hash_table_steal_all(hash_table: GLib.HashTable) -> None: ...
def hash_table_steal_extended(hash_table: GLib.HashTable, lookup_key: object | None, stolen_key: object | None, stolen_value: object | None) -> bool: ...
...
def idle_add(function: SourceFunc, data: object | None) -> int: ...
def idle_add_full(priority: int, function: SourceFunc, data: object | None, notify: DestroyNotify | None) -> int: ...
def idle_add_once(function: SourceOnceFunc, data: object | None) -> int: ...
def idle_remove_by_data(data: object | None) -> bool: ...
...
def io_add_watch(channel: IOChannel, condition: IOCondition, func: IOFunc, user_data: object | None) -> int: ...
def io_add_watch_full(channel: IOChannel, priority: int, condition: IOCondition, func: IOFunc, user_data: object | None, notify: DestroyNotify) -> int: ...
...
def log(log_domain: str | None, log_level: LogLevelFlags, format: str) -> None: ...
def log_default_handler(log_domain: str | None, log_level: LogLevelFlags, message: str | None, unused_data: object | None) -> None: ...
...
def log_set_default_handler(log_func: LogFunc, user_data: object | None) -> LogFunc: ...
def log_set_fatal_mask(log_domain: str, fatal_mask: LogLevelFlags) -> LogLevelFlags: ...
def log_set_handler(log_domain: str | None, log_levels: LogLevelFlags, log_func: LogFunc, user_data: object | None) -> int: ...
def log_set_handler_full(log_domain: str | None, log_levels: LogLevelFlags, log_func: LogFunc, user_data: object | None, destroy: DestroyNotify) -> int: ...
def log_set_writer_func(func: LogWriterFunc | None, user_data: object | None, user_data_free: DestroyNotify) -> None: ...
...
def log_variant(log_domain: str | None, log_level: LogLevelFlags, fields: Variant) -> None: ...
def log_writer_default(log_level: LogLevelFlags, fields: list[LogField], n_fields: gsize, user_data: object | None) -> LogWriterOutput: ...
def log_writer_default_set_use_stderr(use_stderr: bool) -> None: ...
def log_writer_default_would_drop(log_level: LogLevelFlags, log_domain: str | None) -> bool: ...
...
def log_writer_journald(log_level: LogLevelFlags, fields: list[LogField], n_fields: gsize, user_data: object | None) -> LogWriterOutput: ...
def log_writer_standard_streams(log_level: LogLevelFlags, fields: list[LogField], n_fields: gsize, user_data: object | None) -> LogWriterOutput: ...
def log_writer_supports_color(output_fd: int) -> bool: ...
def logv(log_domain: str | None, log_level: LogLevelFlags, format: str, args: va_list) -> None: ...
...
def main_depth() -> int: ...
def malloc(n_bytes: gsize) -> object | None: ...
def malloc0(n_bytes: gsize) -> object | None: ...
def malloc0_n(n_blocks: gsize, n_block_bytes: gsize) -> object | None: ...
def malloc_n(n_blocks: gsize, n_block_bytes: gsize) -> object | None: ...
...
def memdup(mem: object | None, byte_size: int) -> object | None: ...
def memdup2(mem: object | None, byte_size: gsize) -> object | None: ...
def mkdir_with_parents(pathname: filename, mode: int) -> int: ...
def mkdtemp(tmpl: filename) -> filename | None: ...
def mkdtemp_full(tmpl: filename, mode: int) -> filename | None: ...
...
def parse_debug_string(string: str | None, keys: list[DebugKey], nkeys: int) -> int: ...
...
def path_skip_root(file_name: filename) -> filename | None: ...
def pattern_match(pspec: PatternSpec, string_length: int, string: str, string_reversed: str | None) -> bool: ...
...
def prefix_error(err: Error | None, format: str) -> None: ...
...
def propagate_error(dest: Error | None, src: Error) -> None: ...
def propagate_prefixed_error(dest: Error, src: Error, format: str) -> None: ...
def ptr_array_find(haystack: list[object], needle: object | None, index_: int) -> bool: ...
def ptr_array_find_with_equal_func(haystack: list[object], needle: object | None, equal_func: EqualFunc | None, index_: int) -> bool: ...
def qsort_with_data(pbase: object, total_elems: int, size: gsize, compare_func: CompareDataFunc, user_data: object | None) -> None: ...
...
def realloc(mem: object | None, n_bytes: gsize) -> object | None: ...
def realloc_n(mem: object | None, n_blocks: gsize, n_block_bytes: gsize) -> object | None: ...
...
def return_if_fail_warning(log_domain: str | None, pretty_function: str, expression: str | None) -> None: ...
def rmdir(filename: filename) -> int: ...
def sequence_get(iter: SequenceIter) -> object | None: ...
def sequence_insert_before(iter: SequenceIter, data: object | None) -> SequenceIter: ...
...
def sequence_set(iter: SequenceIter, data: object | None) -> None: ...
...
def slice_alloc(block_size: gsize) -> object | None: ...
def slice_alloc0(block_size: gsize) -> object | None: ...
def slice_copy(block_size: gsize, mem_block: object | None) -> object | None: ...
def slice_free1(block_size: gsize, mem_block: object | None) -> None: ...
def slice_free_chain_with_offset(block_size: gsize, mem_chain: object | None, next_offset: gsize) -> None: ...
...
def source_remove_by_funcs_user_data(funcs: SourceFuncs, user_data: object | None) -> bool: ...
def source_remove_by_user_data(user_data: object | None) -> bool: ...
def source_set_name_by_id(tag: int, name: str) -> None: ...
def spaced_primes_closest(num: int) -> int: ...
def spawn_async(working_directory: filename | None, argv: list[filename], envp: list[filename] | None, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | None, user_data: object | None, child_pid: Pid) -> bool: ...
def spawn_async_with_fds(working_directory: filename | None, argv: list[str], envp: list[str] | None, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | None, user_data: object | None, child_pid: Pid, stdin_fd: int, stdout_fd: int, stderr_fd: int) -> bool: ...
def spawn_async_with_pipes(working_directory: filename | None, argv: list[filename], envp: list[filename] | None, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | None, user_data: object | None, child_pid: Pid, standard_input: int, standard_output: int, standard_error: int) -> bool: ...
def spawn_async_with_pipes_and_fds(working_directory: filename | None, argv: list[filename], envp: list[filename] | None, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | None, user_data: object | None, stdin_fd: int, stdout_fd: int, stderr_fd: int, source_fds: list[int] | None, target_fds: list[int] | None, n_fds: gsize, child_pid_out: Pid, stdin_pipe_out: int, stdout_pipe_out: int, stderr_pipe_out: int) -> bool: ...
...
def spawn_sync(working_directory: filename | None, argv: list[filename], envp: list[filename] | None, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | None, user_data: object | None, standard_output: list[int], standard_error: list[int], wait_status: int) -> bool: ...
...
def str_tokenize_and_fold(string: str, translit_locale: str | None, ascii_alternates: list[str]) -> list[str]: ...
...
def strdelimit(string: str, delimiters: str | None, new_delimiter: str) -> str: ...
...
def strdupv(str_array: str | None) -> list[str] | None: ...
def strerror(errnum: int) -> str: ...
def strescape(source: str, exceptions: str | None) -> str: ...
def strfreev(str_array: str | None) -> None: ...
def strip_context(msgid: str, msgval: str) -> str: ...
def strjoin(separator: str | None) -> str: ...
def strjoinv(separator: str | None, str_array: str) -> str: ...
...
def test_add_data_func(testpath: str, test_data: object | None, test_func: TestDataFunc) -> None: ...
def test_add_data_func_full(testpath: str, test_data: object | None, test_func: TestDataFunc, data_free_func: DestroyNotify) -> None: ...
def test_add_func(testpath: str, test_func: TestFunc) -> None: ...
def test_add_vtable(testpath: str, data_size: gsize, test_data: object | None, data_setup: TestFixtureFunc, data_test: TestFixtureFunc, data_teardown: TestFixtureFunc) -> None: ...
...
def test_create_case(test_name: str, data_size: gsize, test_data: object | None, data_setup: TestFixtureFunc, data_test: TestFixtureFunc, data_teardown: TestFixtureFunc) -> TestCase: ...
def test_create_suite(suite_name: str) -> TestSuite: ...
def test_expect_message(log_domain: str | None, log_level: LogLevelFlags, pattern: str) -> None: ...
def test_fail() -> None: ...
...
def test_log_set_fatal_handler(log_func: TestLogFatalFunc, user_data: object | None) -> None: ...
...
def test_queue_destroy(destroy_func: DestroyNotify, destroy_data: object | None) -> None: ...
def test_queue_free(gfree_pointer: object | None) -> None: ...
...
def test_trap_subprocess(test_path: str | None, usec_timeout: int, test_flags: TestSubprocessFlags) -> None: ...
def thread_error_quark() -> Quark: ...
def thread_exit(retval: object | None) -> None: ...
...
def timeout_add(interval: int, function: SourceFunc, data: object | None) -> int: ...
def timeout_add_full(priority: int, interval: int, function: SourceFunc, data: object | None, notify: DestroyNotify | None) -> int: ...
def timeout_add_once(interval: int, function: SourceOnceFunc, data: object | None) -> int: ...
def timeout_add_seconds(interval: int, function: SourceFunc, data: object | None) -> int: ...
def timeout_add_seconds_full(priority: int, interval: int, function: SourceFunc, data: object | None, notify: DestroyNotify | None) -> int: ...
...
def trash_stack_peek(stack_p: TrashStack) -> object | None: ...
def trash_stack_pop(stack_p: TrashStack) -> object | None: ...
def trash_stack_push(stack_p: TrashStack, data_p: object) -> None: ...
def try_malloc(n_bytes: gsize) -> object | None: ...
def try_malloc0(n_bytes: gsize) -> object | None: ...
def try_malloc0_n(n_blocks: gsize, n_block_bytes: gsize) -> object | None: ...
def try_malloc_n(n_blocks: gsize, n_block_bytes: gsize) -> object | None: ...
def try_realloc(mem: object | None, n_bytes: gsize) -> object | None: ...
def try_realloc_n(mem: object | None, n_blocks: gsize, n_block_bytes: gsize) -> object | None: ...
...
def unix_fd_add(fd: int, condition: IOCondition, function: UnixFDSourceFunc, user_data: object | None) -> int: ...
def unix_fd_add_full(priority: int, fd: int, condition: IOCondition, function: UnixFDSourceFunc, user_data: object | None, notify: DestroyNotify) -> int: ...
def unix_fd_source_new(fd: int, condition: IOCondition) -> Source: ...
def unix_get_passwd_entry(user_name: str) -> object | None: ...
def unix_open_pipe(fds: list[int], flags: int) -> bool: ...
def unix_set_fd_nonblocking(fd: int, nonblock: bool) -> bool: ...
def unix_signal_add(signum: int, handler: SourceFunc, user_data: object | None) -> int: ...
def unix_signal_add_full(priority: int, signum: int, handler: SourceFunc, user_data: object | None, notify: DestroyNotify) -> int: ...
def unix_signal_source_new(signum: int) -> Source: ...
def unlink(filename: filename) -> int: ...
def unsetenv(variable: filename) -> None: ...
def uri_build(flags: UriFlags, scheme: str, userinfo: str | None, host: str | None, port: int, path: str, query: str | None, fragment: str | None) -> Uri: ...
def uri_build_with_user(flags: UriFlags, scheme: str, user: str | None, password: str | None, auth_params: str | None, host: str | None, port: int, path: str, query: str | None, fragment: str | None) -> Uri: ...
def uri_error_quark() -> Quark: ...
def uri_escape_bytes(unescaped: list[int], length: gsize, reserved_chars_allowed: str | None) -> str: ...
...
def uri_join(flags: UriFlags, scheme: str | None, userinfo: str | None, host: str | None, port: int, path: str, query: str | None, fragment: str | None) -> str: ...
def uri_join_with_user(flags: UriFlags, scheme: str | None, user: str | None, password: str | None, auth_params: str | None, host: str | None, port: int, path: str, query: str | None, fragment: str | None) -> str: ...
...
def uri_resolve_relative(base_uri_string: str | None, uri_ref: str, flags: UriFlags) -> str: ...
def uri_split(uri_ref: str, flags: UriFlags, scheme: str | None, userinfo: str | None, host: str | None, port: int, path: str, query: str | None, fragment: str | None) -> bool: ...
def uri_split_network(uri_string: str, flags: UriFlags, scheme: str | None, host: str | None, port: int) -> bool: ...
def uri_split_with_user(uri_ref: str, flags: UriFlags, scheme: str | None, user: str | None, password: str | None, auth_params: str | None, host: str | None, port: int, path: str, query: str | None, fragment: str | None) -> bool: ...
def uri_unescape_bytes(escaped_string: str, length: gssize, illegal_characters: str | None) -> Bytes: ...
...
def utf8_normalize(str: str, len: gssize, mode: NormalizeMode) -> str | None: ...
...
def variant_type_string_scan(string: str, limit: str | None, endptr: str) -> bool: ...
...
def warn_message(domain: str | None, file: str, line: int, func: str, warnexpr: str | None) -> None: ...
