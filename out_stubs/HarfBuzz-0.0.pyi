...
def blob_create(data: str, length: int, mode: memory_mode_t, user_data: object, destroy: destroy_func_t) -> blob_t: ...
def blob_create_from_file(file_name: str) -> blob_t: ...
def blob_create_from_file_or_fail(file_name: str) -> blob_t: ...
def blob_create_or_fail(data: str, length: int, mode: memory_mode_t, user_data: object, destroy: destroy_func_t) -> blob_t: ...
def blob_create_sub_blob(parent: blob_t, offset: int, length: int) -> blob_t: ...
def blob_destroy(blob: blob_t) -> None: ...
def blob_get_data(blob: blob_t, length: int) -> list[str]: ...
...
def blob_set_user_data(blob: blob_t, key: user_data_key_t, data: object, destroy: destroy_func_t, replace: bool_t) -> bool_t: ...
...
def buffer_deserialize_glyphs(buffer: buffer_t, buf: list[str], buf_len: int, end_ptr: str, font: font_t, format: buffer_serialize_format_t) -> bool_t: ...
...
def buffer_serialize(buffer: buffer_t, start: int, end: int, buf: list[int], buf_size: int, buf_consumed: int, font: font_t, format: buffer_serialize_format_t, flags: buffer_serialize_flags_t) -> int: ...
...
def buffer_serialize_glyphs(buffer: buffer_t, start: int, end: int, buf: list[int], buf_size: int, buf_consumed: int, font: font_t, format: buffer_serialize_format_t, flags: buffer_serialize_flags_t) -> int: ...
...
def buffer_set_message_func(buffer: buffer_t, func: buffer_message_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
...
def buffer_set_user_data(buffer: buffer_t, key: user_data_key_t, data: object, destroy: destroy_func_t, replace: bool_t) -> bool_t: ...
...
def draw_close_path(dfuncs: draw_funcs_t, draw_data: object, st: draw_state_t) -> None: ...
def draw_cubic_to(dfuncs: draw_funcs_t, draw_data: object, st: draw_state_t, control1_x: float, control1_y: float, control2_x: float, control2_y: float, to_x: float, to_y: float) -> None: ...
...
def draw_funcs_set_close_path_func(dfuncs: draw_funcs_t, func: draw_close_path_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def draw_funcs_set_cubic_to_func(dfuncs: draw_funcs_t, func: draw_cubic_to_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def draw_funcs_set_line_to_func(dfuncs: draw_funcs_t, func: draw_line_to_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def draw_funcs_set_move_to_func(dfuncs: draw_funcs_t, func: draw_move_to_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def draw_funcs_set_quadratic_to_func(dfuncs: draw_funcs_t, func: draw_quadratic_to_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def draw_line_to(dfuncs: draw_funcs_t, draw_data: object, st: draw_state_t, to_x: float, to_y: float) -> None: ...
def draw_move_to(dfuncs: draw_funcs_t, draw_data: object, st: draw_state_t, to_x: float, to_y: float) -> None: ...
def draw_quadratic_to(dfuncs: draw_funcs_t, draw_data: object, st: draw_state_t, control_x: float, control_y: float, to_x: float, to_y: float) -> None: ...
...
def face_create_for_tables(reference_table_func: reference_table_func_t, user_data: object, destroy: destroy_func_t) -> face_t: ...
...
def face_set_user_data(face: face_t, key: user_data_key_t, data: object, destroy: destroy_func_t, replace: bool_t) -> bool_t: ...
...
def font_funcs_set_font_h_extents_func(ffuncs: font_funcs_t, func: font_get_font_h_extents_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_font_v_extents_func(ffuncs: font_funcs_t, func: font_get_font_v_extents_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_contour_point_func(ffuncs: font_funcs_t, func: font_get_glyph_contour_point_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_extents_func(ffuncs: font_funcs_t, func: font_get_glyph_extents_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_from_name_func(ffuncs: font_funcs_t, func: font_get_glyph_from_name_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_func(ffuncs: font_funcs_t, func: font_get_glyph_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_h_advance_func(ffuncs: font_funcs_t, func: font_get_glyph_h_advance_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_h_advances_func(ffuncs: font_funcs_t, func: font_get_glyph_h_advances_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_h_kerning_func(ffuncs: font_funcs_t, func: font_get_glyph_h_kerning_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_h_origin_func(ffuncs: font_funcs_t, func: font_get_glyph_h_origin_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_name_func(ffuncs: font_funcs_t, func: font_get_glyph_name_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_shape_func(ffuncs: font_funcs_t, func: font_get_glyph_shape_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_v_advance_func(ffuncs: font_funcs_t, func: font_get_glyph_v_advance_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_v_advances_func(ffuncs: font_funcs_t, func: font_get_glyph_v_advances_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_v_kerning_func(ffuncs: font_funcs_t, func: font_get_glyph_v_kerning_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_glyph_v_origin_func(ffuncs: font_funcs_t, func: font_get_glyph_v_origin_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_nominal_glyph_func(ffuncs: font_funcs_t, func: font_get_nominal_glyph_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_nominal_glyphs_func(ffuncs: font_funcs_t, func: font_get_nominal_glyphs_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def font_funcs_set_user_data(ffuncs: font_funcs_t, key: user_data_key_t, data: object, destroy: destroy_func_t, replace: bool_t) -> bool_t: ...
def font_funcs_set_variation_glyph_func(ffuncs: font_funcs_t, func: font_get_variation_glyph_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
...
def font_get_glyph_shape(font: font_t, glyph: codepoint_t, dfuncs: draw_funcs_t, draw_data: object) -> None: ...
...
def font_set_funcs(font: font_t, klass: font_funcs_t, font_data: object, destroy: destroy_func_t) -> None: ...
def font_set_funcs_data(font: font_t, font_data: object, destroy: destroy_func_t) -> None: ...
...
def font_set_user_data(font: font_t, key: user_data_key_t, data: object, destroy: destroy_func_t, replace: bool_t) -> bool_t: ...
...
def ft_face_create(ft_face: freetype2.Face, destroy: destroy_func_t) -> face_t: ...
...
def ft_font_create(ft_face: freetype2.Face, destroy: destroy_func_t) -> font_t: ...
def ft_font_create_referenced(ft_face: freetype2.Face) -> font_t: ...
def ft_font_get_face(font: font_t) -> freetype2.Face: ...
def ft_font_get_load_flags(font: font_t) -> int: ...
def ft_font_lock_face(font: font_t) -> freetype2.Face: ...
...
def graphite2_face_get_gr_face(face: face_t) -> None: ...
def graphite2_font_get_gr_font(font: font_t) -> None: ...
...
def map_set_user_data(map: map_t, key: user_data_key_t, data: object, destroy: destroy_func_t, replace: bool_t) -> bool_t: ...
def ot_color_glyph_get_layers(face: face_t, glyph: codepoint_t, start_offset: int, layer_count: int, layers: list[ot_color_layer_t]) -> int: ...
...
def ot_color_palette_get_colors(face: face_t, palette_index: int, start_offset: int, color_count: int, colors: list[color_t]) -> int: ...
...
def ot_layout_collect_features(face: face_t, table_tag: tag_t, scripts: list[tag_t], languages: list[tag_t], features: list[tag_t], feature_indexes: set_t) -> None: ...
def ot_layout_collect_lookups(face: face_t, table_tag: tag_t, scripts: list[tag_t], languages: list[tag_t], features: list[tag_t], lookup_indexes: set_t) -> None: ...
...
def set_set_user_data(set: set_t, key: user_data_key_t, data: object, destroy: destroy_func_t, replace: bool_t) -> bool_t: ...
...
def shape(font: font_t, buffer: buffer_t, features: list[feature_t], num_features: int) -> None: ...
def shape_full(font: font_t, buffer: buffer_t, features: list[feature_t], num_features: int, shaper_list: list[str]) -> bool_t: ...
...
def shape_plan_set_user_data(shape_plan: shape_plan_t, key: user_data_key_t, data: object, destroy: destroy_func_t, replace: bool_t) -> bool_t: ...
...
def unicode_funcs_create(parent: unicode_funcs_t) -> unicode_funcs_t: ...
...
def unicode_funcs_set_combining_class_func(ufuncs: unicode_funcs_t, func: unicode_combining_class_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def unicode_funcs_set_compose_func(ufuncs: unicode_funcs_t, func: unicode_compose_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def unicode_funcs_set_decompose_compatibility_func(ufuncs: unicode_funcs_t, func: unicode_decompose_compatibility_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def unicode_funcs_set_decompose_func(ufuncs: unicode_funcs_t, func: unicode_decompose_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def unicode_funcs_set_eastasian_width_func(ufuncs: unicode_funcs_t, func: unicode_eastasian_width_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def unicode_funcs_set_general_category_func(ufuncs: unicode_funcs_t, func: unicode_general_category_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def unicode_funcs_set_mirroring_func(ufuncs: unicode_funcs_t, func: unicode_mirroring_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def unicode_funcs_set_script_func(ufuncs: unicode_funcs_t, func: unicode_script_func_t, user_data: object, destroy: destroy_func_t) -> None: ...
def unicode_funcs_set_user_data(ufuncs: unicode_funcs_t, key: user_data_key_t, data: object, destroy: destroy_func_t, replace: bool_t) -> bool_t: ...
