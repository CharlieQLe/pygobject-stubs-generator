...
def show_about_window(parent: Gtk.Window, first_property_name: str) -> None: ...
...
class AboutWindow(Window, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager): 
    ...
    def add_acknowledgement_section(self, name: str, people: list[str]) -> None: ...
    def add_credit_section(self, name: str, people: list[str]) -> None: ...
    def add_legal_section(self, title: str, copyright: str, license_type: Gtk.License, license: str) -> None: ...
    ...
    def set_designers(self, designers: list[str]) -> None: ...
    def set_developer_name(self, developer_name: str) -> None: ...
    def set_developers(self, developers: list[str]) -> None: ...
...
class ActionRow(PreferencesRow, Gtk.Accessible, Gtk.Actionable, Gtk.Buildable, Gtk.ConstraintTarget): 
    ...
    def get_activatable_widget(self) -> Gtk.Widget: ...
...
class Avatar(Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget): 
    @classmethod
    def new(cls, size: int, text: str, show_initials: bool) -> Gtk.Widget: ...
    def draw_to_texture(self, scale_factor: int) -> Gdk.Texture: ...
    def get_custom_image(self) -> Gdk.Paintable: ...
    def get_icon_name(self) -> str: ...
    def get_show_initials(self) -> bool: ...
    def get_size(self) -> int: ...
    def get_text(self) -> str: ...
    def set_custom_image(self, custom_image: Gdk.Paintable) -> None: ...
    def set_icon_name(self, icon_name: str) -> None: ...
...
class CallbackAnimationTarget(AnimationTarget): 
    @classmethod
    def new(cls, callback: AnimationTargetFunc, user_data: object, destroy: GLib.DestroyNotify) -> AnimationTarget: ...
...
class CarouselIndicatorDots(Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable): 
    ...
    def set_carousel(self, carousel: Carousel) -> None: ...
...
class ComboRow(ActionRow, Gtk.Accessible, Gtk.Actionable, Gtk.Buildable, Gtk.ConstraintTarget): 
    ...
    def get_factory(self) -> Gtk.ListItemFactory: ...
    def get_list_factory(self) -> Gtk.ListItemFactory: ...
    def get_model(self) -> Gio.ListModel: ...
    def get_selected(self) -> int: ...
    def get_selected_item(self) -> GObject.Object: ...
    def get_use_subtitle(self) -> bool: ...
    def set_expression(self, expression: Gtk.Expression) -> None: ...
    def set_factory(self, factory: Gtk.ListItemFactory) -> None: ...
    def set_list_factory(self, factory: Gtk.ListItemFactory) -> None: ...
...
class EntryRow(PreferencesRow, Gtk.Accessible, Gtk.Actionable, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Editable): 
    ...
    def set_attributes(self, attributes: Pango.AttrList) -> None: ...
...
class Flap(Gtk.Widget, Swipeable, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable): 
    ...
    def set_separator(self, separator: Gtk.Widget) -> None: ...
...
class HeaderBar(Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget): 
    ...
    def get_title_widget(self) -> Gtk.Widget: ...
    ...
    def set_title_widget(self, title_widget: Gtk.Widget) -> None: ...
...
class Leaflet(Gtk.Widget, Swipeable, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable): 
    ...
    def get_adjacent_child(self, direction: NavigationDirection) -> Gtk.Widget: ...
    def get_can_navigate_back(self) -> bool: ...
    def get_can_navigate_forward(self) -> bool: ...
    def get_can_unfold(self) -> bool: ...
    def get_child_by_name(self, name: str) -> Gtk.Widget: ...
    ...
    def insert_child_after(self, child: Gtk.Widget, sibling: Gtk.Widget) -> LeafletPage: ...
    def navigate(self, direction: NavigationDirection) -> bool: ...
    def prepend(self, child: Gtk.Widget) -> LeafletPage: ...
    def remove(self, child: Gtk.Widget) -> None: ...
    def reorder_child_after(self, child: Gtk.Widget, sibling: Gtk.Widget) -> None: ...
...
class MessageDialog(Gtk.Window, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager): 
    @classmethod
    def new(cls, parent: Gtk.Window, heading: str, body: str) -> Gtk.Widget: ...
    ...
    def get_extra_child(self) -> Gtk.Widget: ...
    ...
    def set_extra_child(self, child: Gtk.Widget) -> None: ...
...
class PreferencesGroup(Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget): 
    ...
    def get_header_suffix(self) -> Gtk.Widget: ...
    def get_title(self) -> str: ...
    def remove(self, child: Gtk.Widget) -> None: ...
    def set_description(self, description: str) -> None: ...
    def set_header_suffix(self, suffix: Gtk.Widget) -> None: ...
...
class PreferencesWindow(Window, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager): 
    ...
    def get_visible_page(self) -> PreferencesPage: ...
...
class SplitButton(Gtk.Widget, Gtk.Accessible, Gtk.Actionable, Gtk.Buildable, Gtk.ConstraintTarget): 
    ...
    def get_popover(self) -> Gtk.Popover: ...
    def get_use_underline(self) -> bool: ...
    ...
    def set_popover(self, popover: Gtk.Popover) -> None: ...
    def set_use_underline(self, use_underline: bool) -> None: ...
...
class TabBar(Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget): 
    ...
    def get_end_action_widget(self) -> Gtk.Widget: ...
    def get_expand_tabs(self) -> bool: ...
    def get_inverted(self) -> bool: ...
    def get_is_overflowing(self) -> bool: ...
    def get_start_action_widget(self) -> Gtk.Widget: ...
    def get_tabs_revealed(self) -> bool: ...
    def get_view(self) -> TabView: ...
    def set_autohide(self, autohide: bool) -> None: ...
    def set_end_action_widget(self, widget: Gtk.Widget) -> None: ...
    def set_expand_tabs(self, expand_tabs: bool) -> None: ...
    def set_inverted(self, inverted: bool) -> None: ...
    def set_start_action_widget(self, widget: Gtk.Widget) -> None: ...
    def set_view(self, view: TabView) -> None: ...
    def setup_extra_drop_target(self, actions: Gdk.DragAction, types: list[GObject.Type], n_types: gsize) -> None: ...

class TabPage(GObject.Object): 
    def get_child(self) -> Gtk.Widget: ...
    def get_icon(self) -> Gio.Icon: ...
    def get_indicator_activatable(self) -> bool: ...
    def get_indicator_icon(self) -> Gio.Icon: ...
    def get_indicator_tooltip(self) -> str: ...
    def get_loading(self) -> bool: ...
    def get_needs_attention(self) -> bool: ...
    def get_parent(self) -> TabPage: ...
    ...
    def set_indicator_icon(self, indicator_icon: Gio.Icon) -> None: ...
...
class TabView(Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget): 
    @classmethod
    def new(cls) -> TabView: ...
    def add_page(self, child: Gtk.Widget, parent: TabPage) -> TabPage: ...
    ...
    def get_pages(self) -> Gtk.SelectionModel: ...
    def get_selected_page(self) -> TabPage: ...
...
class Toast(GObject.Object): 
    ...
    def get_custom_title(self) -> Gtk.Widget: ...
    ...
    def set_action_target_value(self, action_target: GLib.Variant) -> None: ...
    def set_button_label(self, button_label: str) -> None: ...
    def set_custom_title(self, widget: Gtk.Widget) -> None: ...
...
class ViewStack(Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget): 
    ...
    def add_named(self, child: Gtk.Widget, name: str) -> ViewStackPage: ...
    def add_titled(self, child: Gtk.Widget, name: str, title: str) -> ViewStackPage: ...
    def add_titled_with_icon(self, child: Gtk.Widget, name: str, title: str, icon_name: str) -> ViewStackPage: ...
    def get_child_by_name(self, name: str) -> Gtk.Widget: ...
...
class ViewSwitcher(Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget): 
    ...
    def get_stack(self) -> ViewStack: ...
    def set_policy(self, policy: ViewSwitcherPolicy) -> None: ...
    def set_stack(self, stack: ViewStack) -> None: ...
