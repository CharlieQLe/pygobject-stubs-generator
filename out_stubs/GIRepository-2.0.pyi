...
def callable_info_invoke(info: CallableInfo, function: object, in_args: list[Argument], n_in_args: int, out_args: list[Argument], n_out_args: int, return_value: Argument, is_method: bool, throws: bool) -> bool: ...
...
def cclosure_marshal_generic(closure: GObject.Closure, return_gvalue: GObject.Value, n_param_values: int, param_values: GObject.Value, invocation_hint: object, marshal_data: object) -> None: ...
...
def field_info_get_field(field_info: FieldInfo, mem: object, value: Argument) -> bool: ...
...
def field_info_set_field(field_info: FieldInfo, mem: object, value: Argument) -> bool: ...
...
def object_info_find_method(info: ObjectInfo, name: str) -> FunctionInfo: ...
def object_info_find_method_using_interfaces(info: ObjectInfo, name: str, implementor: ObjectInfo) -> FunctionInfo: ...
def object_info_find_signal(info: ObjectInfo, name: str) -> SignalInfo: ...
def object_info_find_vfunc(info: ObjectInfo, name: str) -> VFuncInfo: ...
def object_info_find_vfunc_using_interfaces(info: ObjectInfo, name: str, implementor: ObjectInfo) -> VFuncInfo: ...
def object_info_get_abstract(info: ObjectInfo) -> bool: ...
def object_info_get_class_struct(info: ObjectInfo) -> StructInfo: ...
...
def object_info_get_get_value_function(info: ObjectInfo) -> str: ...
def object_info_get_get_value_function_pointer(info: ObjectInfo) -> ObjectInfoGetValueFunction: ...
...
def object_info_get_parent(info: ObjectInfo) -> ObjectInfo: ...
def object_info_get_property(info: ObjectInfo, n: int) -> PropertyInfo: ...
def object_info_get_ref_function(info: ObjectInfo) -> str: ...
def object_info_get_ref_function_pointer(info: ObjectInfo) -> ObjectInfoRefFunction: ...
def object_info_get_set_value_function(info: ObjectInfo) -> str: ...
def object_info_get_set_value_function_pointer(info: ObjectInfo) -> ObjectInfoSetValueFunction: ...
...
def object_info_get_unref_function(info: ObjectInfo) -> str: ...
def object_info_get_unref_function_pointer(info: ObjectInfo) -> ObjectInfoUnrefFunction: ...
...
def property_info_get_getter(info: PropertyInfo) -> FunctionInfo: ...
def property_info_get_ownership_transfer(info: PropertyInfo) -> Transfer: ...
def property_info_get_setter(info: PropertyInfo) -> FunctionInfo: ...
...
def type_info_argument_from_hash_pointer(info: TypeInfo, hash_pointer: object, arg: Argument) -> None: ...
...
def type_info_hash_pointer_from_argument(info: TypeInfo, arg: Argument) -> object: ...
def type_info_is_pointer(info: TypeInfo) -> bool: ...
def type_info_is_zero_terminated(info: TypeInfo) -> bool: ...
def type_tag_argument_from_hash_pointer(storage_type: TypeTag, hash_pointer: object, arg: Argument) -> None: ...
def type_tag_hash_pointer_from_argument(storage_type: TypeTag, arg: Argument) -> object: ...
...
def vfunc_info_get_address(info: VFuncInfo, implementor_gtype: GObject.Type) -> object: ...
...
class Repository(GObject.Object): 
    ...
    def get_shared_library(self, namespace_: str) -> str: ...
    def get_typelib_path(self, namespace_: str) -> str: ...
    def get_version(self, namespace_: str) -> str: ...
    def is_registered(self, namespace_: str, version: str) -> bool: ...
    def load_typelib(self, typelib: Typelib, flags: RepositoryLoadFlags) -> str: ...
    def require(self, namespace_: str, version: str, flags: RepositoryLoadFlags) -> Typelib: ...
    def require_private(self, typelib_dir: str, namespace_: str, version: str, flags: RepositoryLoadFlags) -> Typelib: ...
