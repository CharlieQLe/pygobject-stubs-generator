...
def boxed_deserialize(gboxed_type: GObject.Type, node: Node) -> object | None: ...
...
def boxed_serialize(gboxed_type: GObject.Type, boxed: object | None) -> Node | None: ...
def construct_gobject(gtype: GObject.Type, data: str, length: gsize) -> GObject.Object | None: ...
def from_string(str: str) -> Node | None: ...
def gobject_deserialize(gtype: GObject.Type, node: Node) -> GObject.Object: ...
def gobject_from_data(gtype: GObject.Type, data: str, length: gssize) -> GObject.Object | None: ...
def gobject_serialize(gobject: GObject.Object) -> Node: ...
def gobject_to_data(gobject: GObject.Object, length: gsize) -> str: ...
def gvariant_deserialize(json_node: Node, signature: str | None) -> GLib.Variant | None: ...
def gvariant_deserialize_data(json: str, length: gssize, signature: str | None) -> GLib.Variant | None: ...
...
class Builder(GObject.Object): 
    @classmethod
    def new(cls) -> Builder: ...
    def add_boolean_value(self, value: bool) -> Builder | None: ...
    def add_double_value(self, value: float) -> Builder | None: ...
    def add_int_value(self, value: int) -> Builder | None: ...
    def add_null_value(self) -> Builder | None: ...
    def add_string_value(self, value: str) -> Builder | None: ...
    def add_value(self, node: Node) -> Builder | None: ...
    def begin_array(self) -> Builder | None: ...
    def begin_object(self) -> Builder | None: ...
    def end_array(self) -> Builder | None: ...
    def end_object(self) -> Builder | None: ...
    def get_root(self) -> Node | None: ...
    def reset(self) -> None: ...
    def set_member_name(self, member_name: str) -> Builder | None: ...
...
class Generator(GObject.Object): 
    ...
    def to_stream(self, stream: Gio.OutputStream, cancellable: Gio.Cancellable | None) -> bool: ...
...
class Parser(GObject.Object): 
    ...
    def load_from_stream(self, stream: Gio.InputStream, cancellable: Gio.Cancellable | None) -> bool: ...
    def load_from_stream_async(self, stream: Gio.InputStream, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    def load_from_stream_finish(self, result: Gio.AsyncResult) -> bool: ...
    def steal_root(self) -> Node | None: ...
...
class Reader(GObject.Object): 
    @classmethod
    def new(cls, node: Node | None) -> Reader: ...
...
class Serializable: 
    ...
    def find_property(self, name: str) -> GObject.ParamSpec | None: ...
    ...
    def default_serialize_property(self, property_name: str, value: GObject.Value, pspec: GObject.ParamSpec) -> Node | None: ...
    def deserialize_property(self, property_name: str, value: GObject.Value, pspec: GObject.ParamSpec, property_node: Node) -> bool: ...
    def find_property(self, name: str) -> GObject.ParamSpec | None: ...
    def get_property(self, pspec: GObject.ParamSpec, value: GObject.Value) -> None: ...
