...
class DOMDOMImplementation(DOMObject): 
    ...
    def create_document(self, namespaceURI: str | None, qualifiedName: str, doctype: DOMDocumentType | None) -> DOMDocument: ...
...
class DOMDOMWindow(DOMObject, DOMEventTarget): 
    ...
    def get_computed_style(self, element: DOMElement, pseudoElement: str | None) -> DOMCSSStyleDeclaration: ...
...
class DOMDocument(DOMNode, DOMEventTarget): 
    ...
    def create_attribute_ns(self, namespaceURI: str | None, qualifiedName: str) -> DOMAttr: ...
    ...
    def create_element_ns(self, namespaceURI: str | None, qualifiedName: str) -> DOMElement: ...
    def create_entity_reference(self, name: str | None) -> DOMEntityReference: ...
    ...
    def create_node_iterator(self, root: DOMNode, whatToShow: int, filter: DOMNodeFilter | None, expandEntityReferences: bool) -> DOMNodeIterator: ...
    ...
    def create_tree_walker(self, root: DOMNode, whatToShow: int, filter: DOMNodeFilter | None, expandEntityReferences: bool) -> DOMTreeWalker: ...
    def element_from_point(self, x: int, y: int) -> DOMElement: ...
    def evaluate(self, expression: str, contextNode: DOMNode, resolver: DOMXPathNSResolver | None, type: gushort, inResult: DOMXPathResult | None) -> DOMXPathResult: ...
    ...
    def get_override_style(self, element: DOMElement, pseudoElement: str | None) -> DOMCSSStyleDeclaration: ...
...
class DOMElement(DOMNode, DOMEventTarget): 
    ...
    def set_attribute_ns(self, namespaceURI: str | None, qualifiedName: str, value: str) -> None: ...
...
class DOMNode(DOMObject, DOMEventTarget): 
    ...
    def insert_before(self, newChild: DOMNode, refChild: DOMNode | None) -> DOMNode: ...
...
class WebExtension(GObject.Object): 
    ...
    def send_message_to_context(self, message: UserMessage, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
...
class WebPage(GObject.Object): 
    ...
    def get_uri(self) -> str: ...
    def send_message_to_view(self, message: UserMessage, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
...
class DOMEventTarget: 
    ...
    def add_event_listener(self, event_name: str, handler: GObject.Callback, use_capture: bool, user_data: object | None) -> bool: ...
