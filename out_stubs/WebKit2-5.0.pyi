...
def uri_for_display(uri: str) -> str: ...
...
class BackForwardList(GObject.Object): 
    def get_back_item(self) -> BackForwardListItem: ...
    def get_back_list(self) -> GLib.List: ...
    def get_back_list_with_limit(self, limit: int) -> GLib.List: ...
    def get_current_item(self) -> BackForwardListItem: ...
    def get_forward_item(self) -> BackForwardListItem: ...
    def get_forward_list(self) -> GLib.List: ...
    def get_forward_list_with_limit(self, limit: int) -> GLib.List: ...
    def get_length(self) -> int: ...
    def get_nth_item(self, index: int) -> BackForwardListItem: ...
...
class CookieManager(GObject.Object): 
    def add_cookie(self, cookie: Soup.Cookie, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def add_cookie_finish(self, result: Gio.AsyncResult) -> bool: ...
    def delete_all_cookies(self) -> None: ...
    def delete_cookie(self, cookie: Soup.Cookie, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def delete_cookie_finish(self, result: Gio.AsyncResult) -> bool: ...
    def delete_cookies_for_domain(self, domain: str) -> None: ...
    def get_accept_policy(self, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def get_accept_policy_finish(self, result: Gio.AsyncResult) -> CookieAcceptPolicy: ...
    def get_cookies(self, uri: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def get_cookies_finish(self, result: Gio.AsyncResult) -> GLib.List: ...
    def get_domains_with_cookies(self, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class FaviconDatabase(GObject.Object): 
    def clear(self) -> None: ...
    def get_favicon(self, page_uri: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class FormSubmissionRequest(GObject.Object): 
    def get_text_fields(self) -> GLib.HashTable: ...
...
class InputMethodContext(GObject.Object): 
    ...
    def get_preedit(self, text: str, underlines: GLib.List, cursor_offset: int) -> None: ...
...
class PrintOperation(GObject.Object): 
    ...
    def print(self) -> None: ...
    def run_dialog(self, parent: Gtk.Window) -> PrintOperationResponse: ...
...
class Settings(GObject.Object): 
    ...
    def set_media_content_types_requiring_hardware_support(self, content_types: str) -> None: ...
    ...
    def set_user_agent_with_application_details(self, application_name: str, application_version: str) -> None: ...
...
class URISchemeRequest(GObject.Object): 
    def finish(self, stream: Gio.InputStream, stream_length: int, content_type: str) -> None: ...
...
class UserContentFilterStore(GObject.Object): 
    ...
    def fetch_identifiers(self, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def fetch_identifiers_finish(self, result: Gio.AsyncResult) -> list[str]: ...
    def get_path(self) -> str: ...
    def load(self, identifier: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def load_finish(self, result: Gio.AsyncResult) -> UserContentFilter: ...
    def remove(self, identifier: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def remove_finish(self, result: Gio.AsyncResult) -> bool: ...
    def save(self, identifier: str, source: GLib.Bytes, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def save_finish(self, result: Gio.AsyncResult) -> UserContentFilter: ...
    def save_from_file(self, identifier: str, file: Gio.File, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class WebContext(GObject.Object): 
    ...
    def get_plugins(self, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def register_uri_scheme(self, scheme: str, callback: URISchemeRequestCallback, user_data: object, user_data_destroy_func: GLib.DestroyNotify) -> None: ...
    ...
    def set_favicon_database_directory(self, path: str) -> None: ...
    def set_network_proxy_settings(self, proxy_mode: NetworkProxyMode, proxy_settings: NetworkProxySettings) -> None: ...
...
class WebResource(GObject.Object): 
    def get_data(self, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class WebView(WebViewBase, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget): 
    ...
    def can_execute_editing_command(self, command: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def get_default_content_security_policy(self) -> str: ...
    ...
    def get_input_method_context(self) -> InputMethodContext: ...
    ...
    def get_snapshot(self, region: SnapshotRegion, options: SnapshotOptions, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def load_alternate_html(self, content: str, content_uri: str, base_uri: str) -> None: ...
    def load_bytes(self, bytes: GLib.Bytes, mime_type: str, encoding: str, base_uri: str) -> None: ...
    ...
    def run_async_javascript_function_in_world(self, body: str, arguments: GLib.Variant, world_name: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def run_javascript(self, script: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def run_javascript_finish(self, result: Gio.AsyncResult) -> JavascriptResult: ...
    def run_javascript_from_gresource(self, resource: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def run_javascript_from_gresource_finish(self, result: Gio.AsyncResult) -> JavascriptResult: ...
    def run_javascript_in_world(self, script: str, world_name: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def run_javascript_in_world_finish(self, result: Gio.AsyncResult) -> JavascriptResult: ...
    def save(self, save_mode: SaveMode, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def save_finish(self, result: Gio.AsyncResult) -> Gio.InputStream: ...
    def save_to_file(self, file: Gio.File, save_mode: SaveMode, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def save_to_file_finish(self, result: Gio.AsyncResult) -> bool: ...
    def send_message_to_page(self, message: UserMessage, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def set_cors_allowlist(self, allowlist: list[str]) -> None: ...
    def set_custom_charset(self, charset: str) -> None: ...
    def set_display_capture_state(self, state: MediaCaptureState) -> None: ...
    def set_editable(self, editable: bool) -> None: ...
    def set_input_method_context(self, context: InputMethodContext) -> None: ...
...
class WebsiteDataManager(GObject.Object): 
    ...
    def clear(self, types: WebsiteDataTypes, timespan: GLib.TimeSpan, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def clear_finish(self, result: Gio.AsyncResult) -> bool: ...
    def fetch(self, types: WebsiteDataTypes, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def fetch_finish(self, result: Gio.AsyncResult) -> GLib.List: ...
    def get_base_cache_directory(self) -> str: ...
    def get_base_data_directory(self) -> str: ...
    def get_cookie_manager(self) -> CookieManager: ...
    def get_disk_cache_directory(self) -> str: ...
    def get_dom_cache_directory(self) -> str: ...
    def get_hsts_cache_directory(self) -> str: ...
    def get_indexeddb_directory(self) -> str: ...
    def get_itp_directory(self) -> str: ...
    def get_itp_enabled(self) -> bool: ...
    def get_itp_summary(self, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def get_itp_summary_finish(self, result: Gio.AsyncResult) -> GLib.List: ...
    def get_local_storage_directory(self) -> str: ...
    def get_offline_application_cache_directory(self) -> str: ...
    def get_persistent_credential_storage_enabled(self) -> bool: ...
    def get_service_worker_registrations_directory(self) -> str: ...
    def get_tls_errors_policy(self) -> TLSErrorsPolicy: ...
    def get_websql_directory(self) -> str: ...
    def is_ephemeral(self) -> bool: ...
    def remove(self, types: WebsiteDataTypes, website_data: GLib.List, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    def remove_finish(self, result: Gio.AsyncResult) -> bool: ...
