...
def font_get_face(font: Pango.Font) -> freetype2.Face | None: ...
...
def render_transformed(bitmap: freetype2.Bitmap, matrix: Pango.Matrix | None, font: Pango.Font, glyphs: Pango.GlyphString, x: int, y: int) -> None: ...
