...
def binding_set_by_class(object_class: object | None) -> BindingSet: ...
...
def init(argc: int, argv: list[str] | None) -> None: ...
def init_check(argc: int, argv: list[str] | None) -> bool: ...
def init_with_args(argc: int, argv: list[str] | None, parameter_string: str | None, entries: list[GLib.OptionEntry], translation_domain: str | None) -> bool: ...
def key_snooper_install(snooper: KeySnoopFunc, func_data: object | None) -> int: ...
...
def main_level() -> int: ...
def main_quit() -> None: ...
def paint_arrow(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, arrow_type: ArrowType, fill: bool, x: int, y: int, width: int, height: int) -> None: ...
def paint_box(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int) -> None: ...
def paint_box_gap(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int, gap_side: PositionType, gap_x: int, gap_width: int) -> None: ...
def paint_check(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int) -> None: ...
def paint_diamond(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int) -> None: ...
def paint_expander(style: Style, cr: cairo.Context, state_type: StateType, widget: Widget | None, detail: str | None, x: int, y: int, expander_style: ExpanderStyle) -> None: ...
def paint_extension(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int, gap_side: PositionType) -> None: ...
def paint_flat_box(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int) -> None: ...
def paint_focus(style: Style, cr: cairo.Context, state_type: StateType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int) -> None: ...
def paint_handle(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int, orientation: Orientation) -> None: ...
def paint_hline(style: Style, cr: cairo.Context, state_type: StateType, widget: Widget | None, detail: str | None, x1: int, x2: int, y: int) -> None: ...
def paint_layout(style: Style, cr: cairo.Context, state_type: StateType, use_text: bool, widget: Widget | None, detail: str | None, x: int, y: int, layout: Pango.Layout) -> None: ...
def paint_option(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int) -> None: ...
def paint_resize_grip(style: Style, cr: cairo.Context, state_type: StateType, widget: Widget | None, detail: str | None, edge: Gdk.WindowEdge, x: int, y: int, width: int, height: int) -> None: ...
def paint_shadow(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int) -> None: ...
def paint_shadow_gap(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int, gap_side: PositionType, gap_x: int, gap_width: int) -> None: ...
def paint_slider(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int, orientation: Orientation) -> None: ...
def paint_spinner(style: Style, cr: cairo.Context, state_type: StateType, widget: Widget | None, detail: str | None, step: int, x: int, y: int, width: int, height: int) -> None: ...
def paint_tab(style: Style, cr: cairo.Context, state_type: StateType, shadow_type: ShadowType, widget: Widget | None, detail: str | None, x: int, y: int, width: int, height: int) -> None: ...
def paint_vline(style: Style, cr: cairo.Context, state_type: StateType, widget: Widget | None, detail: str | None, y1_: int, y2_: int, x: int) -> None: ...
...
def rc_get_style_by_paths(settings: Settings, widget_path: str | None, class_path: str | None, type: GObject.Type) -> Style | None: ...
def rc_get_theme_dir() -> str: ...
def rc_parse(filename: str) -> None: ...
def rc_parse_color(scanner: GLib.Scanner, color: Gdk.Color) -> int: ...
def rc_parse_color_full(scanner: GLib.Scanner, style: RcStyle | None, color: Gdk.Color) -> int: ...
...
def selection_owner_set(widget: Widget | None, selection: Gdk.Atom, time_: int) -> bool: ...
def selection_owner_set_for_display(display: Gdk.Display, widget: Widget | None, selection: Gdk.Atom, time_: int) -> bool: ...
...
def stock_set_translate_func(domain: str, func: TranslateFunc, data: object | None, notify: GLib.DestroyNotify) -> None: ...
...
def test_create_widget(widget_type: GObject.Type, first_property_name: str | None) -> Widget: ...
...
def test_find_widget(widget: Widget, label_pattern: str, widget_type: GObject.Type) -> Widget | None: ...
...
def tree_get_row_drag_data(selection_data: SelectionData, tree_model: TreeModel | None, path: TreePath | None) -> bool: ...
...
class AccelGroup(GObject.Object): 
    ...
    @classmethod
    def from_accel_closure(cls, closure: GObject.Closure) -> AccelGroup | None: ...
    ...
    def find(self, find_func: AccelGroupFindFunc, data: object | None) -> AccelKey: ...
    def get_is_locked(self) -> bool: ...
    def get_modifier_mask(self) -> Gdk.ModifierType: ...
    def lock(self) -> None: ...
    def query(self, accel_key: int, accel_mods: Gdk.ModifierType, n_entries: int) -> list[AccelGroupEntry] | None: ...
...
class AccelLabel(Label, Atk.ImplementorIface, Buildable): 
    ...
    def set_accel_closure(self, accel_closure: GObject.Closure | None) -> None: ...
    def set_accel_widget(self, accel_widget: Widget | None) -> None: ...
...
class AccelMap(GObject.Object): 
    ...
    @classmethod
    def foreach(cls, data: object | None, foreach_func: AccelMapForeach) -> None: ...
    @classmethod
    def foreach_unfiltered(cls, data: object | None, foreach_func: AccelMapForeach) -> None: ...
    @classmethod
...
class Action(GObject.Object, Buildable): 
    @classmethod
    def new(cls, name: str, label: str | None, tooltip: str | None, stock_id: str | None) -> Action: ...
    ...
    def set_accel_group(self, accel_group: AccelGroup | None) -> None: ...
...
class ActionGroup(GObject.Object, Buildable): 
    ...
    def add_action_with_accel(self, action: Action, accelerator: str | None) -> None: ...
    def add_actions(self, entries: list[ActionEntry], n_entries: int, user_data: object | None) -> None: ...
    def add_actions_full(self, entries: list[ActionEntry], n_entries: int, user_data: object | None, destroy: GLib.DestroyNotify | None) -> None: ...
    def add_radio_actions(self, entries: list[RadioActionEntry], n_entries: int, value: int, on_change: GObject.Callback, user_data: object | None) -> None: ...
    def add_radio_actions_full(self, entries: list[RadioActionEntry], n_entries: int, value: int, on_change: GObject.Callback, user_data: object | None, destroy: GLib.DestroyNotify) -> None: ...
    def add_toggle_actions(self, entries: list[ToggleActionEntry], n_entries: int, user_data: object | None) -> None: ...
    def add_toggle_actions_full(self, entries: list[ToggleActionEntry], n_entries: int, user_data: object | None, destroy: GLib.DestroyNotify | None) -> None: ...
    ...
    def set_accel_group(self, accel_group: AccelGroup | None) -> None: ...
    def set_sensitive(self, sensitive: bool) -> None: ...
    def set_translate_func(self, func: TranslateFunc, data: object | None, notify: GLib.DestroyNotify) -> None: ...
...
class Application(Gio.Application, Gio.ActionGroup, Gio.ActionMap): 
    ...
    def add_accelerator(self, accelerator: str, action_name: str, parameter: GLib.Variant | None) -> None: ...
    ...
    def remove_accelerator(self, action_name: str, parameter: GLib.Variant | None) -> None: ...
    def remove_window(self, window: Window) -> None: ...
    def set_accels_for_action(self, detailed_action_name: str, accels: list[str]) -> None: ...
    def set_app_menu(self, app_menu: Gio.MenuModel | None) -> None: ...
...
class AspectFrame(Frame, Atk.ImplementorIface, Buildable): 
    @classmethod
    def new(cls, label: str | None, xalign: float, yalign: float, ratio: float, obey_child: bool) -> Widget: ...
...
class Assistant(Window, Atk.ImplementorIface, Buildable): 
    ...
    def set_page_header_image(self, page: Widget, pixbuf: GdkPixbuf.Pixbuf | None) -> None: ...
    def set_page_side_image(self, page: Widget, pixbuf: GdkPixbuf.Pixbuf | None) -> None: ...
...
class Builder(GObject.Object): 
    ...
    def connect_signals(self, user_data: object | None) -> None: ...
    def connect_signals_full(self, func: BuilderConnectFunc, user_data: object | None) -> None: ...
...
class Calendar(Widget, Atk.ImplementorIface, Buildable): 
    ...
    def set_detail_func(self, func: CalendarDetailFunc, data: object | None, destroy: GLib.DestroyNotify) -> None: ...
...
class CellRenderer(GObject.InitiallyUnowned): 
    ...
    def get_request_mode(self) -> SizeRequestMode: ...
    def get_sensitive(self) -> bool: ...
    def get_size(self, widget: Widget, cell_area: Gdk.Rectangle | None, x_offset: int, y_offset: int, width: int, height: int) -> None: ...
...
class Clipboard(GObject.Object): 
    ...
    def request_contents(self, target: Gdk.Atom, callback: ClipboardReceivedFunc, user_data: object | None) -> None: ...
    def request_image(self, callback: ClipboardImageReceivedFunc, user_data: object | None) -> None: ...
    def request_rich_text(self, buffer: TextBuffer, callback: ClipboardRichTextReceivedFunc, user_data: object | None) -> None: ...
    def request_targets(self, callback: ClipboardTargetsReceivedFunc, user_data: object | None) -> None: ...
    def request_text(self, callback: ClipboardTextReceivedFunc, user_data: object | None) -> None: ...
    def request_uris(self, callback: ClipboardURIReceivedFunc, user_data: object | None) -> None: ...
    def set_can_store(self, targets: list[TargetEntry] | None, n_targets: int) -> None: ...
    def set_image(self, pixbuf: GdkPixbuf.Pixbuf) -> None: ...
    def set_text(self, text: str, len: int) -> None: ...
    def set_with_data(self, targets: list[TargetEntry], n_targets: int, get_func: ClipboardGetFunc, clear_func: ClipboardClearFunc, user_data: object | None) -> bool: ...
    ...
    def wait_for_rich_text(self, buffer: TextBuffer, format: Gdk.Atom, length: gsize) -> list[int] | None: ...
...
class ComboBox(Bin, Atk.ImplementorIface, Buildable, CellEditable, CellLayout): 
    ...
    def set_row_separator_func(self, func: TreeViewRowSeparatorFunc, data: object | None, destroy: GLib.DestroyNotify | None) -> None: ...
...
class Container(Widget, Atk.ImplementorIface, Buildable): 
    ...
    def forall(self, callback: Callback, callback_data: object | None) -> None: ...
    def foreach(self, callback: Callback, callback_data: object | None) -> None: ...
    ...
    def get_focus_hadjustment(self) -> Adjustment | None: ...
    def get_focus_vadjustment(self) -> Adjustment | None: ...
...
class CssProvider(GObject.Object, StyleProvider): 
    ...
    @classmethod
    def get_named(cls, name: str, variant: str | None) -> CssProvider: ...
...
class Entry(Widget, Atk.ImplementorIface, Buildable, CellEditable, Editable): 
    ...
    def get_icon_pixbuf(self, icon_pos: EntryIconPosition) -> GdkPixbuf.Pixbuf | None: ...
    ...
    def set_cursor_hadjustment(self, adjustment: Adjustment | None) -> None: ...
    ...
    def set_icon_from_pixbuf(self, icon_pos: EntryIconPosition, pixbuf: GdkPixbuf.Pixbuf | None) -> None: ...
    def set_icon_from_stock(self, icon_pos: EntryIconPosition, stock_id: str | None) -> None: ...
    ...
    def set_inner_border(self, border: Border | None) -> None: ...
...
class FileFilter(GObject.InitiallyUnowned, Buildable): 
    ...
    def add_custom(self, needed: FileFilterFlags, func: FileFilterFunc, data: object | None, notify: GLib.DestroyNotify) -> None: ...
...
class Gesture(EventController): 
    ...
    def set_window(self, window: Gdk.Window | None) -> None: ...
...
class GestureMultiPress(GestureSingle): 
    ...
    def set_area(self, rect: Gdk.Rectangle | None) -> None: ...
...
class HScale(Scale, Atk.ImplementorIface, Buildable, Orientable): 
    @classmethod
    def new(cls, adjustment: Adjustment | None) -> Widget: ...
...
class HeaderBar(Container, Atk.ImplementorIface, Buildable): 
    @classmethod
    def new(cls) -> Widget: ...
    def get_custom_title(self) -> Widget | None: ...
    ...
    def pack_end(self, child: Widget) -> None: ...
    def pack_start(self, child: Widget) -> None: ...
    def set_custom_title(self, title_widget: Widget | None) -> None: ...
...
class IMContext(GObject.Object): 
    ...
    def reset(self) -> None: ...
    def set_client_window(self, window: Gdk.Window | None) -> None: ...
...
class IconInfo(GObject.Object): 
    ...
    def load_icon_async(self, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    ...
    def load_symbolic(self, fg: Gdk.RGBA, success_color: Gdk.RGBA | None, warning_color: Gdk.RGBA | None, error_color: Gdk.RGBA | None, was_symbolic: bool) -> GdkPixbuf.Pixbuf: ...
    def load_symbolic_async(self, fg: Gdk.RGBA, success_color: Gdk.RGBA | None, warning_color: Gdk.RGBA | None, error_color: Gdk.RGBA | None, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
    ...
    def load_symbolic_for_context_async(self, context: StyleContext, cancellable: Gio.Cancellable | None, callback: Gio.AsyncReadyCallback | None, user_data: object | None) -> None: ...
...
class IconTheme(GObject.Object): 
    ...
    def choose_icon(self, icon_names: list[str], size: int, flags: IconLookupFlags) -> IconInfo | None: ...
    def choose_icon_for_scale(self, icon_names: list[str], size: int, scale: int, flags: IconLookupFlags) -> IconInfo | None: ...
    ...
    def list_icons(self, context: str | None) -> GLib.List: ...
    def load_icon(self, icon_name: str, size: int, flags: IconLookupFlags) -> GdkPixbuf.Pixbuf | None: ...
    def load_icon_for_scale(self, icon_name: str, size: int, scale: int, flags: IconLookupFlags) -> GdkPixbuf.Pixbuf | None: ...
    def load_surface(self, icon_name: str, size: int, scale: int, for_window: Gdk.Window | None, flags: IconLookupFlags) -> cairo.Surface | None: ...
    def lookup_by_gicon(self, icon: Gio.Icon, size: int, flags: IconLookupFlags) -> IconInfo | None: ...
    def lookup_by_gicon_for_scale(self, icon: Gio.Icon, size: int, scale: int, flags: IconLookupFlags) -> IconInfo | None: ...
    def lookup_icon(self, icon_name: str, size: int, flags: IconLookupFlags) -> IconInfo | None: ...
    def lookup_icon_for_scale(self, icon_name: str, size: int, scale: int, flags: IconLookupFlags) -> IconInfo | None: ...
...
class Image(Misc, Atk.ImplementorIface, Buildable): 
    ...
    def new(cls) -> Widget: ...
    def clear(self) -> None: ...
    def get_animation(self) -> GdkPixbuf.PixbufAnimation | None: ...
    ...
    def set_from_icon_name(self, icon_name: str | None, size: int) -> None: ...
...
class Layout(Container, Atk.ImplementorIface, Buildable, Scrollable): 
    ...
    def set_hadjustment(self, adjustment: Adjustment | None) -> None: ...
    def set_size(self, width: int, height: int) -> None: ...
    def set_vadjustment(self, adjustment: Adjustment | None) -> None: ...
...
class Menu(MenuShell, Atk.ImplementorIface, Buildable): 
    ...
    def attach_to_widget(self, attach_widget: Widget, detacher: MenuDetachFunc | None) -> None: ...
    ...
    def popdown(self) -> None: ...
    def popup(self, parent_menu_shell: Widget | None, parent_menu_item: Widget | None, func: MenuPositionFunc | None, data: object | None, button: int, activate_time: int) -> None: ...
    def popup_at_pointer(self, trigger_event: Gdk.Event | None) -> None: ...
    def popup_at_rect(self, rect_window: Gdk.Window, rect: Gdk.Rectangle, rect_anchor: Gdk.Gravity, menu_anchor: Gdk.Gravity, trigger_event: Gdk.Event | None) -> None: ...
    def popup_at_widget(self, widget: Widget, widget_anchor: Gdk.Gravity, menu_anchor: Gdk.Gravity, trigger_event: Gdk.Event | None) -> None: ...
    def popup_for_device(self, device: Gdk.Device | None, parent_menu_shell: Widget | None, parent_menu_item: Widget | None, func: MenuPositionFunc | None, data: object | None, destroy: GLib.DestroyNotify | None, button: int, activate_time: int) -> None: ...
    def reorder_child(self, child: Widget, position: int) -> None: ...
    def reposition(self) -> None: ...
    def set_accel_group(self, accel_group: AccelGroup | None) -> None: ...
    def set_accel_path(self, accel_path: str | None) -> None: ...
    def set_active(self, index: int) -> None: ...
    def set_monitor(self, monitor_num: int) -> None: ...
    def set_reserve_toggle_size(self, reserve_toggle_size: bool) -> None: ...
    def set_screen(self, screen: Gdk.Screen | None) -> None: ...
...
class MenuButton(ToggleButton, Atk.ImplementorIface, Actionable, Activatable, Buildable): 
    ...
    def set_popup(self, menu: Widget | None) -> None: ...
...
class MenuShell(Container, Atk.ImplementorIface, Buildable): 
    ...
    def bind_model(self, model: Gio.MenuModel | None, action_namespace: str | None, with_separators: bool) -> None: ...
...
class MenuToolButton(ToolButton, Atk.ImplementorIface, Actionable, Activatable, Buildable): 
    @classmethod
    def new(cls, icon_widget: Widget | None, label: str | None) -> ToolItem: ...
...
class NumerableIcon(Gio.EmblemedIcon, Gio.Icon): 
    ...
    def set_background_gicon(self, icon: Gio.Icon | None) -> None: ...
    def set_background_icon_name(self, icon_name: str | None) -> None: ...
...
class OffscreenWindow(Window, Atk.ImplementorIface, Buildable): 
    ...
    def new(cls) -> Widget: ...
    def get_pixbuf(self) -> GdkPixbuf.Pixbuf | None: ...
    def get_surface(self) -> cairo.Surface | None: ...
...
class PadController(EventController): 
    @classmethod
    def new(cls, window: Window, group: Gio.ActionGroup, pad: Gdk.Device | None) -> PadController: ...
...
class PlacesSidebar(ScrolledWindow, Atk.ImplementorIface, Buildable): 
    ...
    def get_nth_bookmark(self, n: int) -> Gio.File | None: ...
...
class Popover(Bin, Atk.ImplementorIface, Buildable): 
    @classmethod
    def new(cls, relative_to: Widget | None) -> Widget: ...
    def bind_model(self, model: Gio.MenuModel | None, action_namespace: str | None) -> None: ...
...
class RadioAction(ToggleAction, Buildable): 
    @classmethod
    def new(cls, name: str, label: str | None, tooltip: str | None, stock_id: str | None, value: int) -> RadioAction: ...
    def get_current_value(self) -> int: ...
    def get_group(self) -> GLib.SList: ...
    def join_group(self, group_source: RadioAction | None) -> None: ...
    def set_current_value(self, current_value: int) -> None: ...
    def set_group(self, group: GLib.SList | None) -> None: ...

class RadioButton(CheckButton, Atk.ImplementorIface, Actionable, Activatable, Buildable): 
    @classmethod
    def new(cls, group: GLib.SList | None) -> Widget: ...
    def get_group(self) -> GLib.SList: ...
    def join_group(self, group_source: RadioButton | None) -> None: ...
    def set_group(self, group: GLib.SList | None) -> None: ...
...
class RadioMenuItem(CheckMenuItem, Atk.ImplementorIface, Actionable, Activatable, Buildable): 
    ...
    def new(cls, group: GLib.SList | None) -> Widget: ...
    def get_group(self) -> GLib.SList: ...
    def join_group(self, group_source: RadioMenuItem | None) -> None: ...
    def set_group(self, group: GLib.SList | None) -> None: ...
...
class RadioToolButton(ToggleToolButton, Atk.ImplementorIface, Actionable, Activatable, Buildable): 
    @classmethod
    def new(cls, group: GLib.SList | None) -> ToolItem: ...
    def get_group(self) -> GLib.SList: ...
    def set_group(self, group: GLib.SList | None) -> None: ...
...
class RecentChooserDialog(Dialog, Atk.ImplementorIface, Buildable, RecentChooser): 
    @classmethod
    def new(cls, title: str | None, parent: Window | None, first_button_text: str | None) -> Widget: ...
...
class RecentFilter(GObject.InitiallyUnowned, Buildable): 
    ...
    def add_custom(self, needed: RecentFilterFlags, func: RecentFilterFunc, data: object | None, data_destroy: GLib.DestroyNotify) -> None: ...
...
class ScaleButton(Button, Atk.ImplementorIface, Actionable, Activatable, Buildable, Orientable): 
    @classmethod
    def new(cls, size: int, min: float, max: float, step: float, icons: list[str] | None) -> Widget: ...
    def get_adjustment(self) -> Adjustment: ...
...
class Style(GObject.Object): 
    ...
    def render_icon(self, source: IconSource, direction: TextDirection, state: StateType, size: int, widget: Widget | None, detail: str | None) -> GdkPixbuf.Pixbuf: ...
...
class StyleContext(GObject.Object): 
    ...
    def cancel_animations(self, region_id: object | None) -> None: ...
    ...
    def notify_state_change(self, window: Gdk.Window, region_id: object | None, state: StateType, state_value: bool) -> None: ...
    def pop_animatable_region(self) -> None: ...
    def push_animatable_region(self, region_id: object | None) -> None: ...
    ...
    def set_parent(self, parent: StyleContext | None) -> None: ...
...
class StyleProperties(GObject.Object, StyleProvider): 
    ...
    @classmethod
    def register_property(cls, parse_func: StylePropertyParser | None, pspec: GObject.ParamSpec) -> None: ...
    def clear(self) -> None: ...
    def get(self, state: StateFlags) -> None: ...
...
class TextBuffer(GObject.Object): 
    ...
    def paste_clipboard(self, clipboard: Clipboard, override_location: TextIter | None, default_editable: bool) -> None: ...
    def place_cursor(self, where: TextIter) -> None: ...
    def register_deserialize_format(self, mime_type: str, function: TextBufferDeserializeFunc, user_data: object | None, user_data_destroy: GLib.DestroyNotify) -> Gdk.Atom: ...
    def register_deserialize_tagset(self, tagset_name: str | None) -> Gdk.Atom: ...
    def register_serialize_format(self, mime_type: str, function: TextBufferSerializeFunc, user_data: object | None, user_data_destroy: GLib.DestroyNotify) -> Gdk.Atom: ...
    def register_serialize_tagset(self, tagset_name: str | None) -> Gdk.Atom: ...
...
class ThemingEngine(GObject.Object): 
    @classmethod
    def load(cls, name: str) -> ThemingEngine | None: ...
    @classmethod
    def register_property(cls, name_space: str, parse_func: StylePropertyParser | None, pspec: GObject.ParamSpec) -> None: ...
    def get(self, state: StateFlags) -> None: ...
    def get_background_color(self, state: StateFlags, color: Gdk.RGBA) -> None: ...
    def get_border(self, state: StateFlags, border: Border) -> None: ...
    def get_border_color(self, state: StateFlags, color: Gdk.RGBA) -> None: ...
...
class ToggleAction(Action, Buildable): 
    @classmethod
    def new(cls, name: str, label: str | None, tooltip: str | None, stock_id: str | None) -> ToggleAction: ...
    def get_active(self) -> bool: ...
    def get_draw_as_radio(self) -> bool: ...
    def set_active(self, is_active: bool) -> None: ...
    def set_draw_as_radio(self, draw_as_radio: bool) -> None: ...
...
class ToolButton(ToolItem, Atk.ImplementorIface, Actionable, Activatable, Buildable): 
    ...
    def new(cls, icon_widget: Widget | None, label: str | None) -> ToolItem: ...
    def get_icon_name(self) -> str | None: ...
    def get_icon_widget(self) -> Widget | None: ...
    def get_label(self) -> str | None: ...
    def get_label_widget(self) -> Widget | None: ...
    def get_stock_id(self) -> str: ...
    def get_use_underline(self) -> bool: ...
    def set_icon_name(self, icon_name: str | None) -> None: ...
    def set_icon_widget(self, icon_widget: Widget | None) -> None: ...
    def set_label(self, label: str | None) -> None: ...
    def set_label_widget(self, label_widget: Widget | None) -> None: ...
    def set_stock_id(self, stock_id: str | None) -> None: ...
    def set_use_underline(self, use_underline: bool) -> None: ...
...
class ToolItem(Bin, Atk.ImplementorIface, Activatable, Buildable): 
    ...
    def get_is_important(self) -> bool: ...
    def get_orientation(self) -> Orientation: ...
    def get_proxy_menu_item(self, menu_item_id: str) -> Widget | None: ...
    ...
    def set_homogeneous(self, homogeneous: bool) -> None: ...
    def set_is_important(self, is_important: bool) -> None: ...
    def set_proxy_menu_item(self, menu_item_id: str, menu_item: Widget | None) -> None: ...
...
class ToolPalette(Container, Atk.ImplementorIface, Buildable, Orientable, Scrollable): 
    ...
    def get_drop_group(self, x: int, y: int) -> ToolItemGroup | None: ...
    def get_drop_item(self, x: int, y: int) -> ToolItem | None: ...
...
class Toolbar(Container, Atk.ImplementorIface, Buildable, Orientable, ToolShell): 
    ...
    def get_n_items(self) -> int: ...
    def get_nth_item(self, n: int) -> ToolItem | None: ...
    def get_relief_style(self) -> ReliefStyle: ...
    def get_show_arrow(self) -> bool: ...
    def get_style(self) -> ToolbarStyle: ...
    def insert(self, item: ToolItem, pos: int) -> None: ...
    def set_drop_highlight_item(self, tool_item: ToolItem | None, index_: int) -> None: ...
...
class Tooltip(GObject.Object): 
    ...
    def set_icon(self, pixbuf: GdkPixbuf.Pixbuf | None) -> None: ...
    def set_icon_from_gicon(self, gicon: Gio.Icon | None, size: int) -> None: ...
    def set_icon_from_icon_name(self, icon_name: str | None, size: int) -> None: ...
...
class TreeView(Container, Atk.ImplementorIface, Buildable, Scrollable): 
    ...
    def set_destroy_count_func(self, func: TreeDestroyCountFunc | None, data: object | None, destroy: GLib.DestroyNotify | None) -> None: ...
    ...
    def set_search_entry(self, entry: Entry | None) -> None: ...
    ...
    def set_search_position_func(self, func: TreeViewSearchPositionFunc | None, data: object | None, destroy: GLib.DestroyNotify | None) -> None: ...
...
class TreeViewColumn(GObject.InitiallyUnowned, Buildable, CellLayout): 
    ...
    def cell_get_size(self, cell_area: Gdk.Rectangle | None, x_offset: int, y_offset: int, width: int, height: int) -> None: ...
...
class UIManager(GObject.Object, Buildable): 
    ...
    def add_ui(self, merge_id: int, path: str, name: str, action: str | None, type: UIManagerItemType, top: bool) -> None: ...
...
class Widget(GObject.InitiallyUnowned, Atk.ImplementorIface, Buildable): 
    ...
    def drag_begin(self, targets: TargetList, actions: Gdk.DragAction, button: int, event: Gdk.Event | None) -> Gdk.DragContext: ...
    def drag_begin_with_coordinates(self, targets: TargetList, actions: Gdk.DragAction, button: int, event: Gdk.Event | None, x: int, y: int) -> Gdk.DragContext: ...
    ...
    def drag_dest_find_target(self, context: Gdk.DragContext, target_list: TargetList | None) -> Gdk.Atom: ...
    def drag_dest_get_target_list(self) -> TargetList | None: ...
    def drag_dest_get_track_motion(self) -> bool: ...
    def drag_dest_set(self, flags: DestDefaults, targets: list[TargetEntry] | None, n_targets: int, actions: Gdk.DragAction) -> None: ...
    def drag_dest_set_proxy(self, proxy_window: Gdk.Window, protocol: Gdk.DragProtocol, use_coordinates: bool) -> None: ...
    def drag_dest_set_target_list(self, target_list: TargetList | None) -> None: ...
    ...
    def drag_source_set(self, start_button_mask: Gdk.ModifierType, targets: list[TargetEntry] | None, n_targets: int, actions: Gdk.DragAction) -> None: ...
    ...
    def drag_source_set_target_list(self, target_list: TargetList | None) -> None: ...
    ...
    def modify_base(self, state: StateType, color: Gdk.Color | None) -> None: ...
    def modify_bg(self, state: StateType, color: Gdk.Color | None) -> None: ...
    def modify_cursor(self, primary: Gdk.Color | None, secondary: Gdk.Color | None) -> None: ...
    def modify_fg(self, state: StateType, color: Gdk.Color | None) -> None: ...
    def modify_font(self, font_desc: Pango.FontDescription | None) -> None: ...
    def modify_style(self, style: RcStyle) -> None: ...
    def modify_text(self, state: StateType, color: Gdk.Color | None) -> None: ...
    def override_background_color(self, state: StateFlags, color: Gdk.RGBA | None) -> None: ...
    def override_color(self, state: StateFlags, color: Gdk.RGBA | None) -> None: ...
    def override_cursor(self, cursor: Gdk.RGBA | None, secondary_cursor: Gdk.RGBA | None) -> None: ...
    def override_font(self, font_desc: Pango.FontDescription | None) -> None: ...
    def override_symbolic_color(self, name: str, color: Gdk.RGBA | None) -> None: ...
    ...
    def render_icon(self, stock_id: str, size: int, detail: str | None) -> GdkPixbuf.Pixbuf | None: ...
    def render_icon_pixbuf(self, stock_id: str, size: int) -> GdkPixbuf.Pixbuf | None: ...
    ...
    def set_accel_path(self, accel_path: str | None, accel_group: AccelGroup | None) -> None: ...
...
class Window(Bin, Atk.ImplementorIface, Buildable): 
    ...
    def get_screen(self) -> Gdk.Screen: ...
    def get_size(self, width: int | None, height: int | None) -> None: ...
    ...
    def set_geometry_hints(self, geometry_widget: Widget | None, geometry: Gdk.Geometry | None, geom_mask: Gdk.WindowHints) -> None: ...
...
class Activatable: 
    def sync_action_properties(self, action: Action | None) -> None: ...
...
class Buildable: 
    ...
    def custom_tag_start(self, builder: Builder, child: GObject.Object | None, tagname: str, parser: GLib.MarkupParser, data: object | None) -> bool: ...
...
class FileChooser: 
    ...
    def get_current_folder(self) -> filename | None: ...
    def get_current_folder_file(self) -> Gio.File | None: ...
    def get_current_folder_uri(self) -> str | None: ...
    def get_current_name(self) -> str: ...
    def get_do_overwrite_confirmation(self) -> bool: ...
    def get_extra_widget(self) -> Widget | None: ...
    ...
    def get_preview_filename(self) -> filename | None: ...
    ...
    def list_shortcut_folder_uris(self) -> GLib.SList | None: ...
    def list_shortcut_folders(self) -> GLib.SList | None: ...
...
class RecentChooser: 
    ...
    def set_sort_func(self, sort_func: RecentSortFunc, sort_data: object | None, data_destroy: GLib.DestroyNotify | None) -> None: ...
    def unselect_all(self) -> None: ...
    def unselect_uri(self, uri: str) -> None: ...
    def add_filter(self, filter: RecentFilter) -> None: ...
    ...
    def select_uri(self, uri: str) -> bool: ...
    def set_current_uri(self, uri: str) -> bool: ...
    def set_filter(self, filter: RecentFilter | None) -> None: ...
