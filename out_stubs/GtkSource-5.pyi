...
def encoding_get_from_charset(charset: str) -> Encoding: ...
def encoding_get_utf8() -> Encoding: ...
def file_loader_error_quark() -> GLib.Quark: ...
def file_saver_error_quark() -> GLib.Quark: ...
def finalize() -> None: ...
def init() -> None: ...
def scheduler_add(callback: SchedulerCallback, user_data: object) -> gsize: ...
def scheduler_add_full(callback: SchedulerCallback, user_data: object, notify: GLib.DestroyNotify) -> gsize: ...
...
class Buffer(Gtk.TextBuffer): 
    @classmethod
    def new(cls, table: Gtk.TextTagTable) -> Buffer: ...
    def backward_iter_to_source_mark(self, iter: Gtk.TextIter, category: str) -> bool: ...
    def change_case(self, case_type: ChangeCaseType, start: Gtk.TextIter, end: Gtk.TextIter) -> None: ...
    def create_source_mark(self, name: str, category: str, where: Gtk.TextIter) -> Mark: ...
    def create_source_tag(self, tag_name: str, first_property_name: str) -> Gtk.TextTag: ...
    def ensure_highlight(self, start: Gtk.TextIter, end: Gtk.TextIter) -> None: ...
    def forward_iter_to_source_mark(self, iter: Gtk.TextIter, category: str) -> bool: ...
    ...
    def get_source_marks_at_iter(self, iter: Gtk.TextIter, category: str) -> GLib.SList: ...
    def get_source_marks_at_line(self, line: int, category: str) -> GLib.SList: ...
...
class Completion(GObject.Object): 
    @classmethod
    def fuzzy_highlight(cls, haystack: str, casefold_query: str) -> Pango.AttrList: ...
    @classmethod
    def fuzzy_match(cls, haystack: str, casefold_needle: str, priority: int) -> bool: ...
...
class CompletionContext(GObject.Object, Gio.ListModel): 
    ...
    def get_language(self) -> Language: ...
    def get_proposals_for_provider(self, provider: CompletionProvider) -> Gio.ListModel: ...
    def get_view(self) -> View: ...
    def get_word(self) -> str: ...
    def list_providers(self) -> Gio.ListModel: ...
    def set_proposals_for_provider(self, provider: CompletionProvider, results: Gio.ListModel) -> None: ...
...
class CompletionWords(GObject.Object, CompletionProvider): 
    @classmethod
    def new(cls, title: str) -> CompletionWords: ...
...
class File(GObject.Object): 
    ...
    def set_mount_operation_factory(self, callback: MountOperationFactory, user_data: object, notify: GLib.DestroyNotify) -> None: ...
...
class FileLoader(GObject.Object): 
    ...
    def get_location(self) -> Gio.File: ...
    def get_newline_type(self) -> NewlineType: ...
    def load_async(self, io_priority: int, cancellable: Gio.Cancellable, progress_callback: Gio.FileProgressCallback, progress_callback_data: object, progress_callback_notify: GLib.DestroyNotify, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class FileSaver(GObject.Object): 
    ...
    def get_location(self) -> Gio.File: ...
    def get_newline_type(self) -> NewlineType: ...
    def save_async(self, io_priority: int, cancellable: Gio.Cancellable, progress_callback: Gio.FileProgressCallback, progress_callback_data: object, progress_callback_notify: GLib.DestroyNotify, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class Language(GObject.Object): 
    ...
    def get_style_fallback(self, style_id: str) -> str: ...
...
class LanguageManager(GObject.Object): 
    ...
    def get_language(self, id: str) -> Language: ...
    def get_language_ids(self) -> list[str]: ...
    def get_search_path(self) -> list[str]: ...
    def guess_language(self, filename: filename, content_type: str) -> Language: ...
    def prepend_search_path(self, path: str) -> None: ...
    def set_search_path(self, dirs: list[str]) -> None: ...
...
class Mark(Gtk.TextMark): 
    @classmethod
    def new(cls, name: str, category: str) -> Mark: ...
    def get_category(self) -> str: ...
    def next(self, category: str) -> Mark: ...
    def prev(self, category: str) -> Mark: ...
...
class PrintCompositor(GObject.Object): 
    ...
    def set_footer_font_name(self, font_name: str) -> None: ...
    def set_footer_format(self, separator: bool, left: str, center: str, right: str) -> None: ...
    def set_header_font_name(self, font_name: str) -> None: ...
    def set_header_format(self, separator: bool, left: str, center: str, right: str) -> None: ...
    def set_highlight_syntax(self, highlight: bool) -> None: ...
    def set_left_margin(self, margin: float, unit: Gtk.Unit) -> None: ...
    def set_line_numbers_font_name(self, font_name: str) -> None: ...
...
class Region(GObject.Object): 
    ...
    def add_region(self, region_to_add: Region) -> None: ...
    ...
    def intersect_region(self, region2: Region) -> Region: ...
    def intersect_subregion(self, _start: Gtk.TextIter, _end: Gtk.TextIter) -> Region: ...
    def is_empty(self) -> bool: ...
    def subtract_region(self, region_to_subtract: Region) -> None: ...
    def subtract_subregion(self, _start: Gtk.TextIter, _end: Gtk.TextIter) -> None: ...
    def to_string(self) -> str: ...

class SearchContext(GObject.Object): 
    @classmethod
    def new(cls, buffer: Buffer, settings: SearchSettings) -> SearchContext: ...
    def backward(self, iter: Gtk.TextIter, match_start: Gtk.TextIter, match_end: Gtk.TextIter, has_wrapped_around: bool) -> bool: ...
    def backward_async(self, iter: Gtk.TextIter, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def forward_async(self, iter: Gtk.TextIter, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    ...
    def get_regex_error(self) -> GLib.Error: ...
    ...
    def set_match_style(self, match_style: Style) -> None: ...
...
class Snippet(GObject.Object): 
    @classmethod
    def new(cls, trigger: str, language_id: str) -> Snippet: ...
...
class SnippetManager(GObject.Object): 
    ...
    def get_search_path(self) -> list[str]: ...
    def get_snippet(self, group: str, language_id: str, trigger: str) -> Snippet: ...
    def list_all(self) -> Gio.ListModel: ...
    def list_groups(self) -> list[str]: ...
    def list_matching(self, group: str, language_id: str, trigger_prefix: str) -> Gio.ListModel: ...
    def set_search_path(self, dirs: list[str]) -> None: ...
...
class SpaceDrawer(GObject.Object): 
    ...
    def set_matrix(self, matrix: GLib.Variant) -> None: ...
...
class StyleSchemeManager(GObject.Object): 
    ...
    def get_scheme_ids(self) -> list[str]: ...
    def get_search_path(self) -> list[str]: ...
    def prepend_search_path(self, path: str) -> None: ...
...
class Tag(Gtk.TextTag): 
    @classmethod
    def new(cls, name: str) -> Gtk.TextTag: ...
...
class View(Gtk.TextView, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Scrollable): 
    ...
    def get_indenter(self) -> Indenter: ...
    ...
    def push_snippet(self, snippet: Snippet, location: Gtk.TextIter) -> None: ...
    ...
    def set_indenter(self, indenter: Indenter) -> None: ...
...
class CompletionProvider: 
    ...
    def list_alternates(self, context: CompletionContext, proposal: CompletionProposal) -> list[CompletionProposal]: ...
    def populate(self, context: CompletionContext) -> Gio.ListModel: ...
    def populate_async(self, context: CompletionContext, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class HoverProvider: 
    ...
    def populate_async(self, context: HoverContext, display: HoverDisplay, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
