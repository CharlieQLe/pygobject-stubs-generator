...
def add_key_event_listener(listener: KeySnoopFunc, data: object | None) -> int: ...
...
class Object(GObject.Object): 
    ...
    def initialize(self, data: object | None) -> None: ...
...
class Document: 
    ...
    def get_document_attribute_value(self, attribute_name: str) -> str | None: ...
...
class Text: 
    ...
    def get_string_at_offset(self, offset: int, granularity: TextGranularity, start_offset: int, end_offset: int) -> str | None: ...
