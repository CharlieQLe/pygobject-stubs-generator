...
class GLShaderNode(RenderNode): 
    @classmethod
    def new(cls, shader: GLShader, bounds: Graphene.Rect, args: GLib.Bytes, children: list[RenderNode] | None, n_children: int) -> GLShaderNode: ...
...
class RenderNode: 
    @classmethod
    def deserialize(cls, bytes: GLib.Bytes, error_func: ParseErrorFunc | None, user_data: object | None) -> RenderNode | None: ...
...
class RepeatNode(RenderNode): 
    @classmethod
    def new(cls, bounds: Graphene.Rect, child: RenderNode, child_bounds: Graphene.Rect | None) -> RepeatNode: ...
    def get_child(self) -> RenderNode: ...
...
class TextNode(RenderNode): 
    @classmethod
    def new(cls, font: Pango.Font, glyphs: Pango.GlyphString, color: Gdk.RGBA, offset: Graphene.Point) -> TextNode | None: ...
    def get_color(self) -> Gdk.RGBA: ...
