...
class DbusAccountProxy(Gio.DBusProxy, DbusAccount, Gio.AsyncInitable, Gio.DBusInterface, Gio.Initable): 
    ...
    @classmethod
    def new(cls, connection: Gio.DBusConnection, flags: Gio.DBusProxyFlags, name: str, object_path: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    @classmethod
    def new_for_bus(cls, bus_type: Gio.BusType, flags: Gio.DBusProxyFlags, name: str, object_path: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class DbusObjectManagerClient(Gio.DBusObjectManagerClient, Gio.AsyncInitable, Gio.DBusObjectManager, Gio.Initable): 
    ...
    @classmethod
    def get_proxy_type(cls, manager: Gio.DBusObjectManagerClient, object_path: str, interface_name: str, user_data: object) -> GObject.Type: ...
    @classmethod
    def new(cls, connection: Gio.DBusConnection, flags: Gio.DBusObjectManagerClientFlags, name: str, object_path: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
    @classmethod
    def new_for_bus(cls, bus_type: Gio.BusType, flags: Gio.DBusObjectManagerClientFlags, name: str, object_path: str, cancellable: Gio.Cancellable, callback: Gio.AsyncReadyCallback, user_data: object) -> None: ...
...
class DbusObjectSkeleton(Gio.DBusObjectSkeleton, DbusObject, Gio.DBusObject): 
    ...
    def set_account(self, interface_: DbusAccount) -> None: ...
    def set_provider(self, interface_: DbusProvider) -> None: ...
...
class DbusAccount: 
    ...
    def get_status_details(self) -> str: ...
    def dup_icon(self) -> str: ...
    def dup_name(self) -> str: ...
    def dup_path(self) -> str: ...
    def dup_status_details(self) -> str: ...
    def get_icon(self) -> str: ...
    def get_name(self) -> str: ...
    def get_path(self) -> str: ...
    def get_status(self) -> int: ...
...
class DbusObject(Gio.DBusObject): 
    def get_account(self) -> DbusAccount: ...
    def get_provider(self) -> DbusProvider: ...
    def peek_account(self) -> DbusAccount: ...
    def peek_provider(self) -> DbusProvider: ...
class DbusProvider: 
    def get_name(self) -> str: ...
    def dup_name(self) -> str: ...
    def get_name(self) -> str: ...
