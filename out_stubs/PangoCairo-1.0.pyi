...
def context_get_shape_renderer(context: Pango.Context, data: object | None) -> ShapeRendererFunc | None: ...
...
def context_set_shape_renderer(context: Pango.Context, func: ShapeRendererFunc | None, data: object | None, dnotify: GLib.DestroyNotify | None) -> None: ...
