...
def deregister_device_event_listener(listener: DeviceListener, filter: object) -> bool: ...
def deregister_keystroke_listener(listener: DeviceListener, key_set: list[KeyDefinition], modmask: KeyMaskType, event_types: KeyEventMask) -> bool: ...
def event_main() -> None: ...
def event_quit() -> None: ...
def exit() -> int: ...
def generate_keyboard_event(keyval: int, keystring: str, synth_type: KeySynthType) -> bool: ...
...
def register_device_event_listener(listener: DeviceListener, event_types: DeviceEventMask, filter: object) -> bool: ...
def register_keystroke_listener(listener: DeviceListener, key_set: list[KeyDefinition], modmask: KeyMaskType, event_types: KeyEventMask, sync_type: KeyListenerSyncType) -> bool: ...
...
class Device(GObject.Object): 
    @classmethod
    def new(cls) -> Device: ...
    def add_key_grab(self, kd: KeyDefinition, callback: KeyCallback, user_data: object, callback_destroyed: GLib.DestroyNotify) -> int: ...
    def add_key_watcher(self, callback: KeyCallback, user_data: object, callback_destroyed: GLib.DestroyNotify) -> None: ...
...
class DeviceListener(GObject.Object): 
    @classmethod
    def new(cls, callback: DeviceListenerCB, user_data: object, callback_destroyed: GLib.DestroyNotify) -> DeviceListener: ...
    def add_callback(self, callback: DeviceListenerCB, callback_destroyed: GLib.DestroyNotify, user_data: object) -> None: ...
...
class EventListener(GObject.Object): 
    @classmethod
    def new(cls, callback: EventListenerCB, user_data: object, callback_destroyed: GLib.DestroyNotify) -> EventListener: ...
    @classmethod
    def deregister_from_callback(cls, callback: EventListenerCB, user_data: object, event_type: str) -> bool: ...
    @classmethod
    def deregister_no_data(cls, callback: EventListenerSimpleCB, event_type: str) -> bool: ...
    @classmethod
    def register_from_callback(cls, callback: EventListenerCB, user_data: object, callback_destroyed: GLib.DestroyNotify, event_type: str) -> bool: ...
    @classmethod
    def register_from_callback_full(cls, callback: EventListenerCB, user_data: object, callback_destroyed: GLib.DestroyNotify, event_type: str, properties: list[str]) -> bool: ...
    @classmethod
    ...
    def register_full(self, event_type: str, properties: list[str]) -> bool: ...
...
class Component: 
    ...
    def get_accessible_at_point(self, x: int, y: int, ctype: CoordType) -> Accessible: ...
...
class Text: 
    ...
    def get_attribute_value(self, offset: int, attribute_name: str) -> str: ...
    ...
    def get_text_attribute_value(self, offset: int, attribute_name: str) -> str: ...
